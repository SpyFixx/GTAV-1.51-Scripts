...
void func_1()
{
	fLocal_332 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(fLocal_331);
	switch (iLocal_327)
	{
		case 0:
			break;
		...
		case 2:
			break;
		case 3:
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_332))
			{
				func_82();
			}
			break;
	...
	switch (iLocal_327)
	{
		case 0:
			...
			if (func_73() == 5)
			{
				...
				fLocal_331 = NETWORK::_0x77758139EC9B66C7(vLocal_348, vLocal_351, 2, false, true, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_331, sLocal_334, sLocal_336, 8f, -2f, 261, 0, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_331);
				iLocal_327 = 7;
			}
			else if (func_54(9))
			{
		...
		case 2:
			...
			{
				MISC::CLEAR_BIT(&iLocal_325, 0);
				fLocal_331 = NETWORK::_0x77758139EC9B66C7(vLocal_348, vLocal_351, 2, false, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_331, sLocal_334, sLocal_335, 4f, -2f, 261, 0, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_331);
				if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
				{
					iLocal_330 = 1;
		...
		case 4:
			...
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_332) > 0.9f)
			{
				MISC::CLEAR_BIT(&iLocal_325, 0);
				fLocal_331 = NETWORK::_0x77758139EC9B66C7(vLocal_348, vLocal_351, 2, false, true, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_331, sLocal_334, sLocal_336, 8f, -2f, 261, 0, 1148846080 /* Float: 1000f */, 0);
		...
		case 5:
			...
			{
				MISC::SET_BIT(&iLocal_325, 0);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(fLocal_332, true);
		...
		case 6:
			...
			if (!func_46(PLAYER::PLAYER_ID()) && PAD::IS_CONTROL_JUST_PRESSED(2, 222))
			{
				...
				MISC::CLEAR_BIT(&iLocal_325, 0);
				fLocal_331 = NETWORK::_0x77758139EC9B66C7(vLocal_348, vLocal_351, 2, false, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_331, sLocal_334, sLocal_337, 2f, -2f, 261, 0, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_331);
				iLocal_327 = 8;
			}
			break;
		case 7:
			...
			if (((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_338)) && !func_8()) && !func_6()) && Global_1312467.f_8 == 0)
			{
				...
				MISC::CLEAR_BIT(&iLocal_325, 0);
				fLocal_331 = NETWORK::_0x77758139EC9B66C7(vLocal_348, vLocal_351, 2, false, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_331, sLocal_334, sLocal_337, 1000f, -2f, 261, 0, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_331);
				iLocal_327 = 8;
			}
			break;
...
void func_3(int iParam0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		Global_2409287.f_3 = NETWORK::_0xBA7F0B77D80A4EB7();
	}
}
...
float func_16(struct<2> Param0, int iParam2, struct<2> Param3, var uParam5)
{
...
bool func_44(bool bParam0, bool bParam1, bool bParam2)
{
	int iVar0;
...
bool func_50(vector3 vParam0, var uParam3, var uParam4, var uParam5)
{
		...
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				if ((((CAM::IS_GAMEPLAY_CAM_RENDERING() && !CUTSCENE::IS_CUTSCENE_PLAYING()) && !CAM::IS_CINEMATIC_CAM_RENDERING()) && !func_43(0)) && !func_53())
				{
					...
					if (func_51(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, uParam3, 0))
					{
						return true;
					}
				}

...
void func_1()
{
	...
	switch (iLocal_308)
	{
		...
		case 2:
			...
			fLocal_319 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_323, vLocal_326, 2);
			if (Global_30828[1 /*11*/].f_2)
			{
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_319, sLocal_322, "enter_no_remote", 8f, -4f, 0, 0, 1000f, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_18(), fLocal_319, "enter_no_remote_remote", sLocal_322, 8f, -4f, 0, 1000f);
			}
			else
			{
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_319, sLocal_322, "enter", 8f, -4f, 0, 0, 1000f, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_18(), fLocal_319, "enter_remote", sLocal_322, 8f, -4f, 0, 1000f);
			}
			if (PED::_0x7F2F4F13AC5257EF(fLocal_319))
			{
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_319, false);
			}
			if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
				...
				if (Global_30828[1 /*11*/].f_2)
				{
					CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_321, fLocal_319, "enter_no_remote_cam", sLocal_322);
				}
				else
				{
					CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_321, fLocal_319, "enter_cam", sLocal_322);
				}
		...
		case 3:
			...
			if (!Global_30828[1 /*11*/].f_2)
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_319) > 0.691f)
				{
					func_16();
					func_12(1, 0, 1, 0, 0);
				}
			}
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_319) > 0.9f)
			{
				fLocal_319 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_323, vLocal_326, 2);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_319, sLocal_322, "base", 8f, -8f, 64, 0, 1000f, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_18(), fLocal_319, "base_remote", sLocal_322, 8f, -8f, 64, 1000f);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(fLocal_319, true);
				func_32("TV_HLP7");
		...
		case 5:
			...
			if (!func_8())
			{
				...
				{
					fLocal_319 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_323, vLocal_326, 2);
					TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_319, sLocal_322, "exit", 8f, -8f, 0, 0, 1000f, 0);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_18(), fLocal_319, "exit_remote", sLocal_322, 8f, -8f, 0, 1000f);
					if (func_6(iLocal_321))
					{
						CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_321, fLocal_319, "exit_cam", sLocal_322);
					}
					if (PED::_0x7F2F4F13AC5257EF(fLocal_319))
					{
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_319, false);
				...
				{
					fLocal_319 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_323, vLocal_326, 2);
					TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_319, sLocal_322, "idle_a", 8f, -8f, 0, 0, 1000f, 0);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_18(), fLocal_319, "idle_a_remote", sLocal_322, 8f, -8f, 0, 1000f);
					if (PED::_0x7F2F4F13AC5257EF(fLocal_319))
					{
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_319, false);
					}
		...
		case 6:
			...
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
			PAD::DISABLE_CONTROL_ACTION(0, 0, true);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_319))
			{
				if (bLocal_316)
				{
					fVar3 = PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_319);
					if (fVar3 > 0.3f)
					{
...
bool func_35(vector3 vParam0, var uParam3, var uParam4, var uParam5)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				if ((((CAM::IS_GAMEPLAY_CAM_RENDERING() && !CUTSCENE::IS_CUTSCENE_PLAYING()) && !CAM::IS_CINEMATIC_CAM_RENDERING()) && !func_39(0)) && !func_38())
				{
					...
					if (func_36(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, uParam3, 0))
					{
						return true;
					}
				}
...
bool func_36(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;

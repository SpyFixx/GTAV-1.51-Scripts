				...
				case 2:
					if (UNK_0x22A8E52414415B76())
					{
						if (UNK_0x3148AE92ED70DC30("Trevor", 0))
						{
							...
							UNK_0x5A9FF5F994E904B8(UNK_0xD803B885F5E47A62(), 1f, 4000, false, 1, 0);
...
void func_207(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_213(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
bool func_216(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
bool func_223(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (UNK_0x405E212DDE472467(UNK_0x16F2683693E537C9(), 0))
	{
		...
		{
			if (!func_230(UNK_0x6937EA2286828455(UNK_0x16F2683693E537C9(), 0), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_230(bool bParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
bool func_244(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
bool func_268(char* sParam0, int iParam1, int iParam2)
{
	bool bVar0;
	struct<32> Var1;
	int iVar33;

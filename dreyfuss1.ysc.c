...
void __EntryFunction__()
{
	...
	bLocal_81 = joaat("LANDSTALKER");
	vLocal_82 = { -1473.376f, 517.8441f, 116.8854f };
	bLocal_85 = 97.3011f;
	bLocal_162 = joaat("DOMINATOR");
	bLocal_163 = joaat("LANDSTALKER");
	bLocal_164 = "Dreyfuss";
	bLocal_331 = true;
	fLocal_334 = 25f;
	...
	{
		bLocal_156 = Local_86.f_28[0];
		UNK_0x73270B3C9CC833FD(bLocal_156, true, 1);
	}
	func_436();
	if (func_447())
	{
...
int func_225(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_246()
{
	switch (iLocal_155)
	{
		case 0:
			...
			if (func_437(bLocal_156))
			{
				UNK_0xDD353D0E9C789D0E(&iLocal_160);
				if (UNK_0x405E212DDE472467(bLocal_156, 0))
				{
					UNK_0x75CDA8644CD3B5F5(false, 0, 0);
				}
				UNK_0xF3268524E9BE6D6E(false, UNK_0x16F2683693E537C9(), 500f, -1, 0, 0);
				UNK_0x75ABDC5F81978924(iLocal_160);
				UNK_0x78ADC381772E3D54(bLocal_156, iLocal_160);
				UNK_0xF82EA857DA10E0CD(&iLocal_160);
			}
			func_243();
			bLocal_537 = false;
			iLocal_155 = 1;
		...
		case 1:
			...
			if (!func_437(bLocal_156))
			{
				...
				if (!UNK_0xEAE0D21A50E6C7F4(Global_111638.f_18569.f_382, false))
				{
					UNK_0x5D96D8530B3D0904(&(Global_111638.f_18569.f_382), false);
				}
				func_295(4);
			}
			else if (func_293(UNK_0x16F2683693E537C9(), bLocal_156) > 250f)
			{
			...
			{
				func_263(&uLocal_549, bLocal_156, 0, 0, 1, 1, 1);
				func_260(&iLocal_157, "", "", &uLocal_538, iLocal_539, 0);
				func_247();
				UNK_0x16F8631A5D4FBCE5(bLocal_156, 1.8f);
			}
			break;
		case 2:
			break;
...
void func_247()
{
	if (!bLocal_507)
	{
		if (func_259(UNK_0x16F2683693E537C9(), bLocal_156, fLocal_334, 1))
		{
			if (UNK_0x36646919F20EAFFC(bLocal_156))
			{
...
void func_248(int iParam0, int iParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, bool bParam6)
{
	...
	if (!*uParam3)
	{
		if (!bLocal_537)
		{
			if (!*iParam0)
			{
				if ((func_249(bLocal_156) && !UNK_0x869EFD0BC0868856(bLocal_156)) && !UNK_0x46BC6F5F089F3AFF(bLocal_156))
				{
					if (func_259(UNK_0x16F2683693E537C9(), bLocal_156, fLocal_334, 1))
					{
						if (!func_242())
	...
	else if ((bParam6 && !iLocal_548 == 0) && !func_242())
	{
		...
		if (iLocal_548 == 1 && UNK_0xC844350D5D58C99A(bLocal_156))
		{
			UNK_0xE910A68AA670B4AA(bLocal_156);
		}
		iLocal_548 = 0;
	}
}
...
int func_250(int iParam0)
{
	if (iLocal_548 == 0)
	{
		if (func_251(bLocal_156, 1, 0, 0, 0) && iLocal_518 < 3)
		{
			func_243();
			iLocal_548 = 2;
		}
		else if (UNK_0xB87D13D0C064E9D1(bLocal_156, UNK_0x16F2683693E537C9(), iParam0) && iLocal_519 < 4)
		{
			func_243();
			iLocal_548 = 1;
		}
...
bool func_251(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_437(UNK_0x16F2683693E537C9()) && func_437(bParam0))
	{
...
bool func_252(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_253(bool bParam0, float fParam1)
{
	...
	{
		if (func_254(bParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_254(bool bParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_256(vParam1 - UNK_0x68F4C0EC296D3901(bParam0, true)) };
	...
	{
		vVar3 = { func_256(UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 5f, 0f) - UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_257(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (UNK_0x168558745A6AC21E(UNK_0x16F2683693E537C9()))
...
bool func_259(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
	return SYSTEM::VDIST2(UNK_0x68F4C0EC296D3901(bParam0, bParam3), UNK_0x68F4C0EC296D3901(bParam1, bParam3)) <= (fParam2 * fParam2);
}

void func_260(int iParam0, bool bParam1, bool bParam2, var uParam3, int iParam4, bool bParam5)
{
	if (UNK_0xE4EDC4B0E92C078B(*iParam0))
	{
		if ((UNK_0x1C0640BA9A7327B3() - *uParam3) > 500)
		{
			if (UNK_0x8FBD6436A27198B4(*iParam0) == 1)
			{
				...
				{
					if (!UNK_0xD17F06053799A7CA() || func_262(bParam1, 0, 0))
					{
						func_261(bParam2, 7500, 0);
					}
				}
			...
			else
			{
				...
				if ((UNK_0x1C0640BA9A7327B3() - iParam4) < 7500 && bParam5)
				{
					if (!UNK_0xD17F06053799A7CA() || func_262(bParam2, 0, 0))
					{
						func_261(bParam1, 7500, 0);
					}
				}
				*uParam3 = UNK_0x1C0640BA9A7327B3();
			}
	...
	{
		if (func_262(bParam1, 0, 0))
		{
			UNK_0x2F23E8033F1ADDD9(bParam1);
		}
		if (func_262(bParam2, 0, 0))
		{
...
void func_263(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_264(uParam0, bParam1, iParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_264(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_265(uParam0, bParam1, 0f, 0f, 0f, iParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_265(var uParam0, bool bParam1, vector3 vParam2, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9)
{
	...
	uParam0->f_6 = 2;
	func_266(uParam0, bParam1, vParam2, iParam5, iParam6, bParam7, iParam8, bParam9);
}

void func_266(var uParam0, bool bParam1, vector3 vParam2, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	bool bVar0;
	bool bVar1;
	...
	if (func_291(bParam1) && UNK_0x4FC40AB0ECCE6E18(bParam1))
	{
		bVar1 = false;
		...
		if (!UNK_0x8C74DE122769E1BF())
		{
			...
			{
				func_282(uParam0, bParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
bool func_272(bool bParam0, bool bParam1, bool bParam2)
{
	bool bVar0;
	bool bVar1;
	...
	if ((func_279() || func_278(Global_4456448.f_232883)) || func_277())
	{
		if (UNK_0x405E212DDE472467(UNK_0x16F2683693E537C9(), 0))
		{
			...
			bVar1 = func_276(UNK_0x16F2683693E537C9(), 0);
			if (((UNK_0x137240CA2BADB0D2(bVar0, bVar1) || (UNK_0x134B62B726CEC8E6(bVar0) == joaat("APC") && bVar1 != -1)) || (UNK_0x134B62B726CEC8E6(bVar0) == joaat("AKULA") && bVar1 != -1)) || (((UNK_0x134B62B726CEC8E6(bVar0) == joaat("RIOT2") && bVar1 == 0) && func_275(bVar0, 10)) && UNK_0x0ECB5CA5140957AD(bVar0, 10) != -1))
			{
				return false;
			}
		}
...
bool func_273(bool bParam0)
{
	if (bParam0 != func_231())
	{
		if (func_274(bParam0, 1, 1))
		{
			return Global_2425662[bParam0 /*421*/].f_310.f_5 != -1;
		}
		else if ((Global_1312877 && bParam0 == UNK_0xD803B885F5E47A62()) && func_274(bParam0, 1, 0))
		{
			return Global_2425662[bParam0 /*421*/].f_310.f_5 != -1;
		}
	}
...
void func_282(var uParam0, bool bParam1, vector3 vParam2, bool bParam5)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_287(bool bParam0, bool bParam1, bool bParam2)
{
...
void func_297()
{
	if (func_437(bLocal_156))
	{
		if (UNK_0x0361981EE62202D8(bLocal_156, joaat("WEAPON_STUNGUN"), 0))
		{
			if (func_437(bLocal_156))
			{
				UNK_0xD458AC1C1D29C3B4(bLocal_156, 99, false);
			}
		}
	}
}
	...
	switch (iLocal_155)
	{
		case 0:
			...
			if (func_437(Local_86.f_35[0]))
			{
				...
				while (iVar0 < 3)
				{
					vLocal_526[iVar0 /*3*/] = { UNK_0x68F4C0EC296D3901(Local_86.f_35[0], true) };
					iVar0++;
				}
			}
		...
		case 1:
			...
			else
			{
				if (func_437(Local_86.f_35[0]))
				{
					...
					if (((!bLocal_332 && !bLocal_333) && UNK_0x0E0E6175453415CB(bLocal_156)) && !UNK_0x5A91F08DF773C39D(Local_86.f_35[0], -1474.445f, 519.4703f, 117.0069f, 15f, 15f, 15f, false, true, 0))
					{
						UNK_0x89258193691A7600(bLocal_156, Local_86.f_35[0], UNK_0x16F2683693E537C9(), 8, 90f, 786469, 100f, 1f, 1);
						bLocal_333 = true;
					}
				}
				func_250(0);
				func_263(&uLocal_549, bLocal_156, 0, 0, 1, 1, 1);
				if (((!bLocal_332 && func_259(UNK_0x16F2683693E537C9(), bLocal_156, 10f, 1)) && UNK_0x0E0E6175453415CB(UNK_0x16F2683693E537C9())) && UNK_0x0E0E6175453415CB(bLocal_156))
				{
					UNK_0x89258193691A7600(bLocal_156, Local_86.f_35[0], UNK_0x16F2683693E537C9(), 8, 90f, 786468, 100f, 1f, 1);
					bLocal_332 = true;
				}
				if (!func_304())
				{
...
void func_299()
{
	if (func_437(Local_86.f_35[0]))
	{
		...
		else if (UNK_0x36646919F20EAFFC(bLocal_156) || !func_3(Local_86.f_35[0]))
		{
			bLocal_332 = true;
			func_295(3);
		}
...
bool func_300()
{
	if (func_437(Local_86.f_35[0]))
	{
		if (UNK_0xC42A92762C58E1B9(bLocal_156, Local_86.f_35[0], 0))
		{
...
void func_302()
{
	...
	vLocal_526[2 /*3*/] = { UNK_0x68F4C0EC296D3901(Local_86.f_35[0], true) };
}
...
bool func_303()
{
	...
	{
		iVar0 = 0;
		if (UNK_0x464B3D84B739AE72(Local_86.f_35[0], false, 0))
		{
			iVar0++;
		}
		if (UNK_0x464B3D84B739AE72(Local_86.f_35[0], true, 0))
		{
			iVar0++;
		}
...
bool func_304()
{
	if (func_249(UNK_0x16F2683693E537C9()))
	{
		if (UNK_0xC844350D5D58C99A(Local_86.f_35[0]))
		{
			if (func_437(Local_86.f_35[0]))
			{
				if (func_259(bLocal_156, Local_86.f_35[0], 5f, 1))
				{
...
bool func_305(bool bParam0)
{
	...
	bVar0 = UNK_0x83C1D4B63BBD91F6(UNK_0x68F4C0EC296D3901(Local_86.f_35[0], true), 20f, bParam0, 6);
	if (UNK_0xC844350D5D58C99A(bVar0))
	{
		if (UNK_0x6D18156F72BE0773(bVar0, Local_86.f_35[0]))
		{
	...
	switch (iLocal_155)
	{
		case 0:
			...
			if (func_3(Local_86.f_35[0]))
			{
				...
				UNK_0x56FDC9ADE35F7DB0(Local_86.f_35[0], true, true, 0);
				UNK_0x611DFA9294B339CA(Local_86.f_35[0], false, 0, false);
			}
			if (func_437(bLocal_156))
			{
				UNK_0xDEAC6BC509D10068(bLocal_156, 3f);
				if (!UNK_0xE4EDC4B0E92C078B(iLocal_157))
				{
					iLocal_157 = func_313(bLocal_156, 1, 0, 5);
				}
				func_312(&iLocal_157, "", "", &uLocal_538, &iLocal_539, 1, 0);
				if (func_3(Local_86.f_35[0]))
				{
					UNK_0xDD353D0E9C789D0E(&iLocal_159);
					UNK_0x96167B03C5A77156(false, -1472.27f, 513.9628f, 116.898f, 3f, 20000, 0.25f, 1, 1193033728);
					UNK_0x5B1D360B9C6F0A09(false, Local_86.f_35[0], 20000, -1, 3f, 1, 0);
					UNK_0xE072601B4380E9DF(false, Local_86.f_35[0], 15f, 262144);
					UNK_0x75ABDC5F81978924(iLocal_159);
					UNK_0x78ADC381772E3D54(bLocal_156, iLocal_159);
					iLocal_330 = UNK_0xA4B9EE930B45BDFA(UNK_0x68F4C0EC296D3901(Local_86.f_35[0], true), 100f, 10f, 0);
				}
				else
				{
					UNK_0xF3268524E9BE6D6E(bLocal_156, UNK_0x16F2683693E537C9(), 500f, -1, 0, 0);
				}
			}
			if (!UNK_0xC844350D5D58C99A(bLocal_161))
			{
				UNK_0x523BCC9DC80CD82F(bLocal_162);
				while (!UNK_0xB87F6CF6E5628C67(bLocal_162))
				{
					SYSTEM::WAIT(0);
				}
				bLocal_161 = UNK_0x122AAB0B1D6F55AD(bLocal_162, -1482.366f, 529.0344f, 117.2725f, 201.5764f, true, true, false);
				UNK_0x71199B01895C6202(bLocal_162);
			}
			func_311(500, 0);
		...
		case 1:
			...
			else
			{
				...
				if ((func_307(242628503) && UNK_0x4F1B602325013CC2(bLocal_156) > 0) && func_303())
				{
					func_295(3);
				}
			}
...
{
	if (UNK_0xD1960163A3042274(bLocal_156, iParam0) == 1 || UNK_0xD1960163A3042274(bLocal_156, iParam0) == 0)
	{
		return true;
	}
	return false;
...
bool func_308()
{
	if (UNK_0xC844350D5D58C99A(Local_86.f_35[0]))
	{
		...
		{
			if (UNK_0x4F1B602325013CC2(bLocal_156) > 0)
			{
				...
				{
					if (!func_309(bLocal_156, Local_86.f_35[0], 1126825984 /* Float: 170f */, 0))
					{
						sLocal_423 = "DREY1_CGONE";
						bLocal_332 = true;
						func_295(3);
...
bool func_309(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_256(UNK_0x68F4C0EC296D3901(bParam1, true) - UNK_0x68F4C0EC296D3901(bParam0, true)) };
...
void func_310()
{
	if (func_249(bLocal_156) && func_3(Local_86.f_35[0]))
	{
		if (UNK_0x82CCEAB29E9451DD(bLocal_156, Local_86.f_35[0]))
		{
			if (UNK_0xE4EDC4B0E92C078B(iLocal_157))
			{
...
void func_312(int iParam0, bool bParam1, bool bParam2, var uParam3, int iParam4, bool bParam5, bool bParam6)
{
	if (UNK_0xE4EDC4B0E92C078B(*iParam0))
	{
		if (bParam5)
...
void func_316()
{
	switch (iLocal_155)
	{
		case 0:
			...
			if (((UNK_0x0F1CCD77290EE12F() && !func_447()) && func_437(bLocal_156)) && func_294(UNK_0x16F2683693E537C9(), Local_86.f_28[0], 1) > 4f)
			{
				UNK_0xC0B0B9E466C0ED17(bLocal_156, 0f, 0f, -0.5f, 1, -1, 3000, 2000, false);
			...
			func_401(&bLocal_565, 0);
			bLocal_565 = UNK_0x4B72871A3BE7B474(-1459.57f, 485.16f, 115.2f, 10f, joaat("PROP_YOGA_MAT_02"), 1, 0, 1);
			if (UNK_0xC844350D5D58C99A(bLocal_565))
			{
				UNK_0x1E9649458B15960F(bLocal_565, true);
			}
			iLocal_155 = 1;
			iLocal_564 = 0;
			break;
		case 1:
			switch (iLocal_562)
			{
				case 0:
					...
					{
						func_393();
						if ((!func_242() && func_437(bLocal_156)) && func_258(&uLocal_165, "DREY1AU", "DREY1_RCM_LI", 8, 0, 0, 0))
						{
							UNK_0x0C8C0C840C2D1AD2(UNK_0x16F2683693E537C9(), bLocal_156, -1, 0, 2);
							iLocal_562++;
						}
					}
					break;
				case 1:
					if (func_437(UNK_0x16F2683693E537C9()))
					{
						...
						if (!func_242() && func_387(1, 1093140480 /* Float: 10.5f */, 0))
						{
							if (func_437(bLocal_156))
							{
								UNK_0x29E8331978B73E7F(bLocal_156, bLocal_164, 0, false, 0);
							}
							func_386();
				...
				case 3:
					...
					else
					{
						...
						if (UNK_0x3148AE92ED70DC30("Dreyfuss", 0) && func_437(bLocal_156))
						{
							UNK_0x96167B03C5A77156(bLocal_156, -1475.366f, 500.3797f, 116.6013f, 3f, 20000, 0.25f, 1, 1193033728);
						}
					}
					break;
			}
...
void func_318(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_324(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
	...
	if (UNK_0xC844350D5D58C99A(Global_102203.f_4))
	{
		if (UNK_0xDF1306B443CD3D15(Global_102203.f_4, 0))
		{
			if (func_376(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_373(UNK_0x68F4C0EC296D3901(Global_102203.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
...
void func_330(bool bParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (UNK_0xC844350D5D58C99A(bParam0) && UNK_0xDF1306B443CD3D15(bParam0, 0))
	{
		...
		func_364(iParam5, &Var0, vParam1, iParam4, func_367(bParam0));
		func_331(iParam5, bParam0, 0);
	}
}
...
void func_332(bool bParam0, int iParam1)
{
	...
	func_368(bParam0, &(Global_111638.f_32744.f_5510));
}

bool func_333(bool bParam0)
{
	if ((((((((((!UNK_0xC844350D5D58C99A(bParam0) || !UNK_0xDF1306B443CD3D15(bParam0, 0)) || func_348(bParam0, 0, 0)) || func_348(bParam0, 1, 0)) || func_348(bParam0, 2, 0)) || func_367(bParam0) != 145) || func_347(bParam0)) || func_346(bParam0)) || func_345(bParam0)) || func_344(bParam0)) || !func_334(UNK_0x134B62B726CEC8E6(bParam0)))
	{
		if (func_346(bParam0))
		{
		}
...
bool func_349(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_356(UNK_0xEAE0D21A50E6C7F4(bParam0, 31), -1, 1)) + 2011;
}
...
void func_364(int iParam0, var uParam1, vector3 vParam2, int iParam5, int iParam6)
{
	if (func_361(&(Global_75441.f_555[0 /*21*/]), iParam0))
	{
...
bool func_373(vector3 vParam0, var uParam3, var uParam4, var uParam5)
{
	int iVar0;

	iVar0 = func_374(vParam0, uParam3, 1);
	switch (iVar0)
	{
		case 0:
...
void func_377(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, int iParam10, int iParam11, int iParam12, bool bParam13, float fParam14, var uParam15)
{
	func_378(vParam0, vParam3, fParam6, vParam7, iParam10, 0f, 0f, 0f, iParam11, iParam12, bParam13, fParam14, uParam15);
}

void func_378(vector3 vParam0, vector3 vParam3, bool bParam6, vector3 vParam7, bool bParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (UNK_0xC844350D5D58C99A(bVar0))
	{
		...
		if (UNK_0xDF1306B443CD3D15(bVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_380(bVar0, vParam0, vParam3, bParam6))
					{
						bVar1 = true;
					}
				}
...
bool func_380(bool bParam0, vector3 vParam1, vector3 vParam4, bool bParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_384(bool bParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_387(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (UNK_0x405E212DDE472467(UNK_0x16F2683693E537C9(), 0))
	{
		...
		{
			if (!func_391(UNK_0x6937EA2286828455(UNK_0x16F2683693E537C9(), 0), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_391(bool bParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_393()
{
	...
	if (iLocal_564 == 0)
	{
		if (func_437(bLocal_156))
		{
			if (func_294(UNK_0x16F2683693E537C9(), bLocal_156, 1) < 3f)
			{
				iLocal_564 = 1;
				UNK_0x98E4DC66A651C9FA(UNK_0xD803B885F5E47A62(), false, false);
				UNK_0xA3BF0AA5A2608191(UNK_0x16F2683693E537C9());
				UNK_0xF96A174EE26D7588(UNK_0x16F2683693E537C9(), bLocal_156, 0);
			}
		}
	}
}
...
void func_395()
{
	if (UNK_0xE1DBBD6CE209517C(UNK_0xD803B885F5E47A62()))
	{
		if (UNK_0x405E212DDE472467(UNK_0x16F2683693E537C9(), 0))
		{
			if (func_391(UNK_0x6937EA2286828455(UNK_0x16F2683693E537C9(), 0), 10.5f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
...
bool func_414(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
void func_421(bool bParam0, bool bParam1, int iParam2)
{
...
void func_424()
{
	if (!func_437(Local_86.f_35[0]))
	{
		UNK_0x523BCC9DC80CD82F(bLocal_163);
		while (!UNK_0xB87F6CF6E5628C67(bLocal_163))
		{
			SYSTEM::WAIT(0);
		}
		Local_86.f_35[0] = UNK_0x122AAB0B1D6F55AD(bLocal_163, vLocal_82, bLocal_85, true, true, false);
		UNK_0x71199B01895C6202(bLocal_163);
	}
	if (func_437(Local_86.f_35[0]))
	{
		UNK_0x67E3D6EA8D96FD85(Local_86.f_35[0], 0);
		UNK_0xC6A6B4DDD6DC073A(Local_86.f_35[0], true);
...
void func_425()
{
	if (!func_437(bLocal_156))
	{
		while (!func_427(&bLocal_156, 68, -1472.9f, 483.3f, 115.2f, 75f, 1))
		{
			SYSTEM::WAIT(0);
		}
	}
	if (func_437(bLocal_156))
	{
		func_426(&uLocal_165, 3, bLocal_156, "DREYFUSS", 0, 1);
		UNK_0x4E885A246A9D983A(bLocal_156, 177, true);
		UNK_0x25C5402CC10F76CD(bLocal_156, true);
		UNK_0xE2F0767314863BD8(bLocal_156, 1, 0);
		UNK_0xE8832A9E16A57A1F(bLocal_156, true, 1);
		UNK_0x291398BF0ED6A2E2(bLocal_156, 0);
		UNK_0x11AD11297DC58CC7(bLocal_156, true);
		UNK_0x4E885A246A9D983A(bLocal_156, 281, true);
		UNK_0x4E885A246A9D983A(bLocal_156, 42, true);
	}
}
...
bool func_427(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6)
{
	bool bVar0;
...
bool func_429(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_436()
{
	...
	UNK_0xAB8E2DDC7AF955E0(bLocal_81, true);
	func_432();
	UNK_0x0674E58A79778E99(&(Global_111638.f_18569.f_382), false);
	UNK_0xD7992BEF7A9D109E("DREY1", false);
...
bool func_440(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			break;
		case 1:
			if (!func_445(&bVar0) || !func_443(&(uParam0->f_48)))
			{
				return false;
			}
			iLocal_79 = 2;
		...
		case 2:
			...
			{
				func_441(&(uParam0->f_35[0]), bVar0[1], vLocal_82, bLocal_85);
				if (func_437(uParam0->f_35[0]))
				{
					UNK_0xC6A6B4DDD6DC073A(uParam0->f_35[0], true);
...
void func_441(bool bParam0, bool bParam1, vector3 vParam2, bool bParam5)
{
	func_2(bParam0);
...
bool func_442(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	if (func_427(bParam0, iParam1, vParam2, fParam5, 1))
	{
		if (UNK_0xC844350D5D58C99A(*bParam0))
		{
			if (!UNK_0x437347B10A200C4B(*bParam0, 0))
...
void func_448()
{
	...
	UNK_0xAB8E2DDC7AF955E0(bLocal_81, false);
	func_190(99, 0, 1, 1, 0);
	func_401(&bLocal_565, 0);
...
void func_458(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	if (UNK_0xC844350D5D58C99A(*bParam0))
	{
		if (!UNK_0xEB6A8945D1AC98A1(*bParam0))
...
void func_459()
{
	...
	func_6(&iLocal_157);
	if (func_249(bLocal_156))
	{
		UNK_0xFADC0A217229F6B5(bLocal_156, true);
		UNK_0xE8832A9E16A57A1F(bLocal_156, false, 1);
	}
	func_458(&bLocal_156, 1, 0, 1);
	func_455(&bLocal_161);
	func_460();
	UNK_0xF858EFDE1871B5F2(Local_147, Local_147.f_3, true, 1);
	UNK_0x5A5CC21130AD387A(iLocal_330);
}
...
bool func_466(char* sParam0, int iParam1, int iParam2)
{
	bool bVar0;
	struct<32> Var1;
	int iVar33;

...
bool func_251(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_252(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_254(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
bool func_257(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_282(var uParam0, int iParam1, vector3 vParam2, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_316()
{
	switch (iLocal_155)
	{
		case 0:
			...
			{
				CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_156, 0f, 0f, -0.5f, true, -1, 3000, 2000, false);
...
void func_377(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, int iParam10, int iParam11, int iParam12, float fParam13, float fParam14, var uParam15)
{
	func_378(vParam0, vParam3, fParam6, vParam7, iParam10, 0f, 0f, 0f, iParam11, iParam12, fParam13, fParam14, uParam15);
}
...
bool func_380(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool func_391(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
bool func_427(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
bool func_429(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
bool func_442(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{

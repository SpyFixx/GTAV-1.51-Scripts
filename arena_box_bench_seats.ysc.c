...
void func_3(var uParam0, int iParam1)
{
	...
	if (uParam0->f_281.f_5 > 2)
	{
		...
		{
			if (((ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && NETWORK::NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(iParam1->f_14[uParam0->f_281.f_2])) && NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(iParam1->f_14[uParam0->f_281.f_2]))
			{
				if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), PLAYER::PLAYER_PED_ID()))
				{
		...
		fVar0 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_281.f_1);
...
void func_36(var uParam0, var uParam1)
{
	...
	if (*uParam1)
	{
		if (!NETWORK::NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(uParam1->f_14[uParam0->f_281.f_4]))
		{
			...
			if (func_37(NETWORK::CAN_REGISTER_MISSION_ENTITIES(false, 1) + 1, 0, 1))
			{
				...
				else if (NETWORK::_RESERVE_NETWORK_LOCAL_VEHICLES(1))
				{
	...
	switch (uParam0->f_281.f_5)
	{
		...
		case 6:
			...
			if (((iVar29 != 1 && iVar29 != 0) || func_101(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar33, 5f)) || func_34(&(uParam0->f_281), 14))
			{
				...
				uParam0->f_281.f_1 = NETWORK::_0x77758139EC9B66C7(vVar36, func_115(uParam0), 2, true, false, 1065353216 /* Float: 1f */, fVar35, fVar34);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_281.f_1, &uVar0, &uVar16, 2f, -1000f, 13, 16, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_281.f_1);
		...
		case 7:
			...
			fVar20 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_281.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fVar20))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fVar20) >= 1f)
				{
					if (!Global_2513612)
					{
						if (!ENTITY::IS_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID()) && !NETWORK::NETWORK_IS_PLAYER_FADING(PLAYER::PLAYER_PED_ID()))
						{
							if (Global_1312792)
							{
					...
					func_119(uParam0, &uVar0);
					func_117(uParam0, &uVar16, 0);
					uParam0->f_281.f_1 = NETWORK::_0x77758139EC9B66C7(func_116(uParam0), func_115(uParam0), 2, true, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
					NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_281.f_1, &uVar0, &uVar16, 4f, -1.5f, 13, 16, 1148846080 /* Float: 1000f */, 0);
					NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_281.f_1);
					func_120(&(uParam0->f_281), 8);
				...
				{
					if (uParam0->f_281.f_9 == 1 && (ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), 1374875855) || PED::GET_SYNCHRONIZED_SCENE_PHASE(fVar20) > 0.25f))
					{
		...
		case 8:
			...
			if (uParam0->f_281.f_9 == 1 && uParam0->f_281.f_2 >= 0)
			{
				if (NETWORK::NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(iParam1->f_14[uParam0->f_281.f_2]) && NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(iParam1->f_14[uParam0->f_281.f_2]))
				{
					...
					ENTITY::SET_ENTITY_COORDS_NO_OFFSET(NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), vVar41, false, false, true);
					ENTITY::SET_ENTITY_ROTATION(NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), vVar44, 2, true);
		...
		case 9:
			...
			fVar47 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_281.f_1);
			iVar48 = TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 1785177548);
			if (iVar48 == 0 || iVar48 == 1)
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fVar47))
				{
					if ((PED::GET_SYNCHRONIZED_SCENE_PHASE(fVar47) >= 0.7f || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), 364629851)) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), 2116425869))
					{
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_281.f_1);
						if ((!MISC::IS_BIT_SET(Global_1695469, 7) && !MISC::IS_BIT_SET(Global_1695469, 3)) && !func_22(PLAYER::PLAYER_ID()))
						{
						...
						if (uParam0->f_281.f_9 == 1 && uParam0->f_281.f_2 >= 0)
						{
							if (NETWORK::NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(iParam1->f_14[uParam0->f_281.f_2]) && NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(iParam1->f_14[uParam0->f_281.f_2]))
							{
								...
								ENTITY::SET_ENTITY_COORDS_NO_OFFSET(NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), vVar49, false, false, true);
								ENTITY::SET_ENTITY_ROTATION(NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), vVar52, 2, true);
								ENTITY::FREEZE_ENTITY_POSITION(NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), true);
							}
						}
						if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
...
int func_93(int iParam0, int iParam1, int iParam2)
{
	...
	Global_2513624 = 0;
	Global_2513626 = 0;
	Global_2513634 = NETWORK::GET_NETWORK_TIME();
	Global_2513627 = 1;
	return 1;
}
...
void func_100(var uParam0)
{
	...
	uParam0->f_281.f_1 = NETWORK::_0x77758139EC9B66C7(func_116(uParam0), func_115(uParam0), 2, true, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
	func_119(uParam0, &uVar0);
	NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_281.f_1, &uVar0, "exit", 4f, -4f, 13, 16, 1148846080 /* Float: 1000f */, 0);
	NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_281.f_1);
	func_30(&(uParam0->f_281.f_6));
...
bool func_101(float fParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
...
int func_102(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, float fParam12)
{
	...
	if (((!vParam0.x == Global_2439138.f_1235 || !vParam0.y == Global_2439138.f_1235.f_1) || !vParam0.z == Global_2439138.f_1235.f_2) || !fParam3 == Global_2439138.f_1238)
	{
		...
		{
			if (NETWORK::IS_TIME_EQUAL_TO(NETWORK::_0xBA7F0B77D80A4EB7(), Global_2439138.f_1239) < func_105(0))
			{
				return 0;
			}
			PLAYER::STOP_PLAYER_TELEPORT();
...
bool func_103(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
...
bool func_129(int iParam0, vector3 vParam1)
{

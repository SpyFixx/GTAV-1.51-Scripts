...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		else if (Var0 == 19)
		{
			...
			if ((((((!func_190() && func_189(Var0.f_28[0])) && !UNK_0x7DECE00E09F41C95(Var0.f_28[0])) && UNK_0x8AA6DC470ABA63A2(iLocal_96)) && UNK_0xAE317D00A5A55DF6("EXTREME_04_DOM_A", 0, -1)) && UNK_0xAE317D00A5A55DF6("EXTREME_04_DOM_B", 0, -1)) && UNK_0xAE317D00A5A55DF6("EXTREME_04_DOM_C", 0, -1))
			{
				UNK_0xCEAA091B490F8407(iLocal_96, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
...
void func_146()
{
	if (UNK_0xE1DBBD6CE209517C(UNK_0xD803B885F5E47A62()))
	{
		if (UNK_0x405E212DDE472467(UNK_0x16F2683693E537C9(), 0))
		{
			if (func_147(UNK_0x6937EA2286828455(UNK_0x16F2683693E537C9(), 0), 10.5f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
...
bool func_147(bool bParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
int func_171(var uParam0)
{
	if (*uParam0 == 18)
	{
		if (UNK_0x3D1053F9EB43B7AD(UNK_0x16F2683693E537C9(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, true, 0))
		{
			...
			else if ((!func_172(UNK_0x16F2683693E537C9(), -828834893) && func_189(UNK_0x6937EA2286828455(UNK_0x16F2683693E537C9(), 0))) && func_147(UNK_0x6937EA2286828455(UNK_0x16F2683693E537C9(), 0), 3f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				UNK_0x75CDA8644CD3B5F5(UNK_0x16F2683693E537C9(), 0, 0);
			}
		}
...
float func_195(bool bParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_197(int iParam0, bool bParam1, vector3 vParam2)
{
	if (UNK_0xE1DBBD6CE209517C(UNK_0xD803B885F5E47A62()))
	{
	...
	if (func_189(bParam0))
	{
		switch (uParam1->f_3)
		{
			case 1:
				...
				break;
			case 2:
				if (!func_208(uParam1) || !UNK_0xB4ECF989E2C1DAC8(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_207(iParam2) && !UNK_0x7069CC4DE1EA3FAA(bParam0, UNK_0x16F2683693E537C9(), 25f))
					{
						UNK_0xF96A174EE26D7588(bParam0, UNK_0x16F2683693E537C9(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && UNK_0x0EB28750412C3A5A(UNK_0x68F4C0EC296D3901(UNK_0x16F2683693E537C9(), true), UNK_0x68F4C0EC296D3901(bParam0, true), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 3:
				...
				break;
			case 5:
				if (!func_207(iParam2) || UNK_0x7069CC4DE1EA3FAA(bParam0, UNK_0x16F2683693E537C9(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						UNK_0xC6EB89C59F2AF6B8(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, false, 0, 0, 0);
...
bool func_215(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_217(bool bParam0, float fParam1)
{
	bool bVar0;

	if (func_189(UNK_0x16F2683693E537C9()) && func_189(bParam0))
	{
		if (func_228(bParam0) || UNK_0x292E02BF8ABF889C(UNK_0xD803B885F5E47A62(), bParam0))
		{
...
{
	return func_219(bParam0, UNK_0x16F2683693E537C9(), fParam1, 1, 250, 7);
}

bool func_219(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;

	iVar4 = func_227(bParam0, bParam1);
	if (!func_189(bParam0) || !func_189(bParam1))
	{
		if (iVar4 != -1)
		{
	...
	bVar0 = func_220(&(Local_37[iVar4 /*4*/]), vVar1, bParam1, &(Local_37[iVar4 /*4*/].f_3), bParam0, iParam5);
	return (bVar0 || (UNK_0x1C0640BA9A7327B3() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_220(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_221(bParam4, iParam7) };
...
Vector3 func_221(bool bParam0, int iParam1)
{
	int iVar0;
...
bool func_223(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_225(UNK_0x68F4C0EC296D3901(bParam1, true) - UNK_0x68F4C0EC296D3901(bParam0, true)) };
	...
	{
		vVar3 = { func_225(UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 5f, 0f) - UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_229(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	bool bVar1;
	int iVar2;
	...
	if (func_189(UNK_0x16F2683693E537C9()) && func_189(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_233(bParam0, bParam1, fVar0, bVar1))
			{
				return true;
			}
			if (func_230(bParam0, bVar1, bParam3, bParam4))
			{
				return true;
			}
		}
...
bool func_230(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_231(bool bParam0, bool bParam1)
{
	...
	{
		if (func_232(bParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_232(bool bParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_225(vParam1 - UNK_0x68F4C0EC296D3901(bParam0, true)) };
...
bool func_233(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
	if (bParam1)
	{
		if (UNK_0x168558745A6AC21E(UNK_0x16F2683693E537C9()))
...
bool func_244(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			break;
		case 1:
			if (!func_249(&bVar0) || !func_248(&(iParam0->f_48)))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			UNK_0x8D6AA03C7E479C0D(iParam0->f_28[0], 1);
...
void func_245(bool bParam0, vector3 vParam1, float fParam4)
{
	func_246(bParam0, bLocal_93, vParam1, fParam4, 26);
	UNK_0x78ED16BE998AECC7(*bParam0);
	UNK_0xF4CB0B98F8F79D8D(*bParam0, 0);
	UNK_0x5F2AA9E2843E9403(*bParam0, "EXTREME LAUNCHER RC");
}

void func_246(bool bParam0, bool bParam1, vector3 vParam2, bool bParam5, int iParam6)
{
	func_247(bParam0);
		...
		case 2:
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_28[0]))
			{
				if (func_252(&(iParam0->f_28[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					...
					UNK_0x262EF6C6306BEA6C(iParam0->f_28[0], joaat("GADGET_PARACHUTE"), true, false, false);
...
bool func_252(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	if (func_253(bParam0, iParam1, vParam2, fParam5, 1))
	{
		if (UNK_0xC844350D5D58C99A(*bParam0))
		{
			if (!UNK_0x437347B10A200C4B(*bParam0, 0))
...
bool func_253(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6)
{
	bool bVar0;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_28[0]))
			{
				...
				{
					UNK_0x08841CDB215AE18F(iParam0->f_28[0], -954.2f, -2760.05f, 14.04f, 1, 0, 1);
					UNK_0x4E885A246A9D983A(iParam0->f_28[0], 118, false);
					UNK_0x4E885A246A9D983A(iParam0->f_28[0], 208, true);
					UNK_0x1E9649458B15960F(iParam0->f_28[0], true);
					UNK_0x20641932E5104B25(iParam0->f_28[0], false, 0);
					UNK_0x64F9F278AB9DCA2C(iParam0->f_28[0], 8, true, false, 0);
					UNK_0xC6EB89C59F2AF6B8(iParam0->f_28[0], iParam0->f_48, iParam0->f_48.f_1, 8f, -8f, -1, 33281, false, 0, 0, 0);
					if (UNK_0xC844350D5D58C99A(UNK_0x16F2683693E537C9()))
					{
						UNK_0x0C8C0C840C2D1AD2(iParam0->f_28[0], UNK_0x16F2683693E537C9(), -1, 48, 2);
					}
				}
				else
				{
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_35[0]))
			{
				...
				UNK_0xCCD53AC1B5D5E456(iParam0->f_35[0], 0f);
			}
			if (!UNK_0xC844350D5D58C99A(iParam0->f_35[1]))
			{
				...
				UNK_0xCCD53AC1B5D5E456(iParam0->f_35[1], 0f);
			}
			if (!UNK_0xC844350D5D58C99A(iParam0->f_35[2]))
			{
				func_256(&(iParam0->f_35[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
				UNK_0x71EDC33E5A423750(iParam0->f_35[2], 2);
				UNK_0xC6A6B4DDD6DC073A(iParam0->f_35[2], 2);
				UNK_0xCCD53AC1B5D5E456(iParam0->f_35[2], 0f);
				UNK_0x05EC10F460C3A4AF(iParam0->f_35[2], 0);
				UNK_0x9A8BCD43DBDDCDCA(iParam0->f_35[2], 0, 0);
			}
			if (bVar5)
			{
				iLocal_91 = 3;
...
bool func_269(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
...
bool func_271(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;

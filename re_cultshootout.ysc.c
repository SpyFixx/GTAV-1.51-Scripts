...
void func_1()
{
	if (bLocal_88 && !bLocal_87)
	{
		...
		while (iLocal_125 < 6)
		{
			...
			{
				if (HUD::DOES_BLIP_EXIST(iLocal_116[iLocal_125]))
				{
					HUD::REMOVE_BLIP(&(iLocal_116[iLocal_125]));
				}
...
bool func_115(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;

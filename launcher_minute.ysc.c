...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_207(329.513f, 3402.691f, 36.258f, UNK_0x68F4C0EC296D3901(Var0.f_35[1], true), 1056964608 /* Float: 0.5f */))
				{
...
float func_191(bool bParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
int func_192(int iParam0, vector3 vParam1, char[4] cParam4, bool bParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	var uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_178(2))
		{
			if (!func_146())
			{
				if (((func_127(UNK_0x16F2683693E537C9()) && func_127(iParam0->f_28[0])) && func_127(iParam0->f_28[1])) && func_191(UNK_0x16F2683693E537C9(), vParam1, 1) < 20f)
				{
					...
					if (*uParam10 == 0)
					{
						...
						func_188(&uVar0, cParam4, bParam5, 7, 0, 0);
						*uParam10 = 2;
					}
					else if (*uParam10 == 2)
					{
			...
			else if (((func_194(bParam5) && !*uParam10 == 1) && func_127(UNK_0x16F2683693E537C9())) && func_191(UNK_0x16F2683693E537C9(), vParam1, 1) >= 20f)
			{
...
void func_196(int iParam0, bool bParam1, vector3 vParam2)
{
	if (UNK_0xE1DBBD6CE209517C(UNK_0xD803B885F5E47A62()))
	{
...
bool func_207(struct<2> Param0, float fParam2, struct<2> Param3, var uParam5, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_209()
{
	...
	{
		UNK_0xA2888AACD3C45CCA("Joe", true, 0, 0, false);
		UNK_0xA2888AACD3C45CCA("Josef", false, 0, 0, false);
		UNK_0xA2888AACD3C45CCA("Josef", true, 0, 0, false);
	}
}
	...
	if (func_127(bParam0))
	{
		switch (uParam1->f_3)
		{
			case 1:
				...
				break;
			case 2:
				if (!func_213(uParam1) || !UNK_0xB4ECF989E2C1DAC8(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_212(iParam2) && !UNK_0x7069CC4DE1EA3FAA(bParam0, UNK_0x16F2683693E537C9(), 25f))
					{
						UNK_0xF96A174EE26D7588(bParam0, UNK_0x16F2683693E537C9(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_213(uParam1) && uParam1->f_4 == 0) && UNK_0x0EB28750412C3A5A(UNK_0x68F4C0EC296D3901(UNK_0x16F2683693E537C9(), true), UNK_0x68F4C0EC296D3901(bParam0, true), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 3:
				...
				break;
			case 5:
				if (!func_212(iParam2) || UNK_0x7069CC4DE1EA3FAA(bParam0, UNK_0x16F2683693E537C9(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						UNK_0xC6EB89C59F2AF6B8(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, false, 0, 0, 0);
...
bool func_216(var uParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
bool func_218(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_220(bool bParam0, float fParam1)
{
	...
	if (func_127(UNK_0x16F2683693E537C9()) && func_127(bParam0))
	{
		if (func_231(bParam0) || UNK_0x292E02BF8ABF889C(UNK_0xD803B885F5E47A62(), bParam0))
		{
...
{
	return func_222(bParam0, UNK_0x16F2683693E537C9(), fParam1, 1, 250, 7);
}

bool func_222(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;

	iVar4 = func_230(bParam0, bParam1);
	...
	if (!func_226(bParam0, bParam1, fParam2, iParam3))
	{
		return false;
	}
	if (iVar4 == -1)
	...
	bVar0 = func_223(&(Local_37[iVar4 /*4*/]), vVar1, bParam1, &(Local_37[iVar4 /*4*/].f_3), bParam0, iParam5);
	return (bVar0 || (UNK_0x1C0640BA9A7327B3() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_223(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_224(bParam4, iParam7) };
...
Vector3 func_224(bool bParam0, int iParam1)
{
	int iVar0;
...
bool func_226(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_228(UNK_0x68F4C0EC296D3901(bParam1, true) - UNK_0x68F4C0EC296D3901(bParam0, true)) };
	...
	{
		vVar3 = { func_228(UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 5f, 0f) - UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_232(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	bool bVar1;
	int iVar2;
	...
	if (func_127(UNK_0x16F2683693E537C9()) && func_127(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_236(bParam0, bParam1, fVar0, bVar1))
			{
				return true;
			}
			if (func_233(bParam0, bVar1, bParam3, bParam4))
			{
				return true;
			}
		}
...
bool func_233(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_234(bool bParam0, bool bParam1)
{
	...
	{
		if (func_235(bParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_235(bool bParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_228(vParam1 - UNK_0x68F4C0EC296D3901(bParam0, true)) };
...
bool func_236(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
	if (bParam1)
	{
		if (UNK_0x168558745A6AC21E(UNK_0x16F2683693E537C9()))
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_35[1]))
			{
				...
				UNK_0xC6A6B4DDD6DC073A(iParam0->f_35[1], false);
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_41[1]))
			{
				...
				UNK_0x9F528B1B53FBC5D9(iParam0->f_41[1], iParam0->f_28[0], UNK_0x4A089F2B762B8D33(iParam0->f_28[0], 18905), 0.12f, 0f, 0.03f, 90f, 0f, 90f, 0, 0, 0, 0, 2, 1);
			}
			if (bVar7)
			{
				iLocal_91 = 3;
...
void func_248(bool bParam0, bool bParam1, vector3 vParam2, bool bParam5)
{
	func_249(bParam0);
...
bool func_250(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	if (func_251(bParam0, iParam1, vParam2, fParam5, 1))
	{
		if (UNK_0xC844350D5D58C99A(*bParam0))
		{
			if (!UNK_0x437347B10A200C4B(*bParam0, 0))
...
bool func_251(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6)
{
	bool bVar0;
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (UNK_0xC844350D5D58C99A(iParam0->f_35[0]))
			{
				...
				UNK_0xCCD53AC1B5D5E456(iParam0->f_35[0], 14f);
				UNK_0xAB8E2DDC7AF955E0(iVar0[0], true);
			}
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_35[1]))
			{
				...
				UNK_0x05EC10F460C3A4AF(iParam0->f_35[1], 0);
			}
			if (bVar6)
			{
				iLocal_91 = 3;
		...
		case 3:
			if (UNK_0xB4AE0788C1587752("rcmminute1"))
			{
				if (func_127(iParam0->f_28[0]))
				{
					if (!UNK_0xB4ECF989E2C1DAC8(iParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						UNK_0xA3BF0AA5A2608191(iParam0->f_28[0]);
						UNK_0xC6EB89C59F2AF6B8(iParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, false, 0, 0, 0);
				...
				if (func_127(iParam0->f_28[1]))
				{
					...
					UNK_0xC6EB89C59F2AF6B8(iParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, false, 0, 0, 0);
					UNK_0x4E885A246A9D983A(iParam0->f_28[1], 185, true);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_259(bool bParam0, bool bParam1)
{
	if (UNK_0xC844350D5D58C99A(bParam0))
	{
		UNK_0xAACF4BD59CB35944(bParam0, 0);
		UNK_0x71EDC33E5A423750(bParam0, 2);
		UNK_0xAB8E2DDC7AF955E0(bParam1, true);
...
bool func_270(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
...
bool func_271(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;

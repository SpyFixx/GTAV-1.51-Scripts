...
{
	switch ((iParam1[iParam0 /*21*/])->f_17)
	{
		case 4:
...
float func_33()
{
	...
	fVar0 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(fLocal_1641);
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fVar0))
	{
		return PED::GET_SYNCHRONIZED_SCENE_PHASE(fVar0);
	}
	return -1f;
}
...
void func_35()
{
	func_36(joaat("MPPLY_CAS_24H_GMBLNG_PX"), NETWORK::_0xF12E6CD06C73D69E());
}
...
void func_37()
{
	func_36(joaat("MPPLY_CAS_CUR_GMBLNG_PX"), NETWORK::_0xF12E6CD06C73D69E());
}
...
void func_45()
{
	...
	if (!bLocal_2101)
	{
		fLocal_2103 = NETWORK::_0xBA7F0B77D80A4EB7();
		bLocal_2101 = true;
	}
	if (!bLocal_2100)
	{
		fLocal_2102 = NETWORK::_0xBA7F0B77D80A4EB7();
		bLocal_2100 = true;
	}
...
void func_55()
{
	func_36(joaat("MPPLY_CASINO_CHIPS_WONTIM"), NETWORK::_0xF12E6CD06C73D69E());
}
...
void func_58()
{
	...
	if (Global_262145.f_26037)
	{
		...
		Var0.f_17 = MISC::ABSI(NETWORK::IS_TIME_EQUAL_TO(fLocal_2102, NETWORK::_0xBA7F0B77D80A4EB7()));
		Var0.f_18 = NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT();
		if (NETWORK::NETWORK_GET_HOST_OF_THIS_SCRIPT() != func_66())
		{
			Var0.f_19 = UNK_0x3DDF605689C8A861(NETWORK::NETWORK_GET_PLAYER_INDEX(NETWORK::NETWORK_GET_HOST_OF_THIS_SCRIPT()));
		}
...
int func_69(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;

	iVar0 = func_70(iParam0, 0, sParam1, iParam4, iParam5, 0, iParam6, 1, iParam2, iParam3, bParam7);
	return iVar0;
}
...
void func_131()
{
	func_36(joaat("MPPLY_CASINO_CHIPS_PURTIM"), NETWORK::_0xF12E6CD06C73D69E());
}
...
bool func_138(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_156())
	{
		if (*iParam0 == 0)
		{
			...
			if (func_151(78225582, 1950528552, iVar3, iVar5, bParam2, iVar1, 0, 4, 0, 3))
			{
...
bool func_151(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	bool bVar0;
	int iVar1;
	struct<4> Var2;
...
void func_168(int iParam0)
{
	...
	fLocal_1641 = NETWORK::_0x77758139EC9B66C7(vLocal_1643, vLocal_1646, 2, Local_2106.f_17, Local_2106.f_16, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
	if (iParam0 == 5 || iParam0 == 6)
	{
		NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_1641, func_328(), &Local_2106, 4f, -8f, 13, 16, 1148846080 /* Float: 1000f */, 0);
	}
	else if (iParam0 == 11 || iParam0 == 12)
	{
		NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_1641, func_328(), &Local_2106, 8f, -8f, 13, 16, 1148846080 /* Float: 1000f */, 0);
	}
	else if (iParam0 == 8 || iParam0 == 14)
	{
		NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_1641, func_328(), &Local_2106, 8f, -4f, 13, 16, 1148846080 /* Float: 1000f */, 0);
	}
	else if (((iParam0 == 0 || iParam0 == 1) || iParam0 == 2) || iParam0 == 3)
	{
		NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_1641, func_328(), &Local_2106, 2f, -1.5f, 13, 16, 2f, 0);
	}
	else
	{
		NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_1641, func_328(), &Local_2106, 2f, -1.5f, 13, 16, 1148846080 /* Float: 1000f */, 0);
		if (iParam0 == 15 || iParam0 == 9)
		{
			...
			NETWORK::NETWORK_ADD_ENTITY_TO_SYNCHRONISED_SCENE(fLocal_1641, iVar6, vLocal_1643, func_328(), &Local_2106, 2f, -1.5f, 13);
		}
	}
	NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_1641);
	iLocal_1642 = iParam0;
}
...
int func_171(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	if (func_156() && *iParam1 == 1)
	{
		bParam3 = false;
	}
	if (!bParam3 || func_173(bParam0))
	{
		return func_172(bParam0, 2, iParam1, iParam2, -1, -1);
	}
	else
	{
		*iParam1 = 3;
...
int func_172(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (func_138(iParam2, iParam1, bParam0))
		{
					...
					if (iParam1 == 7 && iParam3 > 0)
					{
						if (Local_213[iLocal_2125 /*21*/].f_17 == 8)
						{
							if (iParam3 != 12)
							{
								...
								WEAPON::_GET_MAX_AMMO_2(PLAYER::PLAYER_PED_ID(), iVar16, &iVar18);
								if (iVar18 < iVar17)
								{
...
void func_219(bool bParam0)
{
	...
	if (Global_262145.f_26043)
	{
		...
		{
			Var0.f_5 = MISC::ABSI(NETWORK::IS_TIME_EQUAL_TO(fLocal_2103, NETWORK::_0xBA7F0B77D80A4EB7()));
		}
		...
		if (NETWORK::NETWORK_GET_HOST_OF_THIS_SCRIPT() != func_66())
		{
			Var0.f_11 = UNK_0x3DDF605689C8A861(NETWORK::NETWORK_GET_PLAYER_INDEX(NETWORK::NETWORK_GET_HOST_OF_THIS_SCRIPT()));
		}
...
void func_228()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fVar0))
	{
		if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fVar0) >= 0.99f || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), joaat("BLEND_OUT")))
		{
			bVar1 = true;
		}
	}
...
bool func_260(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	char cVar0[64];
	char cVar16[64];
	int iVar32;
...
void func_275()
{
	func_36(joaat("MPPLY_CAS_GMBLNG_L24_PX"), NETWORK::_0xF12E6CD06C73D69E());
	func_276();
	func_35();
	Global_1696068 = 1;
	Global_1696063 = 0;
...
void func_278()
{
	func_36(joaat("MPPLY_CASINO_GMBLNG_GD"), NETWORK::_0xF12E6CD06C73D69E());
	func_37();
	func_279((NETWORK::_0xF12E6CD06C73D69E() + 86400));
	Global_1696067 = 1;
}
	...
	switch (iLocal_1640)
	{
		...
		case 2:
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fVar0))
			{
				...
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fVar0) >= 0.99f)
				{
					iVar7 = 0;
					while (iVar7 < 4)
					{
...
bool func_323(float fParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
...
void func_359(var uParam0, int iParam1)
{
	...
	(iParam1[8 /*21*/])->f_17 = 4;
	(iParam1[9 /*21*/])->f_17 = 5;
	(iParam1[10 /*21*/])->f_17 = 6;
	(iParam1[11 /*21*/])->f_17 = 7;
	(iParam1[12 /*21*/])->f_17 = 1;
	(iParam1[13 /*21*/])->f_17 = 2;
	(iParam1[14 /*21*/])->f_17 = 3;
	(iParam1[15 /*21*/])->f_17 = 4;
	(iParam1[16 /*21*/])->f_17 = 5;
	(iParam1[17 /*21*/])->f_17 = 4;
	(iParam1[18 /*21*/])->f_17 = 5;
	(iParam1[19 /*21*/])->f_17 = 1;
	(iParam1[20 /*21*/])->f_17 = 2;
	(iParam1[21 /*21*/])->f_17 = 3;
	(iParam1[22 /*21*/])->f_17 = 7;
	(iParam1[23 /*21*/])->f_17 = 8;
	(iParam1[24 /*21*/])->f_17 = 4;
	(iParam1[25 /*21*/])->f_17 = 5;
	(iParam1[26 /*21*/])->f_17 = 6;
	(iParam1[27 /*21*/])->f_17 = 4;
	(iParam1[28 /*21*/])->f_17 = 5;
	(iParam1[29 /*21*/])->f_17 = 1;
	(iParam1[30 /*21*/])->f_17 = 2;
	(iParam1[31 /*21*/])->f_17 = 3;
	(iParam1[32 /*21*/])->f_17 = 7;
	(iParam1[33 /*21*/])->f_17 = 8;
	(iParam1[34 /*21*/])->f_17 = 4;
	(iParam1[35 /*21*/])->f_17 = 5;
	(iParam1[36 /*21*/])->f_17 = 6;
	(iParam1[37 /*21*/])->f_17 = 8;
	(iParam1[38 /*21*/])->f_17 = 7;
	(iParam1[39 /*21*/])->f_17 = 6;
	(iParam1[40 /*21*/])->f_17 = 5;
	(iParam1[41 /*21*/])->f_17 = 4;
	(iParam1[42 /*21*/])->f_17 = 3;
	(iParam1[43 /*21*/])->f_17 = 2;
	(iParam1[44 /*21*/])->f_17 = 3;
	(iParam1[45 /*21*/])->f_17 = 4;
	(iParam1[46 /*21*/])->f_17 = 5;
	(iParam1[47 /*21*/])->f_17 = 1;
	(iParam1[48 /*21*/])->f_17 = 2;
	(iParam1[49 /*21*/])->f_17 = 6;
	(iParam1[50 /*21*/])->f_17 = 7;
	(iParam1[51 /*21*/])->f_17 = 8;
	(iParam1[52 /*21*/])->f_17 = 4;
	(iParam1[53 /*21*/])->f_17 = 5;
	iVar0 = 0;
	while (iVar0 < 54)
	{
		switch ((iParam1[iVar0 /*21*/])->f_17)
		{
			case 1:
			case 6:
				(iParam1[iVar0 /*21*/])->f_16 = 100;
				break;
			case 2:
			case 3:
				(iParam1[iVar0 /*21*/])->f_16 = 25;
				break;
			case 4:
			case 8:
				(iParam1[iVar0 /*21*/])->f_16 = 5;
				break;
			case 5:
			case 7:
				(iParam1[iVar0 /*21*/])->f_16 = 500;
				break;
		}
		iVar0++;
	}

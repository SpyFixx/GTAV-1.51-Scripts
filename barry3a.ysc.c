...
bool func_240(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_283(bool bParam0, bool bParam1)
{
	...
	iVar0 = func_148(bParam0);
	if (func_151(iVar0) && !PED::IS_PED_INJURED(bParam0))
	{
...
bool func_292(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;

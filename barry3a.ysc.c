...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	iLocal_80 = func_496(49);
	vLocal_156 = { 0f, -1f, 0.64f };
	bLocal_159 = joaat("PROP_WEED_TUB_01B");
	vLocal_161 = { -1138.977f, -1252.549f, 6.05f };
	bLocal_246 = joaat("POLICE4");
	bLocal_247 = joaat("A_M_Y_BUSINESS_01");
...
int func_41(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
int func_55(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_207(bool bParam0, vector3 vParam1, float fParam4)
{
		...
		case 1:
			if (UNK_0x5A91F08DF773C39D(Local_145.f_4, vLocal_161, 10f, 10f, 2f, false, true, 0))
			{
				...
				else
				{
					...
					else if ((bLocal_433 && func_209(5)) && (UNK_0x0A4C9A3D51EAE31F(203) == 0 || !func_212()))
					{
						func_210(5);
					}
				}
...
bool func_216(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
...
bool func_240(bool bParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_242()
{
	switch (iLocal_143)
	{
		case 0:
			...
			break;
		case 1:
			func_248(&uLocal_450, &uLocal_251, "BAR3AAU", &uLocal_451, &uLocal_457);
			if (!bLocal_248 && UNK_0x1C0640BA9A7327B3() > iLocal_249)
			{
...
void func_248(var uParam0, var uParam1, char* sParam2, char* sParam3, bool bParam4)
{
	switch (*uParam0)
	{
		...
		case 3:
			...
			break;
		case 4:
			if (!UNK_0x25037C66EB32B076() && func_249(uParam1, sParam2, sParam3, bParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_258(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		func_259(iParam0, bParam1, bParam4, iParam5);
...
void func_259(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	func_260(&Global_105187, UNK_0xBB0808A181D4745C(), iParam0, bParam1, iParam3, bParam2);
}

void func_260(var uParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_230();
	...
	if (iParam4 == 1)
	{
		func_262(&(uParam0->f_2890), uParam0, bParam5, 1, 1, 0);
	}
...
void func_262(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (func_275(bParam2, &bVar0, iParam3, iParam5))
	{
...
int func_263(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	if (UNK_0xDF1306B443CD3D15(bParam2, 0))
	{
		func_265(uParam0, bParam2, iParam3);
		uParam1->f_4 = bParam2;
		if (func_264(bParam2))
		{
			uParam1->f_3 = 1;
...
{
	func_271(bParam1, &(uParam0->f_12));
	uParam0->f_7 = func_268(bParam1, 145, 0);
	uParam0->f_11 = func_267(bParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
			uParam0->f_10 = func_266(bParam1);
		}
	}
	if (iParam2 == 1)
	{
	...
	while (iVar0 < 9)
	{
		if (UNK_0xC844350D5D58C99A(Global_96075[iVar0]))
		{
			if (Global_96075[iVar0] == bParam0)
			{
				...
				{
					if (iParam2 == 0 || UNK_0x134B62B726CEC8E6(bParam0) == func_269(iParam1, iParam2))
					{
						return 1;
					}
				}
...
int func_273(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
bool func_275(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	bool bVar0;
			...
			if (UNK_0xC844350D5D58C99A(*bParam1))
			{
				if (UNK_0xDF1306B443CD3D15(*bParam1, 0))
				{
					if (iParam2 == 0 || UNK_0x0EB28750412C3A5A(UNK_0x68F4C0EC296D3901(*bParam1, true), UNK_0x68F4C0EC296D3901(bParam0, true), 1) < 100f)
					{
						...
						if (func_276(*bParam1, func_230(), 1))
						{
...
void func_278(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (!UNK_0xEB6A8945D1AC98A1(bParam0))
	{
		...
		while (bVar1 < 12)
		{
			func_281(bParam0, bVar1, &(uParam1->f_13[bVar1]), uParam1[bVar1], &(uParam1->f_26[bVar1]), iParam2, 145);
			bVar1++;
		}
		bVar1 = false;
		while (bVar1 < 9)
		{
			func_280(bParam0, bVar1, &(uParam1->f_39[bVar1]), &(uParam1->f_49[bVar1]), iParam2, 145);
			bVar1++;
		}
		if (func_151(iVar0))
		{
...
void func_280(bool bParam0, bool bParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_281(bool bParam0, bool bParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_283(bool bParam0, bool bParam1)
{
	...
	iVar0 = func_148(bParam0);
	if (func_151(iVar0) && !UNK_0xEB6A8945D1AC98A1(bParam0))
	{
		if (bParam0 == UNK_0x16F2683693E537C9())
		{
			func_284(bParam0, &(Global_111638.f_2358.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_284(bool bParam0, var uParam1)
{
	...
	if (!UNK_0xEB6A8945D1AC98A1(bParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = UNK_0x3F0B5EEC37A0EDD3(bParam0, func_289(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
bool func_292(vector3 vParam0, bool bParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
bool func_295(int iParam0)
{
	if (!UNK_0x437347B10A200C4B(UNK_0x16F2683693E537C9(), 0) && !UNK_0xEB6A8945D1AC98A1(UNK_0x16F2683693E537C9()))
	{
		if (func_316())
		{
			*iParam0 = func_300(UNK_0x68F4C0EC296D3901(UNK_0x16F2683693E537C9(), false), 6, -1, 0, 1, -1);
...
bool func_297(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (UNK_0x8CD06866876216F2())
	{
		if (func_7() == 0)
		{
			return UNK_0xEAE0D21A50E6C7F4(func_69(func_298(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
int func_300(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam3 == 6 || iParam3 == func_315(iVar0))
		{
			...
			{
				fVar1 = UNK_0x0EB28750412C3A5A(vParam0, func_301(iVar0, 0), 1);
...
bool func_304(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	struct<4> Var0;
	vector3 vVar6;
	struct<4> Var12;
...
{
	return (SYSTEM::SHIFT_RIGHT(bParam0, 26) & 31 * func_323(UNK_0xEAE0D21A50E6C7F4(bParam0, 31), -1, 1)) + 2011;
}
	...
	if (UNK_0xC844350D5D58C99A(Global_102203.f_4))
	{
		if (UNK_0xDF1306B443CD3D15(Global_102203.f_4, 0))
		{
			if (func_362(24) != Global_102203.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_359(UNK_0x68F4C0EC296D3901(Global_102203.f_4, true), iParam5, &vVar0, &fVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = fVar3;
					}
...
void func_336(bool bParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (UNK_0xC844350D5D58C99A(bParam0) && UNK_0xDF1306B443CD3D15(bParam0, 0))
	{
		...
		func_355(iParam5, &Var0, vParam1, iParam4, func_267(bParam0));
		func_337(iParam5, bParam0, 0);
	}
}
...
void func_338(bool bParam0, int iParam1)
{
	...
	func_271(bParam0, &(Global_111638.f_32744.f_5510));
}

bool func_339(bool bParam0)
{
	if ((((((((((!UNK_0xC844350D5D58C99A(bParam0) || !UNK_0xDF1306B443CD3D15(bParam0, 0)) || func_276(bParam0, 0, 0)) || func_276(bParam0, 1, 0)) || func_276(bParam0, 2, 0)) || func_267(bParam0) != 145) || func_353(bParam0)) || func_352(bParam0)) || func_351(bParam0)) || func_350(bParam0)) || !func_340(UNK_0x134B62B726CEC8E6(bParam0)))
	{
		if (func_352(bParam0))
		{
		}
...
void func_355(int iParam0, var uParam1, vector3 vParam2, int iParam5, int iParam6)
{
	if (func_354(&(Global_75441.f_555[0 /*21*/]), iParam0))
	{
...
bool func_359(vector3 vParam0, var uParam3, var uParam4, var uParam5)
{
	int iVar0;

	iVar0 = func_360(vParam0, uParam3, 1);
	switch (iVar0)
	{
		case 0:
...
void func_366()
{
	...
	{
		UNK_0x71199B01895C6202(bLocal_247);
		UNK_0x71199B01895C6202(bLocal_246);
		bLocal_245 = false;
	}
}
	...
	switch (Local_186[iParam0 /*29*/].f_24)
	{
		case 0:
			if (!UNK_0xC844350D5D58C99A(Local_186[iParam0 /*29*/].f_1))
			{
				...
				{
					if (UNK_0xB87F6CF6E5628C67(bLocal_247))
					{
						Local_186[iParam0 /*29*/].f_1 = UNK_0x852A19533F896693(Local_186[iParam0 /*29*/], 6, bLocal_247, -1, 1, true);
						Local_186[iParam0 /*29*/].f_2 = UNK_0x852A19533F896693(Local_186[iParam0 /*29*/], 6, bLocal_247, false, 1, true);
					}
				}
				else if (UNK_0xB87F6CF6E5628C67(bLocal_246))
				{
					Local_186[iParam0 /*29*/] = UNK_0x122AAB0B1D6F55AD(bLocal_246, Local_186[iParam0 /*29*/].f_3, Local_186[iParam0 /*29*/].f_6, true, true, false);
				}
			}
			else if (!UNK_0x437347B10A200C4B(Local_186[iParam0 /*29*/].f_1, 0))
			{
				UNK_0xE733200EEF894A35(Local_186[iParam0 /*29*/].f_1, 1);
				UNK_0x11AD11297DC58CC7(Local_186[iParam0 /*29*/].f_1, true);
				...
				if (func_204(Local_186[iParam0 /*29*/].f_2))
				{
					...
					UNK_0x11AD11297DC58CC7(Local_186[iParam0 /*29*/].f_2, true);
...
void func_370(int iParam0, bool bParam1)
{
	...
	{
		UNK_0x11AD11297DC58CC7(Local_186[iParam0 /*29*/].f_1, false);
	...
	{
		UNK_0xE733200EEF894A35(Local_186[iParam0 /*29*/].f_2, 1);
		UNK_0x11AD11297DC58CC7(Local_186[iParam0 /*29*/].f_2, false);
	...
	{
		UNK_0x56FDC9ADE35F7DB0(Local_186[iParam0 /*29*/], true, true, 0);
...
int func_372(bool bParam0)
{
	...
	if (func_204(bParam0))
	{
		...
		if (UNK_0x36646919F20EAFFC(bParam0) && func_216(bParam0, UNK_0x16F2683693E537C9(), 2f, 1))
		{
			return 1;
		}
		...
		else if (func_373(bParam0, 1126825984 /* Float: 170f */))
		{
			return 1;
		}
	}
...
bool func_373(bool bParam0, float fParam1)
{
	...
	if (func_204(UNK_0x16F2683693E537C9()) && func_204(bParam0))
	{
		if (func_384(bParam0) || UNK_0x292E02BF8ABF889C(UNK_0xD803B885F5E47A62(), bParam0))
		{
...
bool func_375(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (!func_204(bParam0) || !func_204(bParam1))
	{
		if (iVar4 != -1)
		{
	...
	bVar0 = func_376(&(Local_37[iVar4 /*4*/]), vVar1, bParam1, &(Local_37[iVar4 /*4*/].f_3), bParam0, iParam5);
...
bool func_379(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_381(UNK_0x68F4C0EC296D3901(bParam1, true) - UNK_0x68F4C0EC296D3901(bParam0, true)) };
	...
	{
		vVar3 = { func_381(UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 5f, 0f) - UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if (UNK_0x3D1053F9EB43B7AD(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_186[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_186[iParam0 /*29*/].f_7[0 /*8*/].f_7, 0, true, 0))
	{
		return true;
	}
	else if (Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f && UNK_0x3D1053F9EB43B7AD(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7, 0, true, 0))
	{
		return true;
	}
	return false;
...
bool func_390()
{
	switch (iLocal_439)
	{
		...
		case 2:
			...
			{
				if ((!bLocal_443 && UNK_0x1C0640BA9A7327B3() >= iLocal_441) && !func_212())
				{
	...
	switch (iLocal_143)
	{
		case 0:
			if (!func_398())
			{
				...
				if (UNK_0xEA6BC48857E0AC4C(bLocal_449))
				{
					bLocal_449 = "DEFAULT";
				}
				if (UNK_0x7F8A39872A07D2CE(bLocal_449, "DEFAULT"))
				{
					func_472(1);
				}
				else
				{
					func_396(bLocal_449, 1);
				}
				iLocal_143 = 1;
			}
			break;
...
bool func_415(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
void func_429(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
void func_438(bool bParam0, bool bParam1, int iParam2)
{
...
void func_441(bool bParam0)
{
	...
	while (iLocal_250 <= 1)
	{
		...
		if (bParam0)
		{
			...
			if (!bLocal_245)
			{
				UNK_0x523BCC9DC80CD82F(bLocal_247);
				UNK_0x523BCC9DC80CD82F(bLocal_246);
			}
			bLocal_245 = true;
		}
		else
...
void func_442(vector3 vParam0, bool bParam3, bool bParam4)
{
	UNK_0x523BCC9DC80CD82F(Local_145.f_5);
	UNK_0x523BCC9DC80CD82F(bLocal_159);
	while (!UNK_0xB87F6CF6E5628C67(Local_145.f_5) || !UNK_0xB87F6CF6E5628C67(bLocal_159))
	{
		SYSTEM::WAIT(0);
	}
	if (func_204(Local_145.f_4))
	...
	func_206(&bLocal_155);
	func_203(&(Local_145.f_4));
	Local_145.f_4 = UNK_0x122AAB0B1D6F55AD(Local_145.f_5, vParam0, bParam3, true, true, false);
	UNK_0xC6A6B4DDD6DC073A(Local_145.f_4, true);
	if (bParam4)
	{
	...
	UNK_0x44A200C9B6E1CEA6(Local_145.f_4, true);
	UNK_0x2F625BED8BF7F26A(Local_145.f_4);
	UNK_0xD3421E391490133B(Local_145.f_4, true, true);
	UNK_0xD3421E391490133B(Local_145.f_4, 2, true);
	UNK_0xD3421E391490133B(Local_145.f_4, 3, true);
	bLocal_155 = UNK_0x7707E48765093646(bLocal_159, vParam0, true, true, false);
	UNK_0x9F528B1B53FBC5D9(bLocal_155, Local_145.f_4, false, vLocal_156, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
	UNK_0x20641932E5104B25(bLocal_155, true, 0);
	bLocal_152 = true;
	func_421(Local_145.f_4, 0);
	UNK_0x71199B01895C6202(Local_145.f_5);
	UNK_0x71199B01895C6202(bLocal_159);
}
...
void func_451()
{
	UNK_0xD7992BEF7A9D109E("BARR3A", false);
...
bool func_474(char* sParam0, int iParam1, int iParam2)
{
	bool bVar0;
	struct<32> Var1;
	int iVar33;

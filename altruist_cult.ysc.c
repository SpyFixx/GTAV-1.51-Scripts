				...
				case 4:
					...
					else
					{
						...
						while (iVar0 < iLocal_196)
						{
							...
							{
								if (HUD::DOES_BLIP_EXIST(iLocal_229[iVar0]))
								{
									HUD::REMOVE_BLIP(&(iLocal_229[iVar0]));
								}
							}
							else
							{
...
bool func_32(var uParam0, var uParam1, int iParam2, char* sParam3, char* sParam4, bool bParam5, int iParam6)
{
	switch (*uParam0)
	{
		case 0:
...
bool func_33(int iParam0, var uParam1, char* sParam2, char* sParam3, bool bParam4, int iParam5, int iParam6, bool bParam7, float fParam8, bool bParam9)
{
	switch (*uParam1)
	{
		case 0:
...
void func_159()
{
	switch (iLocal_189)
	{
		...
		case 1:
			...
			fLocal_188 = PED::CREATE_SYNCHRONIZED_SCENE(-1044.636f, 4915.204f, 212.32f, 0f, 0f, 110.52f, 2);
			TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_188, "random@altruist_cult", sLocal_405, 1000f, -2f, 4, 0, 1000f, 0);
			TASK::TASK_SYNCHRONIZED_SCENE(iLocal_196[0], fLocal_188, "random@altruist_cult", sLocal_403, 1000f, -2f, 4, 0, 1000f, 0);
			if (Global_111638.f_24990.f_5 >= 2)
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_196[1], fLocal_188, "random@altruist_cult", sLocal_404, 1000f, -2f, 4, 0, 1000f, 0);
			}
			CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_246, fLocal_188, sLocal_408, "random@altruist_cult");
			CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
			if (!PED::IS_PED_INJURED(iLocal_193[0]) && !PED::IS_PED_INJURED(iLocal_193[1]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_193[0], fLocal_188, "random@altruist_cult", sLocal_406, 1000f, -2f, 4, 0, 1000f, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_193[1], fLocal_188, "random@altruist_cult", sLocal_407, 1000f, -2f, 4, 0, 1000f, 0);
			}
			iLocal_189++;
			break;
		case 2:
			...
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_188) > fLocal_185)
			{
				iLocal_189++;
			}
			break;
		case 3:
			...
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_188) > fLocal_184)
			{
				iLocal_189++;
			}
			break;
...
void func_188()
{
	switch (iLocal_189)
	{
		...
		case 3:
			...
			if (Global_111638.f_24990.f_5 == 1 || Global_111638.f_24990.f_5 == 2)
			{
				if ((PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_188) > 0.9742857f && !bLocal_181) && CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
				{

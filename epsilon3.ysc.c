	...
	switch (iLocal_146)
	{
		...
		case 1:
			...
			if (func_236(Local_83.f_28[0]))
			{
				...
				if ((((((GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), 5f) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), 5f, false)) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), joaat("WEAPON_GRENADELAUNCHER"), 5f, false)) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), joaat("WEAPON_RPG"), 5f, false)) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), joaat("WEAPON_GRENADE"), 5f, false)) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), joaat("WEAPON_MOLOTOV"), 5f, false)) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], false), joaat("WEAPON_FLARE"), 5f, false))
				{
...
void func_118(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_183(char* sParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, char* sParam10, char* sParam11, int iParam12, char* sParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, var uParam24)
{
	sParam0->f_4 = iParam5;
	*sParam0 = sParam1;
	sParam0->f_1 = { Param2 };
...
bool func_254(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_258(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11, int iParam12, float fParam13, float fParam14, int iParam15)
{
	func_259(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, fParam13, fParam14, iParam15);
}
...
bool func_263(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool func_274(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
			...
			if (func_238(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >= 4f)
			{
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (func_236(Local_83.f_28[0]))
					{
						if (func_288())
						{
							CAM::SET_GAMEPLAY_ENTITY_HINT(Local_83.f_28[0], 0f, 0f, -0.5f, true, 30000, 2000, 2000, false);
						}
						else
						{
							CAM::SET_GAMEPLAY_ENTITY_HINT(Local_83.f_28[0], -0.75f, 0f, -0.5f, true, 30000, 2000, 2000, false);
						}
...
bool func_317(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
...
bool func_318(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;

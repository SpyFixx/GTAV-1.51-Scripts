...
bool func_149(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
bool func_223(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_224(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_226(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
bool func_227(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_126(iParam0->f_28[0]) && func_200(iParam0->f_35[0]))
			{
				...
				fVar6 = PED::CREATE_SYNCHRONIZED_SCENE(vVar10, ENTITY::GET_ENTITY_ROTATION(iParam0->f_35[0], 2), 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(fVar6, true);
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fVar6, false);
				TASK::TASK_SYNCHRONIZED_SCENE(iParam0->f_28[0], fVar6, sVar7, "hao_base", 8f, -8f, 9, 16, 1000f, 0);
...
bool func_241(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
...
bool func_242(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;

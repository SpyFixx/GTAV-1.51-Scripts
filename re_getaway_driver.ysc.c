	...
	switch (*iParam0)
	{
		...
		case 9:
			...
			while (iVar48 < *iParam10)
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false) && !PED::IS_PED_INJURED((*iParam10)[iVar48]))
				{
					...
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_285[iVar48]))
						{
		...
		case 18:
			...
			while (iVar65 < iLocal_290)
			{
				...
				{
					if (HUD::DOES_BLIP_EXIST(iLocal_285[iVar65]))
					{
						HUD::REMOVE_BLIP(&(iLocal_285[iVar65]));
...
bool func_73(int iParam0, int iParam1, float fParam2)
{
	int iVar0;
...
void func_74(int iParam0, float fParam1)
{
	...
	while (iVar0 <= (*iParam0 - 1))
	{
		if (PED::IS_PED_INJURED((*iParam0)[iVar0]))
		{
			if (HUD::DOES_BLIP_EXIST(iLocal_285[iVar0]))
			{
				HUD::REMOVE_BLIP(&(iLocal_285[iVar0]));
			}
		}
		else
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
				{
					...
					else if (!HUD::DOES_BLIP_EXIST(iLocal_285[iVar0]))
					{
				...
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 121.8366f, -1503.006f, 28.0999f, 0.1367f, -1649.705f, 48.1608f, 125.8125f, false, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED((*iParam0)[iVar0])) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 75.3661f, -1542.811f, 28.4601f, 43.7035f, -1580.28f, 33.4259f, 26f, false, true, 0))
				{
					if (!HUD::DOES_BLIP_EXIST(iLocal_285[iVar0]))
					{
						if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
						{
							...
							iLocal_285[iVar0] = func_67((*iParam0)[iVar0], 0, 145);
							HUD::SHOW_HEIGHT_ON_BLIP(iLocal_285[iVar0], false);
							func_70(iLocal_54);
						}
					}
					if (!func_185())
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 75.3661f, -1542.811f, 28.4601f, 43.7035f, -1580.28f, 33.4259f, 26f, false, true, 0))
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(iParam1, false))
						{
							if (!func_185())
							{
								...
								if (HUD::DOES_BLIP_EXIST(iLocal_285[0]))
								{
									HUD::SHOW_HEIGHT_ON_BLIP(iLocal_285[0], true);
								}
								if (HUD::DOES_BLIP_EXIST(iLocal_285[1]))
								{
									HUD::SHOW_HEIGHT_ON_BLIP(iLocal_285[1], true);
								}
...
bool func_126(vector3 vParam0, float fParam3, int iParam4)
{

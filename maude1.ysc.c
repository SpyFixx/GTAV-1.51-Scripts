	...
	if (func_17(iLocal_158))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_158, "special_ped@maude@base", "base", 3))
		{
			if (!PED::IS_PED_RAGDOLL(iLocal_158) || TASK::IS_PED_GETTING_UP(iLocal_158))
			{
				...
				{
					fLocal_150 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					PED::SET_SYNCHRONIZED_SCENE_LOOPED(fLocal_150, false);
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_150, false);
					if (func_2(iLocal_158, 1785177548))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_158, -1000f, true);
					}
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_158, fLocal_150, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 1000f, -4f, 4626, 0, 1000f, 0);
					...
					if (func_11(iLocal_154))
					{
						...
						iVar0 += 512;
						iVar0 += 4096;
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_154, fLocal_150, "Female_Flee_Table_Left_Maude_Chair", "special_ped@maude@exit_flee", 16f, -4f, iVar0, 1000f);
					}
					return true;
				}
			}
...
bool func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool func_78(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	switch (iParam0)
	{
...
bool func_98(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_119(int iParam0, bool bParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (bParam1 - iParam2))
				{
					...
					func_112(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_112(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_189(char* sParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, char* sParam10, char* sParam11, int iParam12, char* sParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, var uParam24)
{
	sParam0->f_4 = iParam5;
	*sParam0 = sParam1;
	sParam0->f_1 = { Param2 };
...
bool func_244(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_245(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_247(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
bool func_250(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
bool func_257(int iParam0, int iParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
			...
			if (func_11(iLocal_154))
			{
				if (func_17(iLocal_158))
				{
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_160, 0) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_161, 0))
					{
						...
						{
							fLocal_147 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
							PED::SET_SYNCHRONIZED_SCENE_LOOPED(fLocal_147, true);
							PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_147, false);
							TASK::TASK_SYNCHRONIZED_SCENE(iLocal_158, fLocal_147, "special_ped@maude@base", "base", 1000f, -8f, 4688, 0, 1000f, 0);
							iVar0 = 0;
							iVar0 = 16;
							iVar0 = 64;
							iVar0 = 512;
							iVar0 = 4096;
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_154, fLocal_147, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar0, 1000f);
							PED::SET_PED_KEEP_TASK(iLocal_158, true);
						}
					}
				}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(bParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false)) || func_296(bParam0, 0, 0)) || func_296(bParam0, 1, 0)) || func_296(bParam0, 2, 0)) || func_315(bParam0) != 145) || func_295(bParam0)) || func_294(bParam0)) || func_293(bParam0)) || func_292(bParam0)) || !func_282(ENTITY::GET_ENTITY_MODEL(bParam0)))
	{
		if (func_294(bParam0))
		{
		}
...
void func_326(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, int iParam10, int iParam11, var uParam12, float fParam13, float fParam14, var uParam15)
{
	func_327(vParam0, vParam3, fParam6, vParam7, iParam10, 0f, 0f, 0f, iParam11, uParam12, fParam13, fParam14, uParam15);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(bVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_329(bVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
bool func_329(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool func_347(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
bool func_364(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
...
bool func_365(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_375(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_424(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_316(vParam1, 0f, 0f, 0f, 0))
		...
		{
			func_419(iParam12, 0);
			while (!func_376(bParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
bool func_376(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_377(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if ((func_178(iParam0) && ENTITY::DOES_ENTITY_EXIST(*bParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*bParam1, false))
	{
...
bool func_381(bool bParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(bParam0);
	if ((!func_409(iVar0, bParam1, uParam2) && !func_408(PLAYER::PLAYER_ID())) && !func_391(bParam0))
	{
		return false;
	}
	...
	if (((VEHICLE::IS_BIG_VEHICLE(bParam0) && !func_387(bParam0)) && !bVar1) && !(func_386(ENTITY::GET_ENTITY_MODEL(bParam0)) && func_382(PLAYER::PLAYER_ID())))
	{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_293(bParam0) && ENTITY::GET_ENTITY_MODEL(bParam0) != joaat("SENTINEL2")) && ENTITY::GET_ENTITY_MODEL(bParam0) != joaat("ISSI2"))
		{
			*uParam2 = 2;
			return false;
		}
...
bool func_409(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
int func_414(bool bParam0, var uParam1, var uParam2)
{
	...
	if (func_405(ENTITY::GET_ENTITY_MODEL(*bParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*bParam0, 24) != func_417(*bParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*bParam0, 24, func_417(*bParam0, ((*uParam1)[38] - 1)), false);
	}
	func_416(bParam0);
	if (func_415(*bParam0))
	{
...
bool func_425(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	bool bVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_442(uParam0))
	{
		...
		if (func_441(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0))
			{
				...
				else if ((!func_427(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
bool func_427(bool bParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_429(bParam0, uVar1[iVar6], 1) && func_428(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_316(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(bParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
bool func_429(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_430(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_433(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_432())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;

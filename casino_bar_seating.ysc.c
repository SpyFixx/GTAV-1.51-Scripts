...
bool func_83(bool bParam0)
{
	if (bParam0 != func_53())
	{
		if (func_54(bParam0, 1, 1))
		{
			...
			{
				return func_84(Global_2425662[bParam0 /*421*/].f_310.f_5) == 14;
			}
		}
	}
	return false;
...
void func_88(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (UNK_0x40B8C182D63932FC(bParam0) && (UNK_0xE1DBBD6CE209517C(bParam0) || bParam3 == 1))
		{
			...
			if (bParam1)
			{
				...
				if (!func_92(bVar27) && !UNK_0x20906E1D6BDC7044(bVar27))
				{
					if (!bVar22)
					{

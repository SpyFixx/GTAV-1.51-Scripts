					...
					if ((((!PED::IS_PED_INJURED(iLocal_263[1]) && PED::IS_PED_ON_FOOT(iLocal_263[0])) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_263[0], true)) && PED::IS_PED_ON_FOOT(iLocal_263[1])) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_263[1], true))
					{
						...
						switch (iVar1774)
						{
							case -1:
								...
								{
									fLocal_295 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(ScriptParam_0.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (ENTITY::GET_ENTITY_HEADING(ScriptParam_0.f_4) - 3.783146f), 2);
									iLocal_301 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
									CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_301, fLocal_295, "darts_ig_intro_cam", "mini@dartsintro");
									...
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[1], fLocal_295, "mini@dartsintro", "darts_ig_intro_guy1", 1000f, -1000f, 0, 0, 1000f, 0);
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[0], fLocal_295, "mini@dartsintro", "darts_ig_intro_guy2", 1000f, -1000f, 0, 0, 1000f, 0);
									...
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iVar1824, fLocal_295, "darts_ig_intro_dart", "mini@dartsintro", 1000f, 8f, 0, 1000f);
									func_424(&iVar1800);
									iVar1774++;
								}
								break;
							case 0:
								if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_295))
								{
									if (!bVar1770)
									{
									...
									switch (iLocal_31)
									{
										case 0:
											...
											break;
										case 1:
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_295) > 0.25f)
											{
												func_424(&iVar1800);
											...
											break;
										case 2:
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_295) > 0.55f)
											{
											...
											break;
										case 3:
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_295) > 0.85f)
											{
												func_418("DARTS_HOW_3A", -1);
												iLocal_31++;
											}
									...
									if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_295) > 0.95f)
									{
										bLocal_285 = true;
										iVar1774++;
									}
								...
								break;
							case 1:
								if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_295) > 0.99f)
								{
									if (!PED::IS_PED_INJURED(iLocal_263[1]))
									{
							...
							case 3:
								if (!PED::IS_PED_INJURED(iLocal_263[1]))
								{
									fLocal_295 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(ScriptParam_0.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (ENTITY::GET_ENTITY_HEADING(ScriptParam_0.f_4) - 3.783146f), 2);
									iLocal_301 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
									CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_301, fLocal_295, "darts_ig_intro_alt1_cam", "mini@dartsintro_alt1");
									CAM::SET_CAM_ACTIVE(iLocal_301, true);
									CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
									TASK::TASK_CLEAR_LOOK_AT(iLocal_263[0]);
									TASK::TASK_CLEAR_LOOK_AT(iLocal_263[1]);
									TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_263[0]);
									TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_263[1]);
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[1], fLocal_295, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy1", 1000f, -1000f, 0, 0, 1000f, 0);
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[0], fLocal_295, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy2", 1000f, -1000f, 0, 0, 1000f, 0);
									...
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iVar1824, fLocal_295, "darts_ig_intro_alt1_dart", "mini@dartsintro_alt1", 1000f, 8f, 0, 1000f);
									func_424(&iVar1800);
									iVar1774++;
								}
								break;
					...
					switch (iVar1774)
					{
						case 0:
							if (func_423(&(Var0.f_254)) > 0.5f)
							{
								...
								iVar1830 = func_240();
								fLocal_295 = PED::CREATE_SYNCHRONIZED_SCENE(vVar1787, vVar1790, 2);
								iLocal_301 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
								CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_301, fLocal_295, sLocal_375[iVar1830], "mini@dartsoutro");
								CAM::SET_CAM_ACTIVE(iLocal_301, true);
								CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
								if (!PED::IS_PED_INJURED(iLocal_263[0]) && !PED::IS_PED_INJURED(iLocal_263[1]))
								{
									if (Var0.f_454)
									{
										...
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[0], fLocal_295, "mini@dartsoutro", sLocal_367[iVar1830], 1000f, -1.5f, 0, 0, 1000f, 0);
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[1], fLocal_295, "mini@dartsoutro", sLocal_371[iVar1830], 1000f, -1.5f, 0, 0, 1000f, 0);
									...
									else
									{
										...
										func_238(&iLocal_263);
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[1], fLocal_295, "mini@dartsoutro", sLocal_367[iVar1830], 1000f, -1.5f, 0, 0, 1000f, 0);
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[0], fLocal_295, "mini@dartsoutro", sLocal_371[iVar1830], 1000f, -1.5f, 0, 0, 1000f, 0);
...
void func_41(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (bLocal_268)
	{
		...
		if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_295) && PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_295) >= 0.995f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_295))
		{
			bLocal_281 = true;
			if (CAM::DOES_CAM_EXIST(iLocal_301))
			{
	...
	else if (!uParam0->f_457)
	{
		...
		iVar13 = func_240();
		fLocal_295 = PED::CREATE_SYNCHRONIZED_SCENE(vVar7, vVar10, 2);
		iLocal_301 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
		CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_301, fLocal_295, sLocal_375[iVar13], "mini@dartsoutro");
		CAM::SET_CAM_ACTIVE(iLocal_301, true);
		CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
		if (!PED::IS_PED_INJURED(iLocal_263[0]) && !PED::IS_PED_INJURED(iLocal_263[1]))
		{
			if (uParam0->f_454)
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[0], fLocal_295, "mini@dartsoutro", sLocal_367[iVar13], 1000f, -1.5f, 0, 0, 1000f, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[1], fLocal_295, "mini@dartsoutro", sLocal_371[iVar13], 1000f, -1.5f, 0, 0, 1000f, 0);
				TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_362, sLocal_363[MISC::GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0f, false, false, false);
			}
			else
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[1], fLocal_295, "mini@dartsoutro", sLocal_367[iVar13], 1000f, -1.5f, 0, 0, 1000f, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263[0], fLocal_295, "mini@dartsoutro", sLocal_371[iVar13], 1000f, -1.5f, 0, 0, 1000f, 0);
				TASK::TASK_PLAY_ANIM(iLocal_263[1], sLocal_361, sLocal_363[MISC::GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0f, false, false, false);
			}
		}
		bLocal_281 = false;
...
bool func_168(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4)
{
	int iVar0;
	struct<13> Var1[1];
...
bool func_407(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int* iParam5)
{
	int iVar0;
	int iVar1;

...
void func_188(int iParam0, bool bParam1, vector3 vParam2)
{
	if (UNK_0xE1DBBD6CE209517C(UNK_0xD803B885F5E47A62()))
	{
...
float func_192(bool bParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
bool func_209(var uParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
bool func_211(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_213(bool bParam0, float fParam1)
{
	bool bVar0;

	if (func_127(UNK_0x16F2683693E537C9()) && func_127(bParam0))
	{
		if (func_224(bParam0) || UNK_0x292E02BF8ABF889C(UNK_0xD803B885F5E47A62(), bParam0))
		{
...
{
	return func_215(bParam0, UNK_0x16F2683693E537C9(), fParam1, 1, 250, 7);
}

bool func_215(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;

	iVar4 = func_223(bParam0, bParam1);
	...
	bVar0 = func_216(&(Local_37[iVar4 /*4*/]), vVar1, bParam1, &(Local_37[iVar4 /*4*/].f_3), bParam0, iParam5);
	return (bVar0 || (UNK_0x1C0640BA9A7327B3() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_216(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_217(bParam4, iParam7) };
...
Vector3 func_217(bool bParam0, int iParam1)
{
	int iVar0;
...
bool func_219(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_221(UNK_0x68F4C0EC296D3901(bParam1, true) - UNK_0x68F4C0EC296D3901(bParam0, true)) };
	...
	{
		vVar3 = { func_221(UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 5f, 0f) - UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_225(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	bool bVar1;
	int iVar2;
	...
	if (func_127(UNK_0x16F2683693E537C9()) && func_127(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_229(bParam0, bParam1, fVar0, bVar1))
			{
				return true;
			}
			if (func_226(bParam0, bVar1, bParam3, bParam4))
			{
				return true;
			}
		}
...
bool func_226(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_227(bool bParam0, bool bParam1)
{
	...
	{
		if (func_228(bParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_228(bool bParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_221(vParam1 - UNK_0x68F4C0EC296D3901(bParam0, true)) };
...
bool func_229(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
	if (bParam1)
	{
		if (UNK_0x168558745A6AC21E(UNK_0x16F2683693E537C9()))
...
bool func_241(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			break;
		case 1:
			if (!func_250(&iVar0) || !UNK_0xB4AE0788C1587752(bVar8))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_28[0]))
			{
				if (func_247(&(iParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
					...
					UNK_0x915804B434753CBD(iParam0->f_28[0], iVar10, "rcmpaparazzo_4", "pap_4_rcm_leadin", 8f, -8f, 1, 16, 1148846080, 0);
				}
				else
				{
					bVar11 = false;
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_28[1]))
			{
				...
				{
					UNK_0x5F2AA9E2843E9403(iParam0->f_28[1], "Camera Man");
					UNK_0xC6EB89C59F2AF6B8(iParam0->f_28[1], "rcmpaparazzo_4", "Idle_Camman", 8f, -8f, -1, 57, false, 0, 0, 0);
					...
					UNK_0x64F9F278AB9DCA2C(iParam0->f_28[1], 3, false, false, 1);
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_28[2]))
			{
				func_245(&(iParam0->f_28[2]), iVar0[4], -498.309f, 227.9112f, 82.106f, 296.4216f, 26);
				if (func_126(iParam0->f_28[2]))
				{
					UNK_0x5F2AA9E2843E9403(iParam0->f_28[2], "Makeup Woman");
					UNK_0xC6EB89C59F2AF6B8(iParam0->f_28[2], "rcmpaparazzo_4", "Idle_Prod", 8f, -8f, -1, 57, false, 0, 0, 0);
					UNK_0x11AD11297DC58CC7(iParam0->f_28[2], true);
					UNK_0x64F9F278AB9DCA2C(iParam0->f_28[2], false, true, false, 0);
					UNK_0x64F9F278AB9DCA2C(iParam0->f_28[2], 2, 3, false, 0);
					UNK_0x64F9F278AB9DCA2C(iParam0->f_28[2], 3, true, 2, 0);
					UNK_0x64F9F278AB9DCA2C(iParam0->f_28[2], 4, false, true, 0);
					UNK_0x64F9F278AB9DCA2C(iParam0->f_28[2], 8, false, false, 0);
					UNK_0x64F9F278AB9DCA2C(iParam0->f_28[2], 9, false, false, 0);
				}
				else
				{
					bVar11 = false;
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_35[0]))
			{
				...
				{
					UNK_0x821D9A7077DBCDBC(iParam0->f_35[0], 1);
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_35[1]))
			{
				...
				{
					UNK_0xC6A6B4DDD6DC073A(iParam0->f_35[1], true);
					UNK_0x71EDC33E5A423750(iParam0->f_35[1], 2);
					UNK_0x446EA2500F021666(iParam0->f_35[1], false);
				}
				else
				{
					bVar11 = false;
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_41[0]))
			{
				func_242(&(iParam0->f_41[0]), iVar0[5], -490.11f, 233.15f, 82.1f, 0f);
				if (func_127(iParam0->f_28[0]) && UNK_0xC844350D5D58C99A(iParam0->f_41[0]))
				{
					UNK_0x9F528B1B53FBC5D9(iParam0->f_41[0], iParam0->f_28[0], UNK_0x4A089F2B762B8D33(iParam0->f_28[0], 57005), 0.1561f, -0.003f, -0.0344f, 202.8703f, -124.43f, -121.5398f, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar11 = false;
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_41[1]))
			{
				func_242(&(iParam0->f_41[1]), iVar0[6], -490.11f, 233.15f, 82.1f, 0f);
				if (func_127(iParam0->f_28[1]) && UNK_0xC844350D5D58C99A(iParam0->f_41[1]))
				{
					UNK_0x9F528B1B53FBC5D9(iParam0->f_41[1], iParam0->f_28[1], UNK_0x4A089F2B762B8D33(iParam0->f_28[1], 57005), 0.1181f, 0.2229f, -0.1535f, 259.2501f, 24.08f, -51.2899f, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar11 = false;
...
void func_242(bool bParam0, bool bParam1, vector3 vParam2, bool bParam5)
{
	func_207(bParam0);
...
void func_243(bool bParam0, bool bParam1, vector3 vParam2, bool bParam5)
{
	func_244(bParam0);
...
void func_245(bool bParam0, bool bParam1, vector3 vParam2, bool bParam5, int iParam6)
{
	func_246(bParam0);
...
bool func_247(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	if (func_248(bParam0, iParam1, vParam2, fParam5, 1))
	{
		if (UNK_0xC844350D5D58C99A(*bParam0))
		{
			if (!UNK_0x437347B10A200C4B(*bParam0, 0))
...
bool func_248(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6)
{
	bool bVar0;

	if (!func_36(iParam1))
	{
		bVar0 = func_286(iParam1);
...
bool func_252(int iParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			UNK_0xC6A6B4DDD6DC073A(iParam0->f_35[0], 2);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
...
bool func_253(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			break;
		case 1:
			if (!func_250(&iVar0) || !UNK_0xB4AE0788C1587752(bVar30))
			{
				return false;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_126(iParam0->f_28[0]))
			{
				...
				{
					func_242(&(iParam0->f_41[3]), iVar0[1], UNK_0x68E4ADDDDCD7BDDE(iParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_127(iParam0->f_41[3]))
					{
						UNK_0x9F528B1B53FBC5D9(iParam0->f_41[3], iParam0->f_28[0], UNK_0x4A089F2B762B8D33(iParam0->f_28[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			...
			if (bVar32)
			{
				...
				iParam0->f_41[0] = UNK_0xB0BE3DFBBB59A620(joaat("PROP_CS_DUMPSTER_01A"), vVar10[0 /*3*/], true, true, false);
				UNK_0xC023D1C4BF532815(iParam0->f_41[0], vVar20[0 /*3*/], 2, 1);
				UNK_0xE3430088DE1D3440(iParam0->f_41[0], 0);
				iParam0->f_41[1] = UNK_0xB0BE3DFBBB59A620(joaat("PROP_CS_DUMPSTER_LIDL"), vVar10[1 /*3*/], true, true, false);
				UNK_0xC023D1C4BF532815(iParam0->f_41[1], vVar20[1 /*3*/], 2, 1);
				UNK_0xE3430088DE1D3440(iParam0->f_41[1], 0);
				iParam0->f_41[2] = UNK_0xB0BE3DFBBB59A620(joaat("PROP_CS_DUMPSTER_LIDR"), vVar10[2 /*3*/], true, true, false);
				UNK_0xC023D1C4BF532815(iParam0->f_41[2], vVar20[2 /*3*/], 2, 1);
				UNK_0xE3430088DE1D3440(iParam0->f_41[2], 0);
				iLocal_91 = 3;
			}
			break;
		case 3:
			...
			{
				iLocal_94 = UNK_0xE9744DB7B8CA6965(UNK_0x68F4C0EC296D3901(iParam0->f_41[0], true), UNK_0x835730A2D89F6093(iParam0->f_41[0], 2), 2);
				UNK_0xE14EC663EED44AD5(iParam0->f_41[0], iLocal_94, "idle_closed_pap_3_rcm_dumpster", bVar30, 8f, -8f, 0, 1148846080 /* Float: 1000f */);
				UNK_0xC90224D9E95E5E3A(iLocal_94, true);
				if (func_127(iParam0->f_28[0]))
				{
					UNK_0x915804B434753CBD(iParam0->f_28[0], iLocal_94, bVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_127(iParam0->f_41[1]))
				{
					UNK_0xE14EC663EED44AD5(iParam0->f_41[1], iLocal_94, "idle_closed_pap_3_rcm_lid_l", bVar30, 8f, -8f, 0, 1148846080 /* Float: 1000f */);
				}
				if (func_127(iParam0->f_41[2]))
				{
					UNK_0xE14EC663EED44AD5(iParam0->f_41[2], iLocal_94, "idle_closed_pap_3_rcm_lid_r", bVar30, 8f, -8f, 0, 1148846080 /* Float: 1000f */);
				}
			}
			iVar31 = 0;
			while (iVar31 <= (iVar0 - 1))
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (func_126(iParam0->f_28[0]))
			{
				if (!UNK_0xC844350D5D58C99A(iParam0->f_41[0]))
				{
					func_242(&(iParam0->f_41[0]), iVar0[2], UNK_0x68E4ADDDDCD7BDDE(iParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_127(iParam0->f_41[0]))
					{
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_35[0]))
			{
				...
				UNK_0xC6A6B4DDD6DC073A(iParam0->f_35[0], 7);
				...
				UNK_0x55A3C4ED4728EA42(iParam0->f_35[0], "P4P4R4Z0");
			...
			break;
		case 3:
			if (func_127(iParam0->f_28[0]) && func_127(UNK_0x16F2683693E537C9()))
			{
				...
				UNK_0xC90224D9E95E5E3A(iLocal_94, true);
				UNK_0x915804B434753CBD(iParam0->f_28[0], iLocal_94, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
...
bool func_255(int iParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			UNK_0x3F423BF5B8125A50(bVar7);
			iLocal_91 = 1;
			break;
		case 1:
			if (!func_250(&iVar0) || !UNK_0xB4AE0788C1587752(bVar7))
			{
				return false;
			}
			func_256(46, 1);
		...
		case 2:
			...
			if (!UNK_0xC844350D5D58C99A(iParam0->f_35[0]))
			{
				...
				if (func_178(iParam0->f_35[0]))
				{
					UNK_0xC002508A277213DE(iParam0->f_35[0], 62, 62);
				}
				else
				{
					bVar5 = false;
		...
		case 3:
			if (func_127(iParam0->f_28[0]))
			{
				if (UNK_0xB4AE0788C1587752("rcmpaparazzo1beckon"))
				{
					...
					UNK_0xC6EB89C59F2AF6B8(false, bVar7, "pap_idle_01", 8f, -8f, -1, 0, false, 0, 0, 0);
					UNK_0xC6EB89C59F2AF6B8(false, bVar7, "pap_idle_action_01", 8f, -8f, -1, 0, false, 0, 0, 0);
					UNK_0xC6EB89C59F2AF6B8(false, bVar7, "pap_idle_02", 8f, -8f, -1, 0, false, 0, 0, 0);
					UNK_0xC6EB89C59F2AF6B8(false, bVar7, "pap_idle_action_02", 8f, -8f, -1, 0, false, 0, 0, 0);
					UNK_0x25644C31B4B6E9F3(iVar6, 1);
					UNK_0x75ABDC5F81978924(iVar6);
					UNK_0x78ADC381772E3D54(iParam0->f_28[0], iVar6);
					UNK_0xF82EA857DA10E0CD(&iVar6);
				}
			}
			UNK_0x8D17794CE3273D70(bVar7);
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
				if (iVar4 != 1)
...
bool func_267(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
...
bool func_269(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_270(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		{
			case 46:
				UNK_0x71199B01895C6202(bLocal_93);

...
void __EntryFunction__()
{
	...
	iLocal_99 = 49;
	iLocal_100 = 64;
	bLocal_105 = HUD::_GET_LEVEL_BLIP_SPRITE();
...
bool func_103(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool func_139(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_150(int iParam0, bool bParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (bParam1 - iParam2))
				{
					...
					func_144(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_144(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
bool func_217(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (func_42(iLocal_392) && func_49(iLocal_403))
	{
		switch (iLocal_274)
		{
			case 0:
				...
				break;
			case 2:
				fLocal_273 = PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
				PED::SET_SYNCHRONIZED_SCENE_PHASE(fLocal_273, 0f);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(fLocal_273, false);
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(fLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, fLocal_273, sLocal_272, "enter_back", 8f, -8f, 4, iLocal_276, 1000f, 0);
				bLocal_322 = false;
				iLocal_323 = -1;
				iLocal_274 = 12;
				break;
			case 3:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_273))
				{
					if (bLocal_277 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_403, 7))
					{
						iLocal_274 = 14;
			...
			case 4:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(fLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, fLocal_273, sLocal_272, "enter_left", 8f, -8f, 4, iLocal_276, 1000f, 0);
				iLocal_274 = 5;
				break;
			case 5:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_273) >= 0.9f)
					{
						fLocal_273 = PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(fLocal_273, true);
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_273, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(fLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, fLocal_273, sLocal_272, "left", 8f, -8f, 4, iLocal_276, 1000f, 0);
						iLocal_274 = 6;
					}
				}
				break;
			...
			case 7:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(fLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, fLocal_273, sLocal_272, "exit_left", 8f, -8f, 4, iLocal_276, 1000f, 0);
			...
			case 8:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(fLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, fLocal_273, sLocal_272, "enter_right", 8f, -8f, 4, iLocal_276, 1000f, 0);
				iLocal_274 = 9;
				break;
			case 9:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_273) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_273, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(fLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, fLocal_273, sLocal_272, "right", 8f, -8f, 4, iLocal_276, 1000f, 0);
						iLocal_274 = 10;
					}
				}
				break;
			...
			case 11:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(fLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, fLocal_273, sLocal_272, "exit_right", 8f, -8f, 4, iLocal_276, 1000f, 0);
				if (bLocal_277 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_403, 7))
				{
					iLocal_274 = 13;
				}
			...
			case 12:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_273) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_273, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(fLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, fLocal_273, sLocal_272, "back", 8f, -8f, 4, iLocal_276, 1000f, 0);
						iLocal_274 = 3;
					}
				}
				break;
			case 13:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_273) >= 0.7f)
					{
						iLocal_274 = 14;
					}
				}
			...
			case 14:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_273, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(fLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, fLocal_273, sLocal_272, "exit_back", 4f, -8f, 4, iLocal_276, 1000f, 0);
				iLocal_274 = 15;
				break;
			case 15:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_273) >= 0.95f)
					{
						fLocal_273 = PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
						PED::SET_SYNCHRONIZED_SCENE_PHASE(fLocal_273, 0f);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(fLocal_273, false);
						...
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, fLocal_273, sLocal_272, "enter_backseat", 8f, -8f, 4, iLocal_276, 1000f, 0);
						iLocal_274 = 16;
					}
				}
				else
			...
			case 16:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_273))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_273) >= 0.85f)
					{
...
bool func_286(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
void func_327(char* sParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, char* sParam10, char* sParam11, int iParam12, char* sParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, var uParam24)
{
	sParam0->f_4 = iParam5;
	*sParam0 = sParam1;
	sParam0->f_1 = { Param2 };
...
bool func_349(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, float fParam6)
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	if (func_49(iLocal_403))
	{
		...
		if (!func_42(iLocal_392))
		{
			if (STREAMING::HAS_MODEL_LOADED(func_52(14)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_272))
			{
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_273, false);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(fLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, fLocal_273, sLocal_272, "base", 8f, -8f, 4, iLocal_276, 1000f, 0);
				iLocal_274 = 0;
			}
		}
	}
...
void func_419(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (func_434() && func_420(iParam1, iParam2, iParam3, 1))
	{
		vVar0 = { 0f, 0f, 0f };
		fVar3 = 0f;
		func_436(bParam0, vVar0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
bool func_420(int iParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_436(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	else if (iParam9 == 1)
	{
		...
		{
			func_485(iParam12, 0);
			while (!func_437(bParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
bool func_437(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_438(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if ((func_18(iParam0) && ENTITY::DOES_ENTITY_EXIST(*bParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*bParam1, false))
	{
		...
		{
			func_268(bParam1, &(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111638.f_20113[iParam0 /*43*/].f_31 = func_441(*bParam1);
...
bool func_469(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(bParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false)) || func_215(bParam0, 0, 0)) || func_215(bParam0, 1, 0)) || func_215(bParam0, 2, 0)) || func_262(bParam0) != 145) || func_476(bParam0)) || func_475(bParam0)) || func_443(bParam0)) || func_474(bParam0)) || !func_473(ENTITY::GET_ENTITY_MODEL(bParam0)))
	{
		if (func_475(bParam0))
		{
		}
...
int func_480(bool bParam0, var uParam1, var uParam2)
{
	...
	if (func_465(ENTITY::GET_ENTITY_MODEL(*bParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*bParam0, 24) != func_483(*bParam0, ((*uParam1)[38] - 1)))
	{
...
bool func_498(bool bParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_499(bParam0, uVar1[iVar6], 1) && func_424(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_288(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(bParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{

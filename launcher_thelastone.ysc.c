...
int func_184(var uParam0, vector3 vParam1, char[4] cParam4, bool bParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_175(2))
	{
		if (!func_146())
		{
			if (((func_127(UNK_0x16F2683693E537C9()) && func_127(uParam0->f_28[0])) && (UNK_0x1C0640BA9A7327B3() - uParam0->f_60) > iParam8) && func_190(UNK_0x16F2683693E537C9(), vParam1, 1) < 20f)
			{
				...
				func_187(&uVar0, cParam4, bParam5, 7, 0, 0);
				uParam0->f_60 = UNK_0x1C0640BA9A7327B3();
				return 1;
			}
		}
		else if (func_185(bParam5))
		{
...
void func_191(int iParam0, var uParam1, bool bParam2, vector3 vParam3, vector3 vParam6, vector3 vParam9)
{
	float fVar0;
	float fVar1;
	float fVar2;
				...
				else
				{
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								UNK_0x5C8D148FC238F38A();
								UNK_0x8E590B419F1E5182(bParam2, 5, 8);
								func_192(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							UNK_0x5C8D148FC238F38A();
							UNK_0x8E590B419F1E5182(bParam2, 6, 8);
							func_192(*iParam0, 1);
							*uParam1 = 2;
						}
					}
...
bool func_238(int iParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			bVar5 = true;
			iParam0->f_28[0] = UNK_0x36F2404464202779(25, bLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, true);
			if (func_126(iParam0->f_28[0]))
			{
				UNK_0x262EF6C6306BEA6C(iParam0->f_28[0], joaat("WEAPON_SNIPERRIFLE"), 100, true, true);
				UNK_0xC6EB89C59F2AF6B8(iParam0->f_28[0], "rcmlastone1", "idle_action_01", 8f, -8f, -1, 1, false, 0, 0, 0);
...
bool func_252(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
...
bool func_253(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
...
bool func_254(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;

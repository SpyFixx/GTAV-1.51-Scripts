...
void __EntryFunction__()
{
	...
	if (SYSTEM::VMAG2(UNK_0x56E9E0FD5ACCD35D(UNK_0x16F2683693E537C9())) > 1369f && !func_107())
	{
		func_114(0);
	}
	...
	bLocal_241 = true;
	if (UNK_0xC844350D5D58C99A(bLocal_240) && func_103(bLocal_240))
	{
	...
	while (iVar0 == 1)
	{
		...
		fVar43 = func_97(UNK_0x16F2683693E537C9(), bLocal_240);
		...
		if (UNK_0xE1DBBD6CE209517C(UNK_0xD803B885F5E47A62()))
		{
			if ((((UNK_0xD3AB958FFC730661(UNK_0xD803B885F5E47A62(), bLocal_240) || UNK_0x292E02BF8ABF889C(UNK_0xD803B885F5E47A62(), bLocal_240)) && fVar43 < 25f) && func_89(UNK_0x16F2683693E537C9()) != joaat("WEAPON_UNARMED")) && func_86(bLocal_240, UNK_0x16F2683693E537C9(), 1126825984 /* Float: 170f */, 0))
			{
				if (!func_90())
				{
					func_92();
		...
		if (func_85(bLocal_240, UNK_0x16F2683693E537C9(), 1) < 25f)
		{
			if (!UNK_0xE4EDC4B0E92C078B(iLocal_248))
			{
				func_81(&iLocal_248, &bLocal_240, 0);
			}
		}
		...
		switch (iLocal_250)
		{
			...
			case 3:
				...
				if (func_85(bLocal_240, UNK_0x16F2683693E537C9(), 1) < fVar40)
				{
					if (func_59() == 1)
					{
						iLocal_250 = 8;
			...
			case 8:
				...
				else if (bLocal_440 == 1)
				{
					...
					{
						func_53(Global_111583[iLocal_251], iLocal_297, UNK_0x8CA9406E01C7EE58(bLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			case 9:
			...
			case 13:
				...
				func_51(&uVar1);
				func_50(&uLocal_37, 0, UNK_0x16F2683693E537C9(), &uVar1, 0, 1);
				func_50(&uLocal_37, 3, bLocal_240, &cLocal_236, 0, 1);
				func_49(&cVar5);
		...
		if (((((((((((((iLocal_250 == 0 || iLocal_250 == 1) || iLocal_250 == 3) || iLocal_250 == 8) || iLocal_250 == 9) || iLocal_250 == 7) && func_85(bLocal_240, UNK_0x16F2683693E537C9(), 1) < 5f) && bLocal_436 == 1) && !UNK_0x405E212DDE472467(UNK_0x16F2683693E537C9(), 1)) && iVar30 == 0) && bLocal_439 == 1) && !Global_3) && func_7()) && bVar81)
		{
			if (iLocal_298 == -1)
			{
	...
	while (true)
	{
		...
		if ((UNK_0x03068588A1FCED1A(bLocal_240) && func_85(bLocal_240, UNK_0x16F2683693E537C9(), 1) > 50f) && !UNK_0x338D6FF72D84D90F())
		{
			func_114(1);
		}
		SYSTEM::WAIT(0);
...
{
	func_10();
	if (func_103(bLocal_240) && func_103(UNK_0x16F2683693E537C9()))
	{
		UNK_0x11AD11297DC58CC7(bLocal_240, false);
...
void func_10()
{
	if (bLocal_449)
	{
		if (func_8())
		{
			UNK_0x15AFB6CBDE990FB6(bLocal_448, 1, true);
			bLocal_449 = false;
		}
		else
		{
			UNK_0xF690C84DADBB3551(&bLocal_448);
			bLocal_449 = false;
		}
	}
}
...
void func_53(int iParam0, int iParam1, float fParam2)
{
	if (iParam0 == 3)
	{
		...
		{
			bLocal_448 = UNK_0x7707E48765093646(joaat("PROP_NPC_PHONE"), UNK_0x68F4C0EC296D3901(bLocal_240, true), true, true, false);
			UNK_0x9F528B1B53FBC5D9(bLocal_448, bLocal_240, UNK_0x4A089F2B762B8D33(bLocal_240, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			bLocal_449 = true;
		}
	...
	if (iLocal_447 == 1)
	{
		if (!UNK_0xE4EDC4B0E92C078B(*iParam0))
		{
			if (UNK_0xC844350D5D58C99A(*bParam1))
			{
				...
				{
					*iParam0 = func_82(*bParam1, bParam2, 145);
					if (bParam2 == 0)
					{
...
int func_82(bool bParam0, bool bParam1, int iParam2)
{
	...
	iVar0 = func_83(bParam0, !bParam1, 0);
...
bool func_86(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_88(UNK_0x68F4C0EC296D3901(bParam1, true) - UNK_0x68F4C0EC296D3901(bParam0, true)) };
	...
	{
		vVar3 = { func_88(UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 5f, 0f) - UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_105()
{
	UNK_0xC978532B427F303B(bLocal_240, 0);
	UNK_0x4E885A246A9D983A(bLocal_240, 185, true);
	UNK_0x4E885A246A9D983A(bLocal_240, 318, true);
}

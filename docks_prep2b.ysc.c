...
void func_1()
{
	...
	if (iLocal_28 == 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
			{
				if (func_2(bLocal_48, PLAYER::PLAYER_PED_ID(), 1) > 850f)
				{
					func_3(2);
					return;
				}
	...
	if (iLocal_28 == 3 || iLocal_28 == 4)
	{
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
			{
				if (func_2(bLocal_48, PLAYER::PLAYER_PED_ID(), 1) > 100f)
				{
					func_3(2);
					return;
				}
				else if ((VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(bLocal_48, 3, 30000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(bLocal_48, 1, 40000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(bLocal_48, 0, 7000))
				{
					func_3(3);
					return;
				}
...
float func_2(bool bParam0, bool bParam1, bool bParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_29()
{
	...
	if (iLocal_175 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
		{
			ENTITY::FREEZE_ENTITY_POSITION(bLocal_48, false);
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, false))
				{
					TASK::TASK_LEAVE_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, 0);
				}
			}
		}
		iLocal_197 = 1;
	...
	if (iLocal_175 == 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, true))
				{
					VEHICLE::SET_VEHICLE_DOOR_SHUT(bLocal_48, 0, false);
					VEHICLE::SET_VEHICLE_DOOR_SHUT(bLocal_48, 1, false);
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_48, 2);
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(bLocal_48, false);
					ENTITY::FREEZE_ENTITY_POSITION(bLocal_48, true);
					func_30();
				}
			}
		}
...
void func_35()
{
	switch (iLocal_28)
	{
		case 2:
			...
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_55, false))
				{
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_55, -1);
				}
			}
			else
			{
			...
			if (func_20() == 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
					{
						if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, false))
						{
							PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, -1);
						}
						ENTITY::FREEZE_ENTITY_POSITION(bLocal_48, false);
					}
				}
	...
	switch (iLocal_28)
	{
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(bLocal_48))
			{
				...
				bLocal_48 = VEHICLE::CREATE_VEHICLE(joaat("CARGOBOB"), vLocal_311, fLocal_323, true, true, false);
				VEHICLE::SET_VEHICLE_CAN_BE_TARGETTED(bLocal_48, false);
				ENTITY::FREEZE_ENTITY_POSITION(bLocal_48, true);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_48, true, 1);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("CARGOBOB"));
				VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("CARGOBOB"), true);
				VEHICLE::SET_VEHICLE_STRONG(bLocal_48, true);
				VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(bLocal_48, false);
				...
				if (!ENTITY::DOES_ENTITY_EXIST(bLocal_55))
				{
					if (func_108())
					{
						if (!VEHICLE::IS_THIS_MODEL_A_HELI(func_107()) && !VEHICLE::IS_THIS_MODEL_A_PLANE(func_107()))
						{
							...
							VEHICLE::SET_VEHICLE_STRONG(bLocal_55, true);
						}
					}
				}
			}
		...
		case 3:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(bLocal_48))
			{
				...
				ENTITY::FREEZE_ENTITY_POSITION(bLocal_48, true);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_48, true, 1);
				VEHICLE::SET_HELI_BLADES_FULL_SPEED(bLocal_48);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("CARGOBOB"));
				VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("CARGOBOB"), true);
				VEHICLE::SET_VEHICLE_STRONG(bLocal_48, true);
				VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(bLocal_48, false);
		...
		case 4:
			...
			{
				MISC::CLEAR_AREA(vLocal_311, 10f, true, false, false, false);
				bLocal_48 = VEHICLE::CREATE_VEHICLE(joaat("CARGOBOB"), -629.1677f, 2871.31f, 385.0313f, 283.1214f, true, true, false);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_48, true, 1);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("CARGOBOB"));
				VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("CARGOBOB"), true);
				VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(bLocal_48, false);
				VEHICLE::SET_VEHICLE_STRONG(bLocal_48, true);
				VEHICLE::SET_VEHICLE_ENGINE_ON(bLocal_48, true, true, false);
				VEHICLE::SET_HELI_BLADES_FULL_SPEED(bLocal_48);
				VEHICLE::SET_VEHICLE_FORWARD_SPEED(bLocal_48, 30f);
				func_103(bLocal_48, 0);
			}
			WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), joaat("GADGET_PARACHUTE"), -1, false, true);
			break;
		case 5:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(bLocal_48))
			{
				...
				bLocal_48 = VEHICLE::CREATE_VEHICLE(joaat("CARGOBOB"), 1749.61f, 3272.95f, 40.1533f, 51.128f, true, true, false);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_48, true, 1);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("CARGOBOB"));
				VEHICLE::SET_VEHICLE_STRONG(bLocal_48, true);
				VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(bLocal_48, false);
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_8(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(bParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
void func_109(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11, int iParam12, float fParam13, float fParam14, int iParam15)
{
	func_110(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, fParam13, fParam14, iParam15);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(bVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_112(bVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
bool func_112(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_116()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_55))
	{
		VEHICLE::DELETE_VEHICLE(&bLocal_55);
	}
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
	{
		VEHICLE::DELETE_VEHICLE(&bLocal_48);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
	{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, false))
			{
				...
				if (iLocal_28 == 3)
				{
					if (!HUD::DOES_BLIP_EXIST(iLocal_63[0]))
					{
	...
	if (iLocal_175 == 1)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, false))
				{
					if (ENTITY::IS_ENTITY_IN_AIR(bLocal_48))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_311, true) > 800f)
						{
		...
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, false))
				{
					...
					{
						if (!ENTITY::IS_ENTITY_IN_AIR(bLocal_48) && VEHICLE::IS_VEHICLE_STOPPED(bLocal_48))
						{
							func_128(1, 600);
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96075[iVar0]))
		{
			if (Global_96075[iVar0] == bParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(bParam0) == func_72(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (iLocal_175 == 1)
	{
		if (iLocal_206[0] == 1)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(bLocal_48, 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, false, true, 0))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, false))
						{
							PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, false);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_31[0]))
						{
							...
							TASK::TASK_HELI_MISSION(0, iLocal_49[0], 0, 0, vLocal_317.x, vLocal_317.y, (vLocal_317.z + 20f), 4, 30f, 10f, -1f, 170, 40, -1082130432 /* Float: -1f */, 0);
							TASK::TASK_HELI_MISSION(0, iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 40, -1082130432 /* Float: -1f */, 0);
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_31[0]))
					{
						if (PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_49[0], false))
						{
							...
							else if (MISC::GET_GAME_TIMER() > iLocal_188 + 10000 && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, false))
							{
								if (iLocal_297 == 0)
								{
									PED::SET_PED_ACCURACY(iLocal_31[0], 100);
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 15, 10, -1082130432 /* Float: -1f */, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 50, 20, -1082130432 /* Float: -1f */, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 70, -1082130432 /* Float: -1f */, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, 0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_49[0], 20f, 0f, 0f), 4, 10f, 10f, ENTITY::GET_ENTITY_HEADING(iLocal_49[0]), SYSTEM::ROUND(ENTITY::GET_ENTITY_HEIGHT(iLocal_49[0], ENTITY::GET_ENTITY_COORDS(iLocal_49[0], true), true, true)), 100, -1082130432 /* Float: -1f */, 0);
									iLocal_215[0] = 0;
								}
							}
						}
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
							{
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
								{
									if (!PED::IS_PED_INJURED(iLocal_31[0]))
									{
										TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 170, 70, -1082130432 /* Float: -1f */, 0);
										iLocal_295 = 1;
									}
								}
							}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49[0], false))
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(iLocal_31[0]))
								{
									TASK::TASK_HELI_MISSION(iLocal_31[0], iLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 8, 40f, 50f, -1f, 200, 170, -1082130432 /* Float: -1f */, 0);
									iLocal_215[0] = 0;
								}
							}
						}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_31[0]))
			{
				if (!PED::IS_PED_INJURED(iLocal_31[0]))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_49[0], false))
					{
						if (HUD::DOES_BLIP_EXIST(iLocal_63[0]))
						{
							HUD::SET_BLIP_SCALE(iLocal_63[0], 1f);
						}
					}
					if (func_2(PLAYER::PLAYER_PED_ID(), iLocal_31[0], 1) > 600f)
					{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_33[iLocal_176]))
				{
					if (!PED::IS_PED_INJURED(iLocal_33[iLocal_176]))
					{
						if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
							{
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, false) || iLocal_212 == 1)
								{
									...
									else if (iLocal_231[iLocal_176] == 0)
									{
										TASK::CLEAR_PED_TASKS(iLocal_33[iLocal_176]);
										TASK::OPEN_SEQUENCE_TASK(&iLocal_572);
										TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(bLocal_48, true), 2f, -1, 20f, false, 40000f);
...
void func_237()
{
	...
	if (iLocal_175 == 1)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
			{
				if (func_2(PLAYER::PLAYER_PED_ID(), bLocal_48, 1) < 30f)
				{
					iLocal_212 = 1;
				}
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, false))
...
void func_246(bool bParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(bParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false))
	{
		...
		func_248(iParam5, &Var0, vParam1, fParam4, func_61(bParam0));
...
void func_256()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(bLocal_48))
	{
		...
		bLocal_48 = VEHICLE::CREATE_VEHICLE(joaat("CARGOBOB"), 1740.852f, 3263.161f, 40.2743f, 280.3712f, true, true, false);
		VEHICLE::SET_VEHICLE_DOOR_SHUT(bLocal_48, 0, true);
		VEHICLE::SET_VEHICLE_DOOR_SHUT(bLocal_48, 1, true);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_48, 2);
		VEHICLE::SET_VEHICLE_STRONG(bLocal_48, true);
		ENTITY::FREEZE_ENTITY_POSITION(bLocal_48, true);
		VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(bLocal_48, false);
	...
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_48))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_48, false))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48, false))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_48))
					{
						if (func_262(PLAYER::PLAYER_PED_ID(), bLocal_48) == -1)
						{
...
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, false) && !ENTITY::IS_ENTITY_DEAD(bParam1, false))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(iParam0, bParam1))
		{
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(bParam1, -1, false) == iParam0)
			{
				return -1;
			}
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(bParam1, 0, false) == iParam0)
			{
				return 0;
			}
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(bParam1, 1, false) == iParam0)
			...
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(bParam1, 2, false) == iParam0)
			{
				return 2;
			}
		}

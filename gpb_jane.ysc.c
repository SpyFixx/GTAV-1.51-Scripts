...
void func_9()
{
	...
	{
		UNK_0x79C43E2BAC7C696F(bLocal_240, bLocal_448, 1048576000 /* Float: 0.25f */);
	}
}
...
void func_104()
{
	UNK_0x3F423BF5B8125A50(bLocal_448);
	while (!UNK_0xB4AE0788C1587752(bLocal_448))
	{
		SYSTEM::WAIT(0);
	}
	iLocal_449 = 1;
...
void func_118()
{
	if (iLocal_449 == 1)
	{
		if (UNK_0xB4AE0788C1587752(bLocal_448))
		{
			UNK_0x8D17794CE3273D70(bLocal_448);
		}
	}
}

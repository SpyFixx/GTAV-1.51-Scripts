...
bool func_26(var uParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
void func_70(int iParam0, struct<2> Param1, var uParam3, struct<2> Param4, var uParam6)
{
	vector3 vVar0;
...
bool func_71(var uParam0, var uParam1)
{
	...
	if (SYSTEM::VDIST(vVar0, func_43(uParam0, func_299(uParam1))) > fVar3)
	{
		return false;
	}
	return true;
...
bool func_100(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	char* sVar1;
	char cVar2[32];
...
void func_179(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	func_180(uParam0, iParam1, func_185(uParam0, iParam1), uParam2, iParam3, iParam4);
}
...
bool func_181(vector3 vParam0, struct<2> Param3, float fParam5, Vector3* vParam6, float* fParam7, vector3 vParam8, struct<2> Param11, var uParam13, bool bParam14)
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
bool func_183(vector3 vParam0, struct<2> Param3, var uParam5, Vector3* vParam6, float* fParam7)
{
...
int func_211(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, float fParam12)
{
	...
	if (((!vParam0.x == Global_2439138.f_1235 || !vParam0.y == Global_2439138.f_1235.f_1) || !vParam0.z == Global_2439138.f_1235.f_2) || !fParam3 == Global_2439138.f_1238)
	{
		...
		{
			if (NETWORK::IS_TIME_EQUAL_TO(NETWORK::_0xBA7F0B77D80A4EB7(), Global_2439138.f_1239) < func_214(0))
			{
				return 0;
			}
			PLAYER::STOP_PLAYER_TELEPORT();
...
bool func_212(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
...
bool func_219(int iParam0, bool bParam1, bool bParam2)
{
...
bool func_233(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	vector3 vVar1;
...
bool func_237(var uParam0, var uParam1, bool bParam2)
{
	vector3 vVar0;
...
float func_244(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
...
bool func_263(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	bool bVar1;
...
bool func_264(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
bool func_269(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;

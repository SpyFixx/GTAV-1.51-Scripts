...
void func_3()
{
	...
	while (bVar1 <= (16 - 1))
	{
		if (Local_24[bVar1] != -1)
		{
			if ((!UNK_0xEAE0D21A50E6C7F4(bLocal_58, bVar1) && iVar0 >= Local_24[bVar1]) && iVar0 < Local_24.f_17[bVar1])
			{
				func_4();
				UNK_0x5D96D8530B3D0904(&bLocal_58, bVar1);
			}
		}
		bVar1++;
	}
...
void func_16(bool bParam0)
{
	...
	while (bVar0 <= 26)
	{
		func_21(&(Local_90[bVar0 /*178*/]), bVar0);
		bVar0++;
	}
	bVar0 = false;
	while (bVar0 <= 29)
	{
		func_20(&(Local_4898[bVar0 /*24*/]), bVar0);
		bVar0++;
	}
	bVar0 = false;
	while (bVar0 <= 23)
	{
		func_19(&(Local_5620[bVar0 /*24*/]), bVar0);
		bVar0++;
	}
...
{
	Local_24[bParam0] = iParam1;
	Local_24.f_17[bParam0] = iParam2;
}

void func_19(var uParam0, bool bParam1)
{
	uParam0->f_22 = 0;
	UNK_0x0674E58A79778E99(&uLocal_6197, bParam1);
...
{
	uParam0->f_22 = 0;
	UNK_0x0674E58A79778E99(&uLocal_5619, bParam1);
	if (bParam1 == 0 && uParam0->f_22 == 0)
	{
	}
}
...
void func_21(var uParam0, bool bParam1)
{
	...
	func_26(uParam0);
	UNK_0x0674E58A79778E99(&uLocal_4897, bParam1);
	switch (bParam1)
	{
		case 0:
...
void func_22(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, var uParam8, var uParam9)
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam4 };
	uParam0->f_7 = fParam7;
...
void func_23(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5, int iParam8, var uParam9, var uParam10)
{
	if (uParam0->f_154 >= *uParam0)
	{
		return;
	}
	func_24(uParam0[uParam0->f_154 /*17*/], iParam1, vParam2, vParam5, iParam8, uParam9, uParam10);
	uParam0->f_154++;
}

void func_24(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5, int iParam8, var uParam9, var uParam10)
{
	*uParam0 = { vParam2 };
	uParam0->f_3 = { vParam5 };
	uParam0->f_6 = iParam8;
...
int func_28(bool bParam0, int iParam1, int iParam2)
{
	...
	if (*iParam1 == 0)
	{
		*iParam1 = UNK_0xB01F55A0FD1CFD49(bParam0);
	}
	...
	while (!UNK_0x83D8570832F172A7(*iParam1))
	{
		SYSTEM::WAIT(0);
		if (UNK_0x1C0640BA9A7327B3() > iVar0 && !UNK_0x83D8570832F172A7(*iParam1))
		{
			return 0;
		}
	}
...
void func_42()
{
	...
	bVar0 = false;
	while (bVar0 < Local_90)
	{
		func_49(&(Local_90[bVar0 /*178*/]));
		bVar0++;
	}
	bVar0 = false;
	bVar0 = false;
	while (bVar0 < Local_4898)
	{
		func_46(&(Local_4898[bVar0 /*24*/]));
		bVar0++;
	}
	bVar0 = false;
	bVar0 = false;
	while (bVar0 < Local_5620)
	{
		func_46(&(Local_5620[bVar0 /*24*/]));
		bVar0++;
	}
	bVar0 = false;
	bVar0 = false;
	...
	{
		func_45(iLocal_59[bVar0]);
		bVar0++;
	}
	bVar0 = false;
	while (bVar0 <= 12)
	{
		func_44(func_30(bVar0));
		bVar0++;
	}
	func_43(iLocal_6213);
	func_6(0, 1, 1, 0, 0, 0);
...
{
	UNK_0x8D17794CE3273D70(bParam0);
}
...
void func_46(var uParam0)
{
	...
	while (iVar0 < uParam0->f_17)
	{
		...
		{
			UNK_0x7720CBBC7DD82563(uParam0->f_17[iVar0], bVar2, bVar1, -1000f);
		}

...
bool func_44(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool func_53(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	switch (iParam0)
	{
...
bool func_63(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_73(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_75(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
void func_94(int iParam0, bool bParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (bParam1 - iParam2))
				{
					...
					func_87(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_87(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_164(char* sParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, char* sParam10, char* sParam11, int iParam12, char* sParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, var uParam24)
{
	sParam0->f_4 = iParam5;
	*sParam0 = sParam1;
	sParam0->f_1 = { Param2 };
	...
	if (func_206(Local_98.f_28[1]) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 3))
		{
			if (PED::IS_PED_BEING_STEALTH_KILLED(Local_98.f_28[1]))
			{
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_390))
				{
					ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_98.f_28[1], -4f, true);
					PED::SET_SYNCHRONIZED_SCENE_PHASE(fLocal_390, 1f);
				}
				else
				{
...
bool func_253(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;
...
bool func_267(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_268(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_270(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
bool func_271(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_291(bool bParam0)
{
	...
	if (bLocal_391)
	{
		if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_390))
		{
			fLocal_390 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_401, vLocal_404, 2);
			PED::SET_SYNCHRONIZED_SCENE_LOOPED(fLocal_390, false);
			PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fLocal_390, false);
			...
			if (func_206(Local_98.f_28[0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[0], fLocal_390, sLocal_377, sVar1, fVar4, -4f, 1, 16, 1000f, 0);
			}
			if (func_206(Local_98.f_28[1]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[1], fLocal_390, sLocal_377, sVar2, 1000f, -2f, 1, 16, 1000f, 0);
			}
			if (func_206(Local_98.f_28[2]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[2], fLocal_390, sLocal_377, sVar3, fVar4, -4f, 1, 16, 1000f, 0);
			}
		}
	}
	else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_390))
	{
...
void func_319()
{
	...
	if (func_206(Local_98.f_28[0]))
	{
		TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[0], fLocal_390, sLocal_377, sLocal_392, 1000f, -4f, 1, 16, 1000f, 0);
	}
	if (func_206(Local_98.f_28[1]))
	{
		TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[1], fLocal_390, sLocal_377, sLocal_393, 1000f, -4f, 1, 16, 1000f, 0);
	}
	if (func_206(Local_98.f_28[2]))
	{
		TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[2], fLocal_390, sLocal_377, sLocal_394, 1000f, -4f, 1, 16, 1000f, 0);
	}
	bLocal_391 = true;
}
...
bool func_322(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_334(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, int iParam10, int iParam11, var uParam12, float fParam13, float fParam14, var uParam15)
{
	func_335(vParam0, vParam3, fParam6, vParam7, iParam10, 0f, 0f, 0f, iParam11, uParam12, fParam13, fParam14, uParam15);
}
...
bool func_339(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool func_342(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_392(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
					...
					fVar10 = PED::CREATE_SYNCHRONIZED_SCENE(-490.809f, 232.39f, 82.018f, 0f, 0f, 33.84f, 2);
					PED::SET_SYNCHRONIZED_SCENE_LOOPED(fVar10, true);
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(fVar10, false);
					TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], fVar10, "rcmpaparazzo_4", "pap_4_rcm_leadin", 8f, -8f, 1, 16, 1000f, 0);
				}
				else
				{
					bVar11 = false;
...
bool func_392(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
...
bool func_393(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;

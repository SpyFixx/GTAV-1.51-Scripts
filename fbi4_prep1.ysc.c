...
int func_82(var uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
...
bool func_113(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	float fVar0;
...
bool func_150(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
bool func_152(int iParam0, char* sParam1, int iParam2)
{
...
bool func_153(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_152(iParam1, "Loading", 0))
...
bool func_159(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
bool func_181(int iParam0, int iParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_193(int iParam0, bool bParam1)
{
	switch (iParam0->f_1)
	{
		case 0:
			break;
		case 1:
			*iParam0 = SHAPETEST::START_SHAPE_TEST_LOS_PROBE(iParam0->f_2, iParam0->f_5, 511, bParam1, 7);
			break;
		case 2:
		...
		case 3:
			*iParam0 = SHAPETEST::START_SHAPE_TEST_BOUNDING_BOX(iParam0->f_17, 511, 4);
			break;
		case 4:
			*iParam0 = SHAPETEST::START_SHAPE_TEST_BOX(iParam0->f_2, iParam0->f_8, iParam0->f_11, iParam0->f_14, 6, bParam1, 4);
			break;
		case 5:
			*iParam0 = SHAPETEST::START_SHAPE_TEST_CAPSULE(iParam0->f_2, iParam0->f_5, iParam0->f_15, 511, bParam1, 4);
			break;
	}
...
bool func_204(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;
...
bool func_209(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_210(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_212(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
bool func_225(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)
{

...
int func_121(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
bool func_339(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
bool func_354(vector3 vParam0, float fParam3, bool bParam4, bool bParam5)
{
...
bool func_422(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
		...
		case 0:
			...
			*iParam0 = 1;
			if (func_575(Local_96.f_28[0]))
			{
				if (CAM::_0xEE778F8C7E1142E2(0) == 4)
				{
					CAM::SET_GAMEPLAY_ENTITY_HINT(Local_96.f_28[0], 0f, 0f, 0.8f, true, -1, 3000, 2000, false);
					CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETX(0f);
				}
				else
				{
					CAM::SET_GAMEPLAY_ENTITY_HINT(Local_96.f_28[0], 0.5f, 0f, 0.8f, true, -1, 3000, 2000, false);
...
bool func_471(int iParam0, int iParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
bool func_514(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
...
bool func_515(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;

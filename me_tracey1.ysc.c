...
void __EntryFunction__()
{
	...
	iLocal_84 = 49;
	iLocal_85 = 64;
	bLocal_90 = HUD::_GET_LEVEL_BLIP_SPRITE();
...
void func_40()
{
	...
	{
		case 0:
			if (VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(bLocal_273) < 1f)
			{
				VEHICLE::SET_VEHICLE_PETROL_TANK_HEALTH(bLocal_273, 10f);
			}
			if (VEHICLE::GET_VEHICLE_ENGINE_HEALTH(bLocal_273) < 1f)
			{
				VEHICLE::SET_VEHICLE_ENGINE_HEALTH(bLocal_273, 10f);
			}
			if (func_185(bLocal_273, 5f, 5, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				if (bLocal_533)
				{
					...
					TASK::TASK_LEAVE_VEHICLE(0, bLocal_273, 0);
				...
				TASK::CLEAR_PED_TASKS(bLocal_289);
				TASK::TASK_PERFORM_SEQUENCE(bLocal_289, iVar0);
				TASK::CLEAR_SEQUENCE_TASK(&iVar0);
				PED::SET_PED_CONFIG_FLAG(bLocal_289, 104, true);
				bLocal_472 = false;
				if (func_184())
				{
					bLocal_476 = true;
		...
		case 1:
			...
			else if ((func_62(bLocal_289, vLocal_530, 2f) || (MISC::GET_GAME_TIMER() - iLocal_474) > 5000) || bLocal_475)
			{
				if (bLocal_476)
				{
			...
			if (!bLocal_533)
			{
				PED::SET_PED_RESET_FLAG(bLocal_289, 247, true);
			}
			break;
		case 2:
			if (bLocal_533)
			...
			else
			{
				if (bLocal_475)
				{
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(bLocal_289);
					ENTITY::SET_ENTITY_COORDS(bLocal_289, -813.7761f, 179.4943f, 71.1592f, false, false, false, true);
					PED::_0x2208438012482A1A(bLocal_289, false, false);
				}
				if (func_29())
				{
					func_60();
				}
				VEHICLE::SET_VEHICLE_DOOR_SHUT(bLocal_273, 1, true);
				func_57(bLocal_289);
			}
...
bool func_76(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
bool func_80(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool func_104(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	switch (iParam0)
	{
		case joaat("PLAYER_ZERO"):
...
bool func_105(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (iParam0 == joaat("PLAYER_ZERO"))
	{
		if (iParam1 == 6)
...
bool func_116(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_127(int iParam0, bool bParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (bParam1 - iParam2))
				{
					...
					func_121(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_121(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
bool func_185(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_187()
{
	switch (iLocal_93)
	{
		case 0:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false))
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 0)
				{
		...
		case 1:
			...
			if (bLocal_305)
			{
				...
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false))
				{
					...
					func_33(&iLocal_298);
					HUD::CLEAR_PRINTS();
					if (!PED::IS_PED_IN_VEHICLE(bLocal_289, bLocal_273, false))
					{
						bLocal_306 = true;
						bLocal_307 = false;
				...
				else if (!func_197(PLAYER::PLAYER_PED_ID(), bLocal_289, 160f, 1))
				{
					sLocal_573 = "MET1ABANDON";
					iLocal_92 = 11;
					iLocal_93 = 0;
				}
				else if (!func_197(PLAYER::PLAYER_PED_ID(), bLocal_289, 60f, 1))
				{
					func_34(6);
				}
			}
			else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false))
			{
				bLocal_305 = true;
				HUD::CLEAR_PRINTS();
				func_33(&iLocal_297);
			...
			else if (bLocal_306)
			{
				...
				{
					bLocal_307 = true;
					TASK::TASK_ENTER_VEHICLE(bLocal_289, bLocal_273, 20000, 0, 2f, 1, 0);
				}
				if (PED::IS_PED_IN_VEHICLE(bLocal_289, bLocal_273, false))
				{
					bLocal_306 = false;
				...
				{
					if (!func_197(PLAYER::PLAYER_PED_ID(), bLocal_289, 60f, 1))
					{
						func_34(6);
					}
				}
			...
			else if (!PED::IS_PED_IN_VEHICLE(bLocal_289, bLocal_273, false))
			{
				bLocal_306 = true;
				bLocal_307 = false;
				HUD::CLEAR_PRINTS();
...
void func_191()
{
	...
	else
	{
			...
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > vLocal_438[3 /*3*/] && !func_62(PLAYER::PLAYER_PED_ID(), vLocal_527, 50f))
			{
				if (func_3(&uLocal_96, vLocal_438[3 /*3*/].f_1, vLocal_438[3 /*3*/].f_2, 7, 0, 0, 0))
				{
					if (!bLocal_337)
					{
						...
						TASK::CLEAR_PED_TASKS(bLocal_289);
						TASK::TASK_PERFORM_SEQUENCE(bLocal_289, iVar1);
					}
					iLocal_466++;
				}
			}
		...
		if (iLocal_466 == 8)
		{
			...
			{
				if ((ENTITY::GET_ENTITY_HEALTH(bLocal_273) < 900 || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(bLocal_273) < 900f) || VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(bLocal_273) < 900f)
				{
					iLocal_466++;
					iLocal_467 = MISC::GET_GAME_TIMER();
				}
...
bool func_194()
{
	if (bLocal_274 && VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(bLocal_273))
	{
		return true;
	}
	return false;
...
void func_201()
{
	if (bLocal_312 == 0)
	{
		if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false) && PED::IS_PED_IN_VEHICLE(bLocal_289, bLocal_273, false)) && ENTITY::GET_ENTITY_SPEED(bLocal_273) > 30f)
		{
...
bool func_239(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
void func_280(char* sParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, char* sParam10, char* sParam11, int iParam12, char* sParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, var uParam24)
{
	sParam0->f_4 = iParam5;
	*sParam0 = sParam1;
	sParam0->f_1 = { Param2 };
...
void func_289()
{
	...
	switch (iLocal_93)
	{
		case 0:
			...
			{
				TASK::CLEAR_PED_TASKS(bLocal_290);
				PED::SET_PED_FLEE_ATTRIBUTES(bLocal_290, 2, false);
				if (PED::IS_PED_IN_ANY_VEHICLE(bLocal_290, false))
				{
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					...
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
					TASK::TASK_PERFORM_SEQUENCE(bLocal_290, iVar0);
					TASK::CLEAR_SEQUENCE_TASK(&iVar0);
				}
				else
				{
					TASK::TASK_SMART_FLEE_COORD(bLocal_290, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2000f, -1, false, false);
				}
				bLocal_413 = false;
				bLocal_414 = false;
				iLocal_415 = 0;
				...
				ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(bLocal_290, true, 0f);
		...
		case 1:
			...
			if (func_32(bLocal_290))
			{
				if (!func_197(bLocal_290, PLAYER::PLAYER_PED_ID(), 80f, 1) && !ENTITY::IS_ENTITY_ON_SCREEN(bLocal_290))
				{
					func_39(&bLocal_290);
					bLocal_337 = func_301();
					iLocal_93 = 2;
				...
				else
				{
					...
					else if ((((PED::IS_PED_ON_FOOT(bLocal_290) && !PED::IS_PED_RAGDOLL(bLocal_290)) && !TASK::IS_PED_GETTING_UP(bLocal_290)) && !FIRE::IS_ENTITY_ON_FIRE(bLocal_290)) && !ENTITY::IS_ENTITY_IN_AIR(bLocal_290))
					{
					...
					func_313(&uLocal_261, bLocal_290, 0, 0, 1, 1, 1);
					func_292();
					PED::SET_PED_MAX_MOVE_BLEND_RATIO(bLocal_290, 2.2f);
					func_312();
				}
			}
			else
...
void func_292()
{
	if (!bLocal_604)
	{
		...
		{
			func_295(1);
			if (((func_294(vLocal_584[0 /*3*/], vLocal_584[2 /*3*/], 1f) && !PED::IS_PED_IN_MELEE_COMBAT(bLocal_290)) && !PED::IS_PED_RAGDOLL(bLocal_290)) && !TASK::IS_PED_GETTING_UP(bLocal_290))
			{
				TASK::TASK_COWER(bLocal_290, -1);
				bLocal_604 = true;
			}
		}
		if (!bLocal_604)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_IN_ANY_VEHICLE(bLocal_290, false))
			{
				if (((MISC::GET_GAME_TIMER() > uLocal_606[0] && func_197(PLAYER::PLAYER_PED_ID(), bLocal_290, 20f, 1)) && !PED::IS_PED_RAGDOLL(bLocal_290)) && !TASK::IS_PED_GETTING_UP(bLocal_290))
				{
					func_293(0, 0);
				}
				else if (MISC::GET_GAME_TIMER() > uLocal_606[1])
				{
					if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(bLocal_290, 0f, 1f, -2f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(bLocal_290, 0f, 7f, 5f), 5f, false, true, 0) && !PED::IS_PED_RAGDOLL(bLocal_290)) && !TASK::IS_PED_GETTING_UP(bLocal_290))
					{
						func_293(0, 1);
					}
					else
			...
			else if (!bLocal_605 && !PED::IS_PED_IN_ANY_VEHICLE(bLocal_290, false))
			{
				func_293(1, 1);
			}
		}
...
void func_293(int iParam0, bool bParam1)
{
	...
	{
		TASK::TASK_SMART_FLEE_PED(bLocal_290, PLAYER::PLAYER_PED_ID(), 2000f, -1, false, false);
		uLocal_606[0] = MISC::GET_GAME_TIMER() + 10000;
		if (bParam1)
		{
			uLocal_606[1] = MISC::GET_GAME_TIMER() + 10000;
...
void func_295(bool bParam0)
{
	...
	if (bParam0)
	{
		vLocal_584[5 /*3*/] = { ENTITY::GET_ENTITY_COORDS(bLocal_290, true) };
	}
	else
	{
...
void func_296()
{
	...
	if (func_299() && MISC::GET_GAME_TIMER() > iLocal_412)
	{
		...
		{
			if (func_32(bLocal_273) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false) || func_197(PLAYER::PLAYER_PED_ID(), bLocal_273, 15f, 1)))
			{
				iLocal_380 = 4;
			}
		}
	...
	switch (iLocal_417)
	{
		case 0:
			...
			break;
		case 1:
			if (func_32(bLocal_273) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false))
			{
				bVar0 = true;
			}
			else
			...
			if (func_32(bLocal_290))
			{
				if (func_197(PLAYER::PLAYER_PED_ID(), bLocal_290, 25f, 1))
				{
				...
				{
					if (!func_197(PLAYER::PLAYER_PED_ID(), bLocal_290, (80f * 0.75f), 1))
					{
						if (!bLocal_414)
						{
							iLocal_417 = 8;
				...
				else if ((!bLocal_414 && !func_197(PLAYER::PLAYER_PED_ID(), bLocal_290, (80f * 0.5f), 1)) && func_197(PLAYER::PLAYER_PED_ID(), bLocal_289, 15f, 1))
				{
					iLocal_417 = 8;
				}
			}
		...
		case 10:
			...
			else if (bLocal_375 && func_32(bLocal_290))
			{
				...
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_290, PLAYER::PLAYER_PED_ID(), true))
				{
					if (func_297() == 4)
					{
						func_60();
					}
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(bLocal_290);
				}
			}
			else if (bLocal_376 && func_32(bLocal_273))
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, true) && !func_197(PLAYER::PLAYER_PED_ID(), bLocal_290, 25f, 1))
				{
					func_195();
				}
			}
...
int func_301()
{
	if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false) && PED::IS_PED_IN_VEHICLE(bLocal_289, bLocal_273, false))
	{
		return 1;
	}
	else if (bLocal_336)
	{
		if (func_197(PLAYER::PLAYER_PED_ID(), bLocal_289, 10f, 1))
		{
			return 1;
		}
		else if (func_62(bLocal_289, ENTITY::GET_ENTITY_COORDS(bLocal_290, false), 10f))
		{
			return 1;
		}
		else if (func_302(bLocal_289, PLAYER::PLAYER_PED_ID(), 1126825984 /* Float: 170f */, 1, 250, 7))
		{
			return 1;
		}
...
bool func_306(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_308(ENTITY::GET_ENTITY_COORDS(bParam1, true) - ENTITY::GET_ENTITY_COORDS(bParam0, true)) };
	...
	{
		vVar3 = { func_308(PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_312()
{
	func_302(bLocal_289, PLAYER::PLAYER_PED_ID(), 1126825984 /* Float: 170f */, 1, 250, 7);
	func_302(bLocal_289, bLocal_290, 1126825984 /* Float: 170f */, 1, 250, 7);
}

void func_313(var uParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6)
{
	func_314(uParam0, bParam1, iParam2, iParam3, sParam4, iParam5, bParam6);
}

void func_314(var uParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6)
{
	func_315(uParam0, bParam1, 0f, 0f, 0f, iParam2, iParam3, sParam4, iParam5, bParam6);
}

void func_315(var uParam0, bool bParam1, vector3 vParam2, int iParam5, int iParam6, char* sParam7, int iParam8, bool bParam9)
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
	{
	...
	uParam0->f_6 = 2;
	func_316(uParam0, bParam1, vParam2, iParam5, iParam6, sParam7, iParam8, bParam9);
}

void func_316(var uParam0, bool bParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	char* sVar0;
	bool bVar1;
...
bool func_324(int iParam0, bool bParam1, bool bParam2)
{
	int iVar0;
...
void func_343()
{
	...
	vVar0 = { ENTITY::GET_ENTITY_COORDS(bLocal_290, true) };
...
void func_344()
{
	switch (iLocal_93)
	{
		case 0:
			...
			{
				func_313(&uLocal_261, bLocal_290, 0, 0, 1, 1, 1);
				if (!func_197(PLAYER::PLAYER_PED_ID(), bLocal_290, 220f, 1))
				{
					func_33(&iLocal_297);
				...
				else
				{
					...
					if (!bLocal_333)
					{
						bLocal_333 = true;
						TASK::CLEAR_PED_TASKS(bLocal_290);
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(bLocal_290, Local_277, PLAYER::PLAYER_PED_ID(), 8, 25f, 786477, 100f, 1f, true);
					}
					iLocal_603 = MISC::GET_GAME_TIMER();
		...
		case 1:
			if (func_32(bLocal_290))
			{
				...
				else if (!PED::IS_PED_IN_ANY_VEHICLE(bLocal_290, false))
				{
					iLocal_93 = 0;
					iLocal_92 = 6;
				}
				else if (!func_197(PLAYER::PLAYER_PED_ID(), bLocal_290, 220f, 1))
				{
					func_33(&iLocal_297);
					sLocal_573 = "MET1ESCAPE";
					iLocal_92 = 11;
				...
				if ((HUD::DOES_BLIP_EXIST(iLocal_297) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false)) && PED::IS_PED_IN_VEHICLE(bLocal_289, bLocal_273, false))
				{
					func_359(iLocal_297, bLocal_290, 220f, 0.75f, 0);
				}
				func_313(&uLocal_261, bLocal_290, 0, 0, 1, 1, 1);
...
void func_345()
{
	...
	if ((((iLocal_379 > 0 && iLocal_379 < 250) && (iLocal_380 == 0 || iLocal_380 == 1)) && ENTITY::GET_ENTITY_SPEED(bLocal_273) < 1.5f) && ENTITY::GET_ENTITY_SPEED(Local_277) > 3f)
	{
		iLocal_380 = 8;
	}
	if (func_347())
	...
	{
		case 0:
			if ((((MISC::GET_GAME_TIMER() - iLocal_374) > 4000 && func_32(bLocal_290)) && !func_192()) && !func_29())
			{
				func_27(&uLocal_96, 4, bLocal_290, "Stalker", 0, 1);
				iLocal_380 = 1;
			}
		...
		case 1:
			if (func_32(bLocal_290))
			{
				if (!func_197(PLAYER::PLAYER_PED_ID(), bLocal_290, (220f * 0.75f), 1))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(bLocal_290, false))
					{
						iLocal_380 = 8;
				...
				else if (func_197(PLAYER::PLAYER_PED_ID(), bLocal_290, 50f, 1))
				{
...
bool func_347()
{
	if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(bLocal_273))
	{
		if (func_32(Local_277) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(bLocal_273, Local_277))
		{
			return false;
		}
		return true;
...
void func_348()
{
	if ((MISC::GET_GAME_TIMER() - iLocal_330) > 3000)
	{
		...
		vLocal_320[2 /*3*/] = { ENTITY::GET_ENTITY_COORDS(bLocal_273, true) };
		iLocal_330 = MISC::GET_GAME_TIMER();
	}
}
...
bool func_353()
{
	if (func_62(bLocal_273, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277, 0f, 3.2f, 0.5f), 3f) || func_62(bLocal_273, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277, 0f, -3.2f, 0.5f), 3f))
	{
		return true;
	}
	return false;
...
void func_354()
{
	...
	if (iLocal_617 == 1)
	{
		...
		{
			PED::SET_IK_TARGET(bLocal_290, 1, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 0, 300, 300);
		}
		else
		{
			iLocal_613 = MISC::GET_GAME_TIMER();
	...
	if (iLocal_617 == 2)
	{
		...
		{
			PED::SET_IK_TARGET(bLocal_290, 1, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 0, 150, 400);
		}
		else
		{
			iLocal_613 = MISC::GET_GAME_TIMER();
...
bool func_358(bool bParam0, bool bParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		vVar1 = { func_308(ENTITY::GET_ENTITY_COORDS(iVar0, true) - ENTITY::GET_ENTITY_COORDS(bParam0, true)) };
		vVar4 = { ENTITY::GET_ENTITY_VELOCITY(bParam0) - ENTITY::GET_ENTITY_VELOCITY(iVar0) };
		...
		case 0:
			if (!func_366())
			{
				...
				if (func_362(Local_277.f_6, Local_277.f_9, 0))
				{
					...
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_277, ENTITY::GET_ENTITY_COORDS(bLocal_273, true), 4, 35f, 2883621, 10f, 12f, true);
					TASK::TASK_VEHICLE_ESCORT(0, Local_277, bLocal_273, -1, 25f, 2883621, -1f, 20, 20f);
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
					TASK::TASK_PERFORM_SEQUENCE(bLocal_290, iVar0);
					TASK::CLEAR_SEQUENCE_TASK(&iVar0);
			...
			if (func_32(bLocal_290))
			{
				if (func_32(Local_277))
				{
					if (!bLocal_335)
					{
						...
						{
							TASK::TASK_PLAY_ANIM(bLocal_289, "missmichael_event@tracy", "base", 8f, -8f, -1, 0, 0f, false, false, false);
					...
					else
					{
						...
						if (!bLocal_332)
						{
							if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_277, PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_290, PLAYER::PLAYER_PED_ID(), true))
							{
								ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(bLocal_290);
								ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_277);
								bLocal_332 = true;
							}
							else if (func_197(PLAYER::PLAYER_PED_ID(), bLocal_290, 15f, 1))
							{
								bLocal_332 = true;
							}
						}
...
bool func_362(vector3 vParam0, float fParam3, bool bParam4)
{
	...
	else if (bLocal_292)
	{
		if (STREAMING::HAS_MODEL_LOADED(iLocal_291) && STREAMING::HAS_MODEL_LOADED(Local_277.f_1))
		{
			...
			bLocal_317 = true;
			bLocal_290 = PED::CREATE_PED_INSIDE_VEHICLE(Local_277, 26, iLocal_291, -1, true, true);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_290, 9, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_290, 8, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_290, 0, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_290, 2, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_290, 3, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(bLocal_290, 4, 1, 0, 0);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_291);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_290, true);
			PED::SET_PED_KEEP_TASK(bLocal_290, true);
			func_27(&uLocal_96, 4, bLocal_290, "Stalker", 0, 1);
			PED::SET_PED_CONFIG_FLAG(bLocal_290, 281, true);
			bLocal_292 = false;
...
void func_367()
{
	...
	switch (iLocal_93)
	{
		case 0:
			if (func_32(bLocal_273))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, true))
				{
					bLocal_305 = false;
				}
				else
				...
				if (PED::IS_PED_IN_VEHICLE(bLocal_289, bLocal_273, true))
				{
					bLocal_306 = false;
				}
				else
		...
		case 1:
			if (!func_366())
			{
				...
				if (bLocal_305)
				{
					...
					{
						TASK::CLEAR_PED_TASKS(bLocal_289);
						TASK::TASK_SMART_FLEE_PED(bLocal_289, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
						if (func_29())
						{
							if (func_297() == 3)
							{
...
void func_368()
{
	if (((!func_29() && !func_194()) && PED::IS_PED_IN_VEHICLE(bLocal_289, bLocal_273, false)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false))
	{
...
void func_369()
{
	...
	Var27.f_1 = 3;
	Var27.f_1.f_4 = 3;
	vVar3[0 /*3*/] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(bLocal_273, -8f, 2f, 0f) };
	vVar3[1 /*3*/] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(bLocal_273, -8f, 8f, 0f) };
	vVar3[2 /*3*/] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(bLocal_273, 8f, 2f, 0f) };
	vVar3[3 /*3*/] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(bLocal_273, 8f, 8f, 0f) };
	...
	TASK::TASK_PERFORM_SEQUENCE(bLocal_289, uVar0[0]);
...
bool func_370(bool bParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_32(PLAYER::PLAYER_PED_ID()) && func_32(bParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_374(PLAYER::PLAYER_PED_ID(), bParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
{
	return func_302(bParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
bool func_374(int iParam0, bool bParam1, float fParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_376(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	...
	if (bParam2)
	{
		if (((MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(bParam0, true), joaat("WEAPON_GRENADE"), fParam1, true) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(bParam0, true), joaat("WEAPON_MOLOTOV"), fParam1, true)) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(bParam0, true), joaat("WEAPON_SMOKEGRENADE"), fParam1, true)) || MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(ENTITY::GET_ENTITY_COORDS(bParam0, true), joaat("WEAPON_STICKYBOMB"), 5f, true))
		{
			if (bParam3)
			{
...
bool func_377(bool bParam0, float fParam1)
{
	var uVar0;
	vector3 vVar1;
...
bool func_378(bool bParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_308(vParam1 - ENTITY::GET_ENTITY_COORDS(bParam0, true)) };
...
bool func_379(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (!func_366())
			{
				if (!func_2())
				{
					if (((func_393(&bLocal_289, vLocal_483, fLocal_486, 1) && func_383(&bLocal_273, 15, vLocal_479, fLocal_482, 1, 0)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_296)) && func_32(bLocal_273))
					{
						bLocal_293 = true;
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_289, true);
						func_28(&uLocal_96, 3);
						func_27(&uLocal_96, 3, bLocal_289, "TRACEY", 0, 1);
						PED::SET_PED_CONFIG_FLAG(bLocal_289, 32, false);
						PED::SET_PED_CONFIG_FLAG(bLocal_289, 26, true);
						func_382();
						TASK::TASK_PLAY_ANIM(bLocal_289, sLocal_296, "nervous_loop", 8f, -8f, -1, 1, 0f, false, false, false);
						PED::SET_PED_KEEP_TASK(bLocal_289, true);
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(bLocal_273, true, 1);
						VEHICLE::SET_VEHICLE_STRONG(bLocal_273, true);
						VEHICLE::LOWER_CONVERTIBLE_ROOF(bLocal_273, true);
						VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(bLocal_273);
						VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(bLocal_273, true);
		...
		case 1:
			...
			if (!func_2())
			{
				if (!func_366())
				{
					switch (iLocal_304)
					{
						case 0:
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 246.1479f, -39.21085f, 67.89664f, 202.6635f, -23.77725f, 72.90416f, 22f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 233.7891f, -45.51515f, 67.57388f, 229.9916f, -55.96275f, 72.28979f, 12.5f, false, true, 0))
							{
								...
								TASK::TASK_ENTER_VEHICLE(0, bLocal_273, 60000, 0, 2f, 1, 0);
								TASK::CLOSE_SEQUENCE_TASK(iVar0);
								TASK::CLEAR_PED_TASKS(bLocal_289);
								TASK::TASK_LOOK_AT_ENTITY(bLocal_289, PLAYER::PLAYER_PED_ID(), 4000, 0, 3);
								TASK::TASK_PERFORM_SEQUENCE(bLocal_289, iVar0);
								TASK::CLEAR_SEQUENCE_TASK(&iVar0);
							...
							break;
						case 1:
							if (func_3(&uLocal_96, "MET1AUD", "MET1_SEES", 7, 1, 0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false))
							{
							...
							TASK::TASK_LOOK_AT_ENTITY(bLocal_289, PLAYER::PLAYER_PED_ID(), 2000, 2048, 4);
							break;
						case 2:
					...
					if (iLocal_304 != 0)
					{
						if (!func_197(PLAYER::PLAYER_PED_ID(), bLocal_289, 100f, 1))
						{
							sLocal_573 = "MET1ABANDON";
							iLocal_92 = 11;
							iLocal_93 = 0;
						}
						else if (!func_197(PLAYER::PLAYER_PED_ID(), bLocal_289, 50f, 1))
						{
							func_34(6);
						}
					}
...
void func_381()
{
	...
	{
		case 0:
			if ((MISC::GET_GAME_TIMER() - iLocal_369) > 5000 && func_197(bLocal_289, PLAYER::PLAYER_PED_ID(), 25f, 1))
			{
				iLocal_371 = 9;
			}
			break;
...
void func_382()
{
	...
	if (PED::IS_PED_IN_GROUP(bLocal_289))
	{
		PED::REMOVE_PED_FROM_GROUP(bLocal_289);
	}
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_289, iLocal_295);
}

bool func_383(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	struct<98> Var0;
	int iVar98;
	int iVar99;
	...
	if (!func_17(iParam1))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(*bParam0))
		{
			if (ENTITY::GET_ENTITY_MODEL(*bParam0) != Var0)
			{
			}
			return true;
		}
		if ((iParam1 == 17 && Global_111638.f_2358.f_539.f_3618[0 /*197*/][0 /*98*/] == Var0) || (iParam1 == 15 && Global_111638.f_2358.f_539.f_3618[0 /*197*/][1 /*98*/] == Var0))
		{
			...
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/], vParam2, fParam5, false, false, false);
				...
				Var0.f_3 = 1250;
				VEHICLE::SET_VEHICLE_COLOURS(*bParam0, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_5, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_6);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(*bParam0, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_7, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_8);
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(*bParam0, Var0.f_2);
				iVar99 = 0;
				while (iVar99 < 12)
				{
					VEHICLE::SET_VEHICLE_EXTRA(*bParam0, iVar99 + 1, !Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_11[iVar99]);
					iVar99++;
				}
				...
				VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(*bParam0, &(Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_27));
				...
				{
					VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(*bParam0, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_26);
				}
				VEHICLE::SET_VEHICLE_TYRE_SMOKE_COLOR(*bParam0, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_84, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_85, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_86);
				VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(*bParam0, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_88);
				VEHICLE::SET_VEHICLE_WINDOW_TINT(*bParam0, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_87);
				VEHICLE::_SET_VEHICLE_NEON_LIGHTS_COLOUR(*bParam0, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_93, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_94, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_95);
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*bParam0, 2, MISC::IS_BIT_SET(Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 28));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*bParam0, 3, MISC::IS_BIT_SET(Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 29));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*bParam0, 0, MISC::IS_BIT_SET(Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 30));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*bParam0, 1, MISC::IS_BIT_SET(Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 31));
				if (VEHICLE::GET_VEHICLE_LIVERY_COUNT(*bParam0) > 1 && Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_89 >= 0)
				{
					VEHICLE::SET_VEHICLE_LIVERY(*bParam0, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_89);
				}
				if (Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_90 > -1)
				{
					if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(*bParam0)))
					{
						if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(*bParam0)))
						{
							...
							{
								VEHICLE::SET_VEHICLE_WHEEL_TYPE(*bParam0, Global_111638.f_2358.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_90);
							}
						}
						else
						{
		...
		else
		{
			...
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Var0, vParam2, fParam5, false, false, false);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(*bParam0, 5f);
				VEHICLE::_0xAB04325045427AAE(*bParam0, false);
				VEHICLE::SET_VEHICLE_CAN_SAVE_IN_GARAGE(*bParam0, false);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(*bParam0, true);
...
void func_384(bool bParam0, struct<98> Param1)
{
	...
	if (Param1.f_9)
	{
		VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*bParam0, Param1.f_4);
	}
	else
	{
		VEHICLE::SET_VEHICLE_COLOURS(*bParam0, Param1.f_5, Param1.f_6);
	}
	if (Param1.f_10)
	{
		VEHICLE::SET_VEHICLE_EXTRA_COLOURS(*bParam0, Param1.f_7, Param1.f_8);
	}
	VEHICLE::SET_VEHICLE_DIRT_LEVEL(*bParam0, Param1.f_2);
	ENTITY::SET_ENTITY_HEALTH(*bParam0, Param1.f_3, 0);
	iVar0 = 0;
	while (iVar0 < 12)
	{
		VEHICLE::SET_VEHICLE_EXTRA(*bParam0, iVar0 + 1, !Param1.f_11[iVar0]);
		iVar0++;
	}
	if (Param1.f_24)
	{
	...
	{
		VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(*bParam0, &uVar2);
		VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(*bParam0, iVar1);
	}
	else if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Param1.f_27)))
	{
		VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(*bParam0, &(Param1.f_27));
		if (Param1.f_26 >= 0 && Param1.f_26 < VEHICLE::GET_NUMBER_OF_VEHICLE_NUMBER_PLATES())
		{
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(*bParam0, Param1.f_26);
		}
	}
	VEHICLE::SET_VEHICLE_TYRE_SMOKE_COLOR(*bParam0, Param1.f_84, Param1.f_85, Param1.f_86);
	VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(*bParam0, Param1.f_88);
	VEHICLE::SET_VEHICLE_WINDOW_TINT(*bParam0, Param1.f_87);
	VEHICLE::_SET_VEHICLE_NEON_LIGHTS_COLOUR(*bParam0, Param1.f_93, Param1.f_94, Param1.f_95);
	VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*bParam0, 2, MISC::IS_BIT_SET(Param1.f_92, 28));
	VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*bParam0, 3, MISC::IS_BIT_SET(Param1.f_92, 29));
	VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*bParam0, 0, MISC::IS_BIT_SET(Param1.f_92, 30));
	VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*bParam0, 1, MISC::IS_BIT_SET(Param1.f_92, 31));
	if (VEHICLE::GET_VEHICLE_LIVERY_COUNT(*bParam0) > 1 && Param1.f_89 >= 0)
	{
		VEHICLE::SET_VEHICLE_LIVERY(*bParam0, Param1.f_89);
	}
	if (Param1.f_90 > -1)
	{
		if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(*bParam0)))
		{
			if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(*bParam0)))
			{
				if (Param1.f_90 == 6)
				{
					VEHICLE::SET_VEHICLE_WHEEL_TYPE(*bParam0, Param1.f_90);
				}
			}
			else
			{
	...
	VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Param1.f_96);
}
...
int func_387(bool bParam0, var uParam1, var uParam2)
{
	...
	if (func_391(ENTITY::GET_ENTITY_MODEL(*bParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*bParam0, 24) != func_390(*bParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*bParam0, 24, func_390(*bParam0, ((*uParam1)[38] - 1)), false);
	}
	func_389(bParam0);
	if (func_388(*bParam0))
	{
...
bool func_393(bool bParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
	...
	{
		func_39(bParam0);
		*bParam0 = PED::CREATE_PED(26, iVar0, vParam1, fParam4, false, false);
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(bParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false)) || func_223(bParam0, 0, 0)) || func_223(bParam0, 1, 0)) || func_223(bParam0, 2, 0)) || func_213(bParam0) != 145) || func_416(bParam0)) || func_415(bParam0)) || func_414(bParam0)) || func_413(bParam0)) || !func_403(ENTITY::GET_ENTITY_MODEL(bParam0)))
	{
		if (func_415(bParam0))
		{
		}
...
bool func_431()
{
	...
	else if (bLocal_293)
	{
		...
		{
			PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(bLocal_289, false);
		}
	}
	return false;
}
...
bool func_432()
{
	if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(bLocal_273))
	{
		if (bLocal_275)
		{
...
bool func_433()
{
	...
	if (!VEHICLE::IS_VEHICLE_DRIVEABLE(bLocal_273, false))
	{
		return true;
	}
	return false;
...
void func_446(bool bParam0, bool bParam1)
{
	...
	else if ((((iLocal_92 == 3 || iLocal_92 == 4) || iLocal_92 == 5) && func_32(bLocal_273)) && func_32(bLocal_289))
	{
		if (func_32(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false))
			{
				func_459(PLAYER::PLAYER_PED_ID(), bLocal_273, -1);
				vLocal_618 = { ENTITY::GET_ENTITY_COORDS(bLocal_273, true) };
			}
		}
	}
	else
...
void func_460(vector3 vParam0, float fParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		...
		{
			PED::SET_PED_INTO_VEHICLE(bLocal_289, bLocal_273, 0);
		}
	}
	else
	{
	...
	if (func_32(bLocal_273))
	{
		VEHICLE::LOWER_CONVERTIBLE_ROOF(bLocal_273, true);
		VEHICLE::SET_VEHICLE_STRONG(bLocal_273, true);
		VEHICLE::SET_VEHICLE_ENGINE_ON(bLocal_273, true, true, false);
		VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(bLocal_273);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(bLocal_273, true);
		func_363(bLocal_273, 1);
		bLocal_274 = true;
...
void func_461()
{
	...
	if (bLocal_274)
	{
		VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(bLocal_273);
		bLocal_274 = false;
	}
	func_37(&bLocal_273);
}
...
void func_466(bool bParam0)
{
	...
	else
	{
		...
		if (func_32(bLocal_273))
		{
			MISC::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(bLocal_273, 0f, -8f, 0f), 6f, false, false, false, false, false, false);
		}
	}
...
void func_467(bool bParam0)
{
	...
	if (func_32(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if ((func_32(bLocal_273) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_273, false)) || (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false)))
			{
				MISC::CLEAR_AREA(181.2331f, -33.9939f, 67.2522f, 3f, true, false, false, false);
			...
			{
				MISC::CLEAR_AREA_OF_VEHICLES(99.6208f, -21.0027f, 67.0114f, 7f, false, false, false, false, false, false);
				bLocal_623 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
				ENTITY::SET_ENTITY_COORDS(bLocal_623, 99.6208f, -21.0027f, 67.0114f, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(bLocal_623, 251.1f);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_623, 5f);
				vLocal_618 = { 99.6208f, -21.0027f, 67.0114f };
				bLocal_622 = true;
			}
		}
	...
	if (bLocal_622)
	{
		...
		{
			VEHICLE::SET_VEHICLE_ENGINE_ON(bLocal_623, true, true, false);
			VEHICLE::SET_VEHICLE_FORWARD_SPEED(bLocal_623, 10f);
		}
		SYSTEM::WAIT(0);
	}
}
...
bool func_469(vector3 vParam0, float fParam3)
{
	return func_470(&(Global_105187.f_2890), vParam0, fParam3, 0);
}

bool func_470(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	bool bVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_493(uParam0))
	{
		...
		if (func_492(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0))
			{
				...
				else if ((!func_475(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
bool func_475(bool bParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_477(bParam0, uVar1[iVar6], 1) && func_476(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_241(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(bParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&bParam0);
						return true;
					}
...
bool func_477(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_480(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_483(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_482())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
void func_502(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (func_541() && func_538(iParam1, iParam2, iParam3, 1))
	{
		vVar0 = { 0f, 0f, 0f };
		fVar3 = 0f;
		func_503(bParam0, vVar0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
void func_503(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_469(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_241(vParam1, 0f, 0f, 0f, 0))
		...
		{
			func_479(iParam12, 0);
			while (!func_504(bParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
		else
		{
			...
			*bParam0 = VEHICLE::CREATE_VEHICLE(iParam10, vParam1, fParam4, true, true, false);
			if (ENTITY::DOES_ENTITY_EXIST(*bParam0) && !ENTITY::IS_ENTITY_DEAD(*bParam0, false))
			{
				...
				{
					VEHICLE::SET_VEHICLE_COLOURS(*bParam0, iParam11, iParam11);
				}
			}
	...
	if (iParam5 == 1)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(*bParam0) && !ENTITY::IS_ENTITY_DEAD(*bParam0, false)) && ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), *bParam0, -1);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(*bParam0, 5f);
		}
	}
}

bool func_504(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_387(bParam0, &(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = VEHICLE::CREATE_VEHICLE(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_387(bParam0, &(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*bParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*bParam0) == joaat("BODHI2"))
...
void func_505(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if ((func_17(iParam0) && ENTITY::DOES_ENTITY_EXIST(*bParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*bParam1, false))
	{
		...
		{
			func_219(bParam1, &(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111638.f_20113[iParam0 /*43*/].f_31 = func_508(*bParam1);
...
bool func_509(bool bParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if (!STREAMING::IS_MODEL_A_VEHICLE(ENTITY::GET_ENTITY_MODEL(bParam0)))
	{
		return false;
	}
	iVar0 = ENTITY::GET_ENTITY_MODEL(bParam0);
	if ((!func_534(iVar0, bParam1, uParam2) && !func_533(PLAYER::PLAYER_ID())) && !func_517(bParam0))
	{
		return false;
	}
	...
	if (((VEHICLE::IS_BIG_VEHICLE(bParam0) && !func_513(bParam0)) && !bVar1) && !(func_512(ENTITY::GET_ENTITY_MODEL(bParam0)) && func_510(PLAYER::PLAYER_ID())))
	{
		switch (ENTITY::GET_ENTITY_MODEL(bParam0))
		{
			case joaat("CERBERUS"):
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_414(bParam0) && ENTITY::GET_ENTITY_MODEL(bParam0) != joaat("SENTINEL2")) && ENTITY::GET_ENTITY_MODEL(bParam0) != joaat("ISSI2"))
		{
			*uParam2 = 2;
			return false;
		}
...
bool func_534(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
void func_557(bool bParam0, bool bParam1)
{
	...
	{
		VEHICLE::REMOVE_VEHICLE_STUCK_CHECK(bLocal_273);
		bLocal_274 = false;
	}
	if (bParam0)
	{
	...
	else
	{
		if (!bParam1)
		{
			...
			{
				if (!ENTITY::IS_ENTITY_DEAD(bLocal_289, false))
				{
					TASK::CLEAR_PED_TASKS(bLocal_289);

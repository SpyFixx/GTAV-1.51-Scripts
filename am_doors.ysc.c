...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (NETWORK::NETWORK_IS_TUTORIAL_SESSION_CHANGE_PENDING(PLAYER::PLAYER_ID()) == 32)
			{
			...
			else if (ScriptParam_0.f_16 != NETWORK::NETWORK_IS_TUTORIAL_SESSION_CHANGE_PENDING(PLAYER::PLAYER_ID()))
			{
				func_35(2);
			}
		}

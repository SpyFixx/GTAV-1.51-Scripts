	...
	switch (iLocal_84)
	{
		...
		case 1:
			if (func_245(1, 1093140480 /* Float: 10.5f */, 0))
			{
				...
				{
					UNK_0x29E8331978B73E7F(Local_86.f_28[0], bLocal_85, 0, false, 0);
				}
...
void func_202(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	bool bVar1;
	char cVar2[64];
...
void func_217(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_223(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
void func_233(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, int iParam15, int iParam16, var uParam17, bool bParam18)
{
	func_234(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, iParam15, iParam16, uParam17, bParam18);
}

void func_234(vector3 vParam0, vector3 vParam3, bool bParam6, vector3 vParam7, bool bParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (UNK_0xC844350D5D58C99A(bVar0))
	{
		...
		if (UNK_0xDF1306B443CD3D15(bVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_238(bVar0, vParam0, vParam3, bParam6))
					{
						bVar1 = true;
					}
				}
...
bool func_237(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
bool func_238(bool bParam0, vector3 vParam1, vector3 vParam4, bool bParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool func_245(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (UNK_0x405E212DDE472467(UNK_0x16F2683693E537C9(), 0))
	{
		...
		{
			if (!func_252(UNK_0x6937EA2286828455(UNK_0x16F2683693E537C9(), 0), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_252(bool bParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
		...
		case 1:
			if (func_272(UNK_0x16F2683693E537C9(), Local_86.f_28[0], 1) >= 4.5f)
			{
				if (!UNK_0x8C74DE122769E1BF())
				{
					if (func_271())
					{
						UNK_0xC0B0B9E466C0ED17(Local_86.f_28[0], 0f, 0f, 0.5f, 1, 30000, 2000, 2000, false);
					}
					else
					{
						UNK_0xC0B0B9E466C0ED17(Local_86.f_28[0], -1f, 0f, 0f, 0, 30000, 2000, 2000, false);
					}
				...
				if (func_244(Local_86.f_28[0]))
				{
					if (UNK_0xB4ECF989E2C1DAC8(Local_86.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 3))
					{
						if (UNK_0x8CA9406E01C7EE58(Local_86.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall") < 0.1f)
						{
							...
							UNK_0xC6EB89C59F2AF6B8(Local_86.f_28[0], "rcmepsilonism5", "leadin_action", 8f, -8f, -1, 2, false, 0, 0, 0);
							iLocal_84 = 2;
						}
					}
				}
...
int func_256(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_274()
{
	if (UNK_0xE1DBBD6CE209517C(UNK_0xD803B885F5E47A62()))
	{
		if (UNK_0x405E212DDE472467(UNK_0x16F2683693E537C9(), 0))
		{
			if (func_252(UNK_0x6937EA2286828455(UNK_0x16F2683693E537C9(), 0), 10.5f, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
...
bool func_292(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
		...
		case 2:
			...
			if (!UNK_0xC844350D5D58C99A(uParam0->f_28[0]))
			{
				if (func_305(&(uParam0->f_28[0]), 60, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && func_216(UNK_0x16F2683693E537C9()))
				{
					...
					UNK_0x6DF7BF67E86AAE86(uParam0->f_28[0], bVar4);
...
bool func_305(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	if (func_306(bParam0, iParam1, vParam2, fParam5, 1))
	{
		if (UNK_0xC844350D5D58C99A(*bParam0))
		{
			if (!UNK_0x437347B10A200C4B(*bParam0, 0))
...
bool func_306(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6)
{
	bool bVar0;
...
bool func_330(char* sParam0, int iParam1, int iParam2)
{
	bool bVar0;
	struct<32> Var1;
	int iVar33;

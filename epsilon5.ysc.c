...
bool func_31(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_147(iParam0, iParam1, bParam2))
	{
		return false;
	}
	if (iParam1 == 12)
...
int func_34(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		if (iParam7 == 1)
		{
			...
			{
				bVar5 = func_63(iParam0, 8);
				if (bVar5 != 9)
				{
					bVar5 = -99;
				}
			}
			bVar6 = func_63(iParam0, 9);
			...
			bVar7 = func_62(iParam0, 1);
			if (!func_61(iVar10, 14, bVar7, -1))
			{
				bVar7 = -99;
			}
			bVar8 = func_62(iParam0, 0);
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (iParam1 == 12)
		{
			...
			while (bVar0 <= 53)
			{
				if (func_147(iParam0, iParam1, bVar0))
				{
					return bVar0;
				}
				bVar0++;
		...
		else if (iParam1 == 13)
		{
			...
			while (bVar1 <= 19)
			{
				if (func_147(iParam0, iParam1, bVar1))
				{
					return bVar1;
				}
				bVar1++;
...
int func_42(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	bool bVar2;
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								bVar5 = bParam3;
								bVar4 = func_63(iParam0, 3);
							}
							else if (iParam2 == 3)
							{
								bVar4 = bParam3;
								bVar5 = func_63(iParam0, 11);
...
bool func_73(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
void func_233(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, float fParam14, int iParam15, int iParam16, var uParam17, float fParam18)
{
	func_234(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, fParam14, iParam15, iParam16, uParam17, fParam18);
}
...
bool func_238(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool func_252(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
		...
		case 1:
			if (func_272(PLAYER::PLAYER_PED_ID(), Local_86.f_28[0], 1) >= 4.5f)
			{
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (func_271())
					{
						CAM::SET_GAMEPLAY_ENTITY_HINT(Local_86.f_28[0], 0f, 0f, 0.5f, true, 30000, 2000, 2000, false);
					}
					else
					{
						CAM::SET_GAMEPLAY_ENTITY_HINT(Local_86.f_28[0], -1f, 0f, 0f, false, 30000, 2000, 2000, false);
					}
...
bool func_305(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
...
bool func_306(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;

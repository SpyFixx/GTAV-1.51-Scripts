			...
			switch (iLocal_48)
			{
				...
				case 1:
					...
					if (!bLocal_114)
					{
						...
						func_122();
						func_111();
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_318))
						{
							func_110();
						}
					}
...
void func_122()
{
				...
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_66(1, 0, 1))
					{
						if (!bLocal_311)
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_55))
							{
								fLocal_318 = PED::CREATE_SYNCHRONIZED_SCENE(-935.57f, 2767.616f, 24.448f, 2.433f, 0.152f, 53.743f, 2);
								iLocal_134 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
								PED::SET_SYNCHRONIZED_SCENE_PHASE(fLocal_318, 0.158f);
								CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_134, fLocal_318, "untie_cam", "re@stag_do@");
								TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
								TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_55);
								TASK::TASK_SYNCHRONIZED_SCENE(iLocal_55, fLocal_318, "re@stag_do@", "untie_ped", 1000f, -1000f, 4, 0, 1000f, 0);
								PED::_0x2208438012482A1A(iLocal_55, false, false);
								TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_318, "re@stag_do@", "untie_player", 1000f, -1000f, 0, 0, 1000f, 0);
	...
	if (bLocal_311 && !bLocal_312)
	{
		if (!bLocal_316)
		{
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_318) > 0.2f && PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_318) < 0.3f)
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "ROPE_CUT", PLAYER::PLAYER_PED_ID(), "ROPE_CUT_SOUNDSET", false, 0);
				bLocal_316 = true;
			}
		}
		if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_318) > 0.4647059f && !bLocal_317)
		{
...
bool func_153(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;

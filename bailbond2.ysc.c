	...
	if (func_23(Local_385))
	{
		if (func_433(Local_393))
		{
			if (func_58(2))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(Local_385, fVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1000f, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_393, fVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1000f);
...
bool func_410(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)
{
	if (func_433(iParam0))
	{
		if (!func_363(iParam1, 10))
...
bool func_424(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_425(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_427(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
bool func_428(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_447(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_494(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_174(vParam1, 0f, 0f, 0f, 0))
		...
		{
			func_489(iParam12, 0);
			while (!func_448(bParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
bool func_448(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
bool func_453(bool bParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(bParam0);
	if ((!func_479(iVar0, bParam1, uParam2) && !func_478(PLAYER::PLAYER_ID())) && !func_461(bParam0))
	{
		return false;
	}
	...
	if (((VEHICLE::IS_BIG_VEHICLE(bParam0) && !func_457(bParam0)) && !bVar1) && !(func_456(ENTITY::GET_ENTITY_MODEL(bParam0)) && func_454(PLAYER::PLAYER_ID())))
	{
...
bool func_479(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
int func_484(bool bParam0, var uParam1, var uParam2)
{
	...
	if (func_475(ENTITY::GET_ENTITY_MODEL(*bParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*bParam0, 24) != func_487(*bParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*bParam0, 24, func_487(*bParam0, ((*uParam1)[38] - 1)), false);
	}
	func_486(bParam0);
	if (func_485(*bParam0))
	{
...
bool func_494(vector3 vParam0, float fParam3)
{
	return func_495(&(Global_105187.f_2890), vParam0, fParam3, 0);
}

bool func_495(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	bool bVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_512(uParam0))
	{
		...
		if (func_511(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0))
			{
				...
				else if ((!func_497(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
bool func_497(bool bParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_499(bParam0, uVar1[iVar6], 1) && func_498(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
bool func_499(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_500(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_503(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_502())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
bool func_526(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, bool bParam7)
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
bool func_527(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{

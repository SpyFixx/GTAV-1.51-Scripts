...
bool func_1()
{
	...
	if ((SYSTEM::VDIST2(vVar0, vVar3) > 10000f || UNK_0x437347B10A200C4B(bLocal_38, 0)) || func_27())
	{
		return true;
	}
	switch (iLocal_40)
		...
		case 0:
			if (UNK_0xC844350D5D58C99A(bLocal_38) && !UNK_0x437347B10A200C4B(bLocal_38, 0))
			{
				if (UNK_0x5A91F08DF773C39D(bLocal_38, vLocal_57, 1f, 1f, 1f, false, true, 0))
				{
					...
					UNK_0x78ADC381772E3D54(bLocal_38, iVar7);
					UNK_0xF82EA857DA10E0CD(&iVar7);
					iLocal_40 = 1;
				}
			}
			...
			if (UNK_0xC844350D5D58C99A(bLocal_38) && !UNK_0x437347B10A200C4B(bLocal_38, 0))
			{
				if (UNK_0x4F1B602325013CC2(bLocal_38) == 1)
				{
					if (!UNK_0xC844350D5D58C99A(bLocal_39))
					{
						...
						{
							fVar8 = UNK_0x8CA9406E01C7EE58(bLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar8 >= 0.157f)
							{
				...
				{
					iVar6 = (UNK_0x09AC81E49EA267F7(false, 65535) % 2);
					if (iVar6 == 0)
					{

...
void func_248(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_324(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_315(iParam12, 0);
			while (!func_249(bParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
bool func_249(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
bool func_283(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(bParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false)) || func_304(bParam0, 0, 0)) || func_304(bParam0, 1, 0)) || func_304(bParam0, 2, 0)) || func_303(bParam0) != 145) || func_302(bParam0)) || func_301(bParam0)) || func_256(bParam0)) || func_300(bParam0)) || !func_290(ENTITY::GET_ENTITY_MODEL(bParam0)))
	{
		if (func_301(bParam0))
		{
		}
...
int func_309(bool bParam0, var uParam1, var uParam2)
{
	...
	if (func_279(ENTITY::GET_ENTITY_MODEL(*bParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*bParam0, 24) != func_312(*bParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*bParam0, 24, func_312(*bParam0, ((*uParam1)[38] - 1)), false);
	}
	func_311(bParam0);
	if (func_310(*bParam0))
	{
...
bool func_324(vector3 vParam0, float fParam3)
{
	return func_325(&(Global_105187.f_2890), vParam0, fParam3, 0);
}

bool func_325(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	bool bVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_342(uParam0))
	{
		...
		if (func_341(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0))
			{
				...
				else if ((!func_327(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
bool func_327(bool bParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_329(bParam0, uVar1[iVar6], 1) && func_328(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_323(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(bParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{

...
int func_204(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)
{
...
bool func_242(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
void func_248(bool bParam0, vector3 vParam1, bool bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_324(vParam1, bParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_315(iParam12, 0);
			while (!func_249(bParam0, iParam12, vParam1, bParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
bool func_249(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, int iParam7)
{
	bool bVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (UNK_0xB87F6CF6E5628C67(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = UNK_0x122AAB0B1D6F55AD(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, bParam5, false, false, false);
				...
				func_309(bParam0, &(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (UNK_0xB87F6CF6E5628C67(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*bParam0 = UNK_0x122AAB0B1D6F55AD(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, bParam5, false, false, false);
				...
				func_309(bParam0, &(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				UNK_0x0947AEED9914905B(*bParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (UNK_0x134B62B726CEC8E6(*bParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (UNK_0xB87F6CF6E5628C67(Var5))
			{
				...
				*bParam0 = UNK_0x122AAB0B1D6F55AD(Var5, vParam2, bParam5, true, true, false);
				...
				func_309(bParam0, &(Var5.f_31), &(Var5.f_81));
				UNK_0x0947AEED9914905B(*bParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_250(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && UNK_0xC844350D5D58C99A(*bParam1)) && UNK_0xDF1306B443CD3D15(*bParam1, 0))
	{
		...
		if (UNK_0x67303E186EA6C9A0(*bParam1) >= 0 && func_255(*bParam1, 0, &uVar0))
		{
			func_254(bParam1, &(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111638.f_20113[iParam0 /*43*/].f_31 = func_253(*bParam1);
...
bool func_255(bool bParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_283(bVar0, bParam1, uParam2) && !func_282(UNK_0xD803B885F5E47A62())) && !func_265(bParam0))
	{
		return false;
	}
	...
	bVar1 = false;
	if (func_263(UNK_0xD803B885F5E47A62()) && (UNK_0xAFB8495D36825275(bVar0) || UNK_0xC41A9202669A24C4(bVar0)))
	{
		bVar1 = true;
	}
	if (((UNK_0x56E1CD81AE700E98(bParam0) && !func_261(bParam0)) && !bVar1) && !(func_260(UNK_0x134B62B726CEC8E6(bParam0)) && func_257(UNK_0xD803B885F5E47A62())))
	{
	...
	{
		if ((func_256(bParam0) && UNK_0x134B62B726CEC8E6(bParam0) != joaat("SENTINEL2")) && UNK_0x134B62B726CEC8E6(bParam0) != joaat("ISSI2"))
		{
			*uParam2 = 2;
			return false;
		}
...
bool func_257(bool bParam0)
{
	if (bParam0 != func_210())
	{
		if (func_259(bParam0, 1, 1))
		{
			if (Global_2425662[bParam0 /*421*/].f_310.f_5 != -1)
			{
				return func_258(Global_2425662[bParam0 /*421*/].f_310.f_5) == 11;
			}
		}
	}
	return false;
...
bool func_262(bool bParam0)
{
	if (bParam0 != func_210())
	{
		if (func_259(bParam0, 1, 1))
		{
			if (Global_2425662[bParam0 /*421*/].f_310.f_5 != -1)
			{
				return func_258(Global_2425662[bParam0 /*421*/].f_310.f_5) == 13;
			}
		}
	}
	return false;
...
bool func_263(bool bParam0)
{
	if (bParam0 != func_210())
	{
		if (func_259(bParam0, 1, 1))
		{
			if (Global_2425662[bParam0 /*421*/].f_310.f_5 != -1)
			{
				return func_258(Global_2425662[bParam0 /*421*/].f_310.f_5) == 7;
			}
		}
	}
	return false;
...
bool func_267(bool bParam0)
{
	...
	if (func_268(UNK_0x134B62B726CEC8E6(bParam0)))
	{
		return true;
	}
	return false;
...
bool func_269(bool bParam0, bool bParam1)
{
	switch (UNK_0x134B62B726CEC8E6(bParam0))
	{
		...
		case joaat("INSURGENT"):
			if (func_271(UNK_0x134B62B726CEC8E6(bParam0), 0))
			{
...
bool func_280(bool bParam0)
{
	if (bParam0 != func_210())
	{
		if (func_259(bParam0, 1, 1))
		{
			if (Global_2425662[bParam0 /*421*/].f_310.f_5 != -1 && Global_2425662[bParam0 /*421*/].f_310.f_8 != func_210())
			{
				return func_258(Global_2425662[bParam0 /*421*/].f_310.f_5) == 5;
			}
		}
	}
	return false;
...
bool func_281(bool bParam0)
{
	if (bParam0 != func_210())
	{
		if (func_259(bParam0, 1, 1))
		{
			if (Global_2425662[bParam0 /*421*/].f_310.f_5 != -1 && Global_2425662[bParam0 /*421*/].f_310.f_8 != func_210())
			{
				return func_258(Global_2425662[bParam0 /*421*/].f_310.f_5) == 8;
			}
		}
	}
	return false;
...
bool func_282(bool bParam0)
{
	if (bParam0 != func_210())
	{
		if (func_259(bParam0, 1, 1))
		{
			if (Global_2425662[bParam0 /*421*/].f_310.f_5 != -1)
			{
				return func_258(Global_2425662[bParam0 /*421*/].f_310.f_5) == 9;
			}
		}
	}
	return false;
...
bool func_283(bool bParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_263(UNK_0xD803B885F5E47A62()) && (UNK_0xAFB8495D36825275(bParam0) || UNK_0xC41A9202669A24C4(bParam0)))
	{
		bVar0 = true;
	}
...
void func_285(bool bParam0, int iParam1)
{
	...
	func_286(bParam0, &(Global_111638.f_32744.f_5510));
}
...
{
	if ((((((((((!UNK_0xC844350D5D58C99A(bParam0) || !UNK_0xDF1306B443CD3D15(bParam0, 0)) || func_304(bParam0, 0, 0)) || func_304(bParam0, 1, 0)) || func_304(bParam0, 2, 0)) || func_303(bParam0) != 145) || func_302(bParam0)) || func_301(bParam0)) || func_256(bParam0)) || func_300(bParam0)) || !func_290(UNK_0x134B62B726CEC8E6(bParam0)))
	{
		if (func_301(bParam0))
		{
		}
...
bool func_304(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	var uVar1;
	int iVar9;
...
bool func_305(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_309(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_279(UNK_0x134B62B726CEC8E6(*bParam0), 1) && UNK_0x0ECB5CA5140957AD(*bParam0, 24) != func_312(*bParam0, ((*uParam1)[38] - 1)))
	{
		UNK_0xEE6A1776A67F70C1(*bParam0, 24, func_312(*bParam0, ((*uParam1)[38] - 1)), false);
	}
	func_311(bParam0);
	if (func_310(*bParam0))
	{
...
bool func_313(var uParam0, bool bParam1)
{
	if (UNK_0x8CD06866876216F2())
	{
	}
...
void func_317(vector3 vParam0, float fParam3, int iParam4)
{
	int iVar0;
...
bool func_324(vector3 vParam0, bool bParam3)
{
	return func_325(&(Global_105187.f_2890), vParam0, bParam3, 0);
}

bool func_325(var uParam0, vector3 vParam1, bool bParam4, bool bParam5)
{
	bool bVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_342(uParam0))
	{
		...
		if (func_341(uParam0))
		{
			...
			if (UNK_0xC844350D5D58C99A(bVar0))
			{
				...
				else if ((!func_327(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && UNK_0x7F8A39872A07D2CE(UNK_0xBB0808A181D4745C(), "startup_positioning"))
				{
					iVar8 = func_326(bVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
bool func_327(bool bParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("CARGOBOB"):
			if (func_329(bParam0, Global_75441.f_139[38], 0))
			{
				func_318(38);
				return true;
			}
			break;
		case joaat("FIRETRUK"):
			if (func_329(bParam0, Global_75441.f_139[43], 1))
			{
				func_318(43);
				return true;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_329(bParam0, uVar1[iVar6], 1) && func_328(UNK_0x68F4C0EC296D3901(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_323(vParam1, 0f, 0f, 0f, 0)) || UNK_0x0EB28750412C3A5A(UNK_0x68F4C0EC296D3901(bParam0, true), UNK_0x68F4C0EC296D3901(uVar1[iVar6], true), 1) < 10f)
					{

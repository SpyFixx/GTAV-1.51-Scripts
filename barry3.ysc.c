...
bool func_31(bool bParam0, int iParam1, bool bParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(bParam0, func_74(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(bParam0, func_74(iParam1), Global_76434[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(bParam0, func_74(iParam1), Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4, 0);
		}
	}
...
int func_34(bool bParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_76434[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(bParam0, func_74(iVar0), Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(bParam0, func_74(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(bParam0, func_74(iVar0), Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4, iParam4);
						}
						func_65(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(bParam0, func_74(iParam1), Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(bParam0, func_74(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(bParam0, func_74(iParam1), Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
void func_50(bool bParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_51(ENTITY::GET_ENTITY_MODEL(bParam0), 14, iVar0, FILES::GET_HASH_NAME_FOR_PROP(bParam0, 0, iParam2, iParam3)))
			{
...
bool func_55(bool bParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_57(ENTITY::GET_ENTITY_MODEL(bParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("MP_F_FREEMODE_01"))
		{
			return func_57(ENTITY::GET_ENTITY_MODEL(bParam0), iVar1, 14, 4);
		}
	}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (bParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_52(iParam0, bParam2, 14, 3), -1842686353, 1));
					}
					break;
				case 1:
					if (bParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_52(iParam0, bParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (bParam2 >= 327)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_52(iParam0, bParam2, 14, 4), -1842686353, 1));
					}
					break;
				case 1:
					if (bParam2 >= 26)
					{
						...
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_52(iParam0, bParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
bool func_70(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
bool func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_85(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
...
void func_92(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (bParam1 - iParam2))
				{
					...
					func_85(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_85(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
bool func_147(bool bParam0, int iParam1, bool bParam2)
{
	...
	else if (Global_76434[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(bParam0, func_74(iParam1)) && Global_76434[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(bParam0, func_74(iParam1)))
	{
		return true;
	}
	return false;
...
void func_162(char* sParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, char* sParam10, char* sParam11, int iParam12, char* sParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, var uParam24)
{
	sParam0->f_4 = iParam5;
	*sParam0 = sParam1;
	sParam0->f_1 = { Param2 };
...
void func_265(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11, int iParam12, float fParam13, float fParam14, int iParam15)
{
	func_266(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, fParam13, fParam14, iParam15);
}
...
bool func_270(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool func_279(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_282(bool bParam0, var uParam1, int iParam2)
{
	...
	while (iVar0 < 12)
	{
		...
		{
			if (func_41(iVar81, func_80(iVar0), func_64(bParam0, Var2.f_13[iVar0], Var2[iVar0], func_80(iVar0)), &uVar1))
			{
			...
			if (func_48(iVar81, func_80(iVar0), func_64(bParam0, Var2.f_13[iVar0], Var2[iVar0], func_80(iVar0)), &uVar1))
			{
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_41(iVar81, 14, func_55(bParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var67 = { func_82(iVar81, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var67.f_3;
				(*uParam1)[2] = Var67.f_4;
			...
			if (func_48(iVar81, 14, func_55(bParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var67 = { func_82(iVar81, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = Var67.f_3;
				(*uParam1)[1] = Var67.f_4;
		...
		if (func_252(iLocal_147))
		{
			...
			if (bLocal_161)
			{
				if (!bLocal_171)
				{
					if (func_288())
					{
						CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_147, 0f, 0f, 0.5f, true, 5000, 2000, 2000, false);
					}
					else
					{
						CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_147, 0.5f, 0f, 0.5f, true, 5000, 2000, 2000, false);
...
bool func_303(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
bool func_308(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;
...
bool func_319(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_320(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_322(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
bool func_323(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_351(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_425(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_416(iParam12, 0);
			while (!func_352(bParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
bool func_352(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_353(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if ((func_151(iParam0) && ENTITY::DOES_ENTITY_EXIST(*bParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*bParam1, false))
	{
...
bool func_358(int iParam0, bool bParam1, var uParam2)
{
	int iVar0;
	bool bVar1;
...
bool func_386(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(bParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false)) || func_268(bParam0, 0, 0)) || func_268(bParam0, 1, 0)) || func_268(bParam0, 2, 0)) || func_406(bParam0) != 145) || func_405(bParam0)) || func_404(bParam0)) || func_359(bParam0)) || func_403(bParam0)) || !func_393(ENTITY::GET_ENTITY_MODEL(bParam0)))
	{
		if (func_404(bParam0))
		{
		}
...
int func_410(bool bParam0, var uParam1, var uParam2)
{
	...
	if (func_382(ENTITY::GET_ENTITY_MODEL(*bParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*bParam0, 24) != func_413(*bParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*bParam0, 24, func_413(*bParam0, ((*uParam1)[38] - 1)), false);
	}
	func_412(bParam0);
	if (func_411(*bParam0))
	{
...
bool func_425(vector3 vParam0, float fParam3)
{
	return func_426(&(Global_105187.f_2890), vParam0, fParam3, 0);
}

bool func_426(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	bool bVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_443(uParam0))
	{
		...
		if (func_442(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0))
			{
				...
				else if ((!func_428(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
bool func_428(bool bParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_430(bParam0, uVar1[iVar6], 1) && func_429(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_424(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(bParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
bool func_430(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_431(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_434(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_433())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
bool func_454(int* iParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
...
bool func_455(int* iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;

...
void func_1()
{
	switch (iLocal_85)
	{
		case 0:
			...
			func_21();
			if (!UNK_0xEA6BC48857E0AC4C(bLocal_192))
			{
				if (UNK_0x7F8A39872A07D2CE(bLocal_192, "PRE_FKICKOFF"))
				{
...
bool func_8(int iParam0, var uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_38(bool bParam0, vector3 vParam1, float fParam4)
{
	if (func_237(bParam0))
	{
		UNK_0xA3BF0AA5A2608191(bParam0);
	}
	func_39(bParam0, vParam1, fParam4, 0, 1);
}

bool func_39(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
bool func_45(var uParam0, char* sParam1, var uParam2)
{
	switch (*uParam0)
	{
		case 0:
...
int func_62(var uParam0, int iParam1, bool bParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
...
bool func_85(bool bParam0, int iParam1, bool bParam2)
{
...
bool func_88(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (UNK_0x8CD06866876216F2())
	{
		if (func_92() == 0)
		{
			return UNK_0xEAE0D21A50E6C7F4(func_89(func_91(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
bool func_96(int iParam0, vector3 vParam1, float fParam4)
{
	switch (iParam0)
	{
		case 0:
			...
			break;
		case 1:
			UNK_0xD7992BEF7A9D109E(bLocal_193, false);
			UNK_0xD7992BEF7A9D109E(bLocal_209, 6);
...
bool func_97(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_105(bool bParam0, vector3 vParam1, float fParam4)
{
...
void func_108(int iParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6)
{
	if (!UNK_0xE4EDC4B0E92C078B(*iParam0))
	{
		*iParam0 = func_109(vParam1, 5, iParam4);
		if (bParam5)
		{
			UNK_0xDC5B2F9D0CCE3A10(*iParam0, bParam6);
		}
	}
}
		...
		case 0:
			if (func_95(iLocal_84, 0))
			{
				if (func_281())
				{
					...
					func_116(&uVar5, vVar1, fVar4, 0, 0, 0, 0, 0, joaat("ASTEROPE"), 0, 145, 1);
					func_113(0, -1, 1);
...
void func_116(bool bParam0, vector3 vParam1, bool bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*bParam0 = func_196(vParam1, bParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_184(bParam12, 0);
			while (!func_117(bParam0, bParam12, vParam1, bParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
bool func_117(bool bParam0, bool bParam1, vector3 vParam2, bool bParam5, bool bParam6, int iParam7)
{
	bool bVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_111638.f_2358.f_539.f_2407[0 /*295*/][bParam1 /*98*/] == Var5)
		{
			...
			if (UNK_0xB87F6CF6E5628C67(Global_111638.f_2358.f_539.f_2407[0 /*295*/][bParam1 /*98*/]))
			{
				*bParam0 = UNK_0x122AAB0B1D6F55AD(Global_111638.f_2358.f_539.f_2407[0 /*295*/][bParam1 /*98*/], vParam2, bParam5, false, false, false);
				...
				func_178(bParam0, &(Global_111638.f_2358.f_539.f_2407[0 /*295*/][bParam1 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[0 /*295*/][bParam1 /*98*/].f_81));
		...
		else if (Global_111638.f_2358.f_539.f_2407[1 /*295*/][bParam1 /*98*/] == Var5)
		{
			...
			if (UNK_0xB87F6CF6E5628C67(Global_111638.f_2358.f_539.f_2407[1 /*295*/][bParam1 /*98*/]))
			{
				*bParam0 = UNK_0x122AAB0B1D6F55AD(Global_111638.f_2358.f_539.f_2407[1 /*295*/][bParam1 /*98*/], vParam2, bParam5, false, false, false);
				...
				func_178(bParam0, &(Global_111638.f_2358.f_539.f_2407[1 /*295*/][bParam1 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[1 /*295*/][bParam1 /*98*/].f_81));
				UNK_0x0947AEED9914905B(*bParam0, Var5.f_96);
				if (bParam1 == 2)
				{
					if (UNK_0x134B62B726CEC8E6(*bParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (UNK_0xB87F6CF6E5628C67(Var5))
			{
				...
				*bParam0 = UNK_0x122AAB0B1D6F55AD(Var5, vParam2, bParam5, true, true, false);
				...
				func_178(bParam0, &(Var5.f_31), &(Var5.f_81));
				UNK_0x0947AEED9914905B(*bParam0, Var5.f_96);
				if (bParam1 == 1)
				{
...
void func_118(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if ((func_14(bParam0) && UNK_0xC844350D5D58C99A(*bParam1)) && UNK_0xDF1306B443CD3D15(*bParam1, 0))
	{
		...
		if (UNK_0x67303E186EA6C9A0(*bParam1) >= 0 && func_123(*bParam1, 0, &uVar0))
		{
			func_122(bParam1, &(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][bParam0 /*98*/].f_31), &(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][bParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_111638.f_20113[bParam0 /*43*/].f_31 = func_121(*bParam1);
				...
				func_119(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][bParam0 /*98*/].f_5, Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][bParam0 /*98*/].f_7, iVar3, 1, &(Global_111638.f_20113[bParam0 /*43*/].f_1));
				...
				func_119(Global_111638.f_2358.f_539.f_2407[iParam2 /*295*/][bParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_111638.f_20113[bParam0 /*43*/].f_2));
			}
		}
	}
}
...
bool func_123(bool bParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	if ((!func_151(bVar0, bParam1, uParam2) && !func_150(UNK_0xD803B885F5E47A62())) && !func_133(bParam0))
	{
		return false;
	}
	...
	bVar1 = false;
	if (func_131(UNK_0xD803B885F5E47A62()) && (UNK_0xAFB8495D36825275(bVar0) || UNK_0xC41A9202669A24C4(bVar0)))
	{
		bVar1 = true;
	}
	if (((UNK_0x56E1CD81AE700E98(bParam0) && !func_129(bParam0)) && !bVar1) && !(func_128(UNK_0x134B62B726CEC8E6(bParam0)) && func_125(UNK_0xD803B885F5E47A62())))
	{
	...
	if (!UNK_0x8CD06866876216F2())
	{
		if ((func_124(bParam0) && UNK_0x134B62B726CEC8E6(bParam0) != joaat("SENTINEL2")) && UNK_0x134B62B726CEC8E6(bParam0) != joaat("ISSI2"))
		{
			*uParam2 = 2;
			return false;
		}
...
bool func_127(bool bParam0, bool bParam1, bool bParam2)
{
	bool bVar0;
...
bool func_135(bool bParam0)
{
	...
	if (func_136(UNK_0x134B62B726CEC8E6(bParam0)))
	{
		return true;
	}
	return false;
...
bool func_137(bool bParam0, bool bParam1)
{
	switch (UNK_0x134B62B726CEC8E6(bParam0))
	{
		...
		case joaat("INSURGENT"):
			if (func_139(UNK_0x134B62B726CEC8E6(bParam0), 0))
			{
...
bool func_151(bool bParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_131(UNK_0xD803B885F5E47A62()) && (UNK_0xAFB8495D36825275(bParam0) || UNK_0xC41A9202669A24C4(bParam0)))
	{
		bVar0 = true;
	}
...
void func_153(bool bParam0, bool bParam1)
{
	...
	func_154(bParam0, &(Global_111638.f_32744.f_5510));
}
...
{
	if ((((((((((!UNK_0xC844350D5D58C99A(bParam0) || !UNK_0xDF1306B443CD3D15(bParam0, 0)) || func_173(bParam0, 0, 0)) || func_173(bParam0, 1, 0)) || func_173(bParam0, 2, 0)) || func_172(bParam0) != 145) || func_171(bParam0)) || func_170(bParam0)) || func_124(bParam0)) || func_169(bParam0)) || !func_159(UNK_0x134B62B726CEC8E6(bParam0)))
	{
		if (func_170(bParam0))
		{
		}
...
bool func_174(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
int func_178(bool bParam0, var uParam1, var uParam2)
{
	...
	if (func_147(UNK_0x134B62B726CEC8E6(*bParam0), 1) && UNK_0x0ECB5CA5140957AD(*bParam0, 24) != func_181(*bParam0, ((*uParam1)[38] - 1)))
	{
		UNK_0xEE6A1776A67F70C1(*bParam0, 24, func_181(*bParam0, ((*uParam1)[38] - 1)), false);
	}
	func_180(bParam0);
	if (func_179(*bParam0))
	{
...
bool func_182(var uParam0, bool bParam1)
{
	if (UNK_0x8CD06866876216F2())
	{
	}
...
void func_184(bool bParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (UNK_0xC844350D5D58C99A(Global_96075[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || UNK_0x134B62B726CEC8E6(Global_96075[iVar0]) == func_185(bParam0, iParam1))
				{
...
void func_186(vector3 vParam0, float fParam3, int iParam4)
{
	int iVar0;
...
bool func_196(vector3 vParam0, bool bParam3)
{
	return func_197(&(Global_105187.f_2890), vParam0, bParam3, 0);
}

bool func_197(var uParam0, vector3 vParam1, bool bParam4, bool bParam5)
{
	bool bVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_213(uParam0))
	{
		...
		if (func_212(uParam0))
		{
			...
			if (UNK_0xC844350D5D58C99A(bVar0))
			{
				...
				else if ((!func_199(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && UNK_0x7F8A39872A07D2CE(UNK_0xBB0808A181D4745C(), "startup_positioning"))
				{
					iVar8 = func_198(bVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
bool func_199(bool bParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("CARGOBOB"):
			if (func_200(bParam0, Global_75441.f_139[38], 0))
			{
				func_187(38);
				return true;
			}
			break;
		case joaat("FIRETRUK"):
			if (func_200(bParam0, Global_75441.f_139[43], 1))
			{
				func_187(43);
				return true;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_200(bParam0, uVar1[iVar6], 1) && func_97(UNK_0x68F4C0EC296D3901(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_195(vParam1, 0f, 0f, 0f, 0)) || UNK_0x0EB28750412C3A5A(UNK_0x68F4C0EC296D3901(bParam0, true), UNK_0x68F4C0EC296D3901(uVar1[iVar6], true), 1) < 10f)
					{
...
void func_201(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (UNK_0xDF1306B443CD3D15(bParam0, 0))
	{
		...
		if (((UNK_0xEAE0D21A50E6C7F4(uParam1->f_77, 15) || func_204(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_203())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
int func_221(vector3 vParam0, int iParam3)
{
	return func_222(Global_105187.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_222(bool bParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_231(int iParam0)
{
	...
	switch (iParam0)
	{
		case 0:
			break;
		case 1:
			bLocal_192 = "PRE_FKICKOFF";
			break;
		case 2:
			bLocal_192 = "PRE_FLEFT";
			break;
		case 3:
			bLocal_192 = "PRE_CASH";
			break;
...
{
	if (func_85(bParam1, 0, 0) || func_85(bParam2, 0, 0))
	{
		UNK_0x790015DC92C918E2();
	}
	if (!func_85(bParam0, 0, 0))
	{
		func_94(bParam0, 60000, 0);
	}
}
...
void func_239(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	int iVar1;

	if (func_271(bParam0) == 3)
	{
		return;
	}
	if (func_271(bParam0) == 4)
	{
		return;
	}
	func_240(func_271(bParam0), 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		bVar0 = false;
		if (bParam4)
...
void func_243(bool bParam0)
{
	...
	else if (UNK_0xEAE0D21A50E6C7F4(Global_111638.f_20559.f_471, bParam0) || UNK_0xEAE0D21A50E6C7F4(Global_2097152[func_245() /*10930*/].f_6174.f_10, bParam0))
	{
		bVar0 = true;
		UNK_0x0674E58A79778E99(&(Global_111638.f_20559.f_471), bParam0);
		UNK_0x0674E58A79778E99(&(Global_2097152[func_245() /*10930*/].f_6174.f_10), bParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		UNK_0x1E64CE678ED5F61E("COUP_RED");
		UNK_0x6B012227B3921E18(func_244(bParam0));
...
bool func_249(bool bParam0)
{
	...
	return UNK_0xEAE0D21A50E6C7F4(Global_2097152[func_245() /*10930*/].f_6174.f_10, bParam0);
}
...
int func_250(int iParam0, bool bParam1, int iParam2)
{
	...
	iVar1 = func_252(iParam0, bParam1);
...
void func_273(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (UNK_0x8CD06866876216F2())
	{
		if (func_92() == 0)
		{
			...
			func_246(func_91(iParam0), bVar0, -1, 1, 0);
		}
	}
	else
	{
...
bool func_284(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_288(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	bool bVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			bVar0 = func_89(func_291(iParam1, uParam0->f_2), Global_76431, 0);
			if (UNK_0xEAE0D21A50E6C7F4(bVar0, uParam0->f_1))
			{
				UNK_0x5D96D8530B3D0904(&(uParam0->f_6), true);
			}
			bVar0 = func_89(func_290(iParam1, uParam0->f_2), Global_76431, 0);
			if (UNK_0xEAE0D21A50E6C7F4(bVar0, uParam0->f_1))
			{
				UNK_0x5D96D8530B3D0904(&(uParam0->f_6), 2);
			}
			...
			{
				bVar0 = func_89(iVar1, Global_76431, 0);
				if (!UNK_0xEAE0D21A50E6C7F4(bVar0, uParam0->f_1))
				{
					UNK_0x5D96D8530B3D0904(&(uParam0->f_6), 4);
				}
...
bool func_292(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (func_293(bParam0, iParam1, &iVar2, &bVar1, bParam2, bParam3))
	{
		bVar3 = func_89(iVar2, iVar0, 0);
		return UNK_0xEAE0D21A50E6C7F4(bVar3, bVar1);
	}
	return false;
}

bool func_293(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_295(int iParam0, int iParam1, int iParam2, bool bParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!UNK_0x232048AB4B0E0259(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_288(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, UNK_0x1A5A491D253EA7BA(Var20.f_1, joaat("OUTFIT_ONLY"), false), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (bParam3 != -1 && Global_76603)
		{
			...
			func_288(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, UNK_0x1A5A491D253EA7BA(Var41.f_1, joaat("OUTFIT_ONLY"), false), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = UNK_0xF6900DA2D9CD7BC5(bVar1, 7, -1, 0, -1, func_296(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{

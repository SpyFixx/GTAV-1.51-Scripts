...
void func_13(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam1)
	{
		...
		else if (HUD::DOES_BLIP_EXIST(Global_2416079[iVar0]))
		{
			...
			{
				Global_2416079.f_201[iVar0] = NETWORK::HAS_NETWORK_TIME_STARTED(NETWORK::_0xBA7F0B77D80A4EB7(), bParam2);
			}
		}
		else
		{
...
bool func_63(var uParam0, var uParam1, int* iParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	if (bParam5)
	{

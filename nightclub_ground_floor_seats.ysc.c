...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		fVar0 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_141.f_4)
	{
		...
		case 5:
			...
			{
				uParam0->f_141.f_1 = NETWORK::_0x77758139EC9B66C7(func_48(uParam0), func_47(uParam0), 2, true, false, 1065353216 /* Float: 1f */, 0, 1.12f);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_141.f_1, &uVar0, &uVar16, 2f, -1000f, 13, 16, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_141.f_1);
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			fVar33 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fVar33))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fVar33) >= 1f)
				{
					...
					func_49(uParam0, &uVar16);
					uParam0->f_141.f_1 = NETWORK::_0x77758139EC9B66C7(func_48(uParam0), func_47(uParam0), 2, true, false, 1065353216 /* Float: 1f */, 0, 1.12f);
					NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_141.f_1, &uVar0, &uVar16, 4f, -1.5f, 13, 16, 1148846080 /* Float: 1000f */, 0);
					NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_141.f_1);
					func_33(&(uParam0->f_141), 8);
		...
		case 7:
			...
			break;
		case 8:
			fVar34 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
...
void func_30(var uParam0)
{
	...
	uParam0->f_141.f_1 = NETWORK::_0x77758139EC9B66C7(func_48(uParam0), func_47(uParam0), 2, true, false, 1065353216 /* Float: 1f */, 0, 1.12f);
	func_50(uParam0, &uVar0);
	NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_141.f_1, &uVar0, "exit", 4f, -4f, 13, 16, 1148846080 /* Float: 1000f */, 0);
	NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_141.f_1);
	func_7(&(uParam0->f_141.f_5));
	func_65(uParam0, 8);
}

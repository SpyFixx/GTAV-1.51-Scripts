...
void func_1()
{
	...
	switch (iLocal_326)
	{
		case 0:
			...
			if (func_72() == 5)
			{
				fLocal_330 = NETWORK::_0x77758139EC9B66C7(vLocal_347, vLocal_350, 2, false, true, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_330, sLocal_333, sLocal_335, 8f, -2f, 261, 0, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_330);
				iLocal_326 = 7;
			}
			else if (func_53(8))
			{
		...
		case 2:
			...
			{
				fLocal_330 = NETWORK::_0x77758139EC9B66C7(vLocal_347, vLocal_350, 2, false, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_330, sLocal_333, sLocal_334, 4f, -2f, 261, 0, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_330);
				iLocal_326 = 3;
			}
			break;
		case 3:
			...
			func_11(1);
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
			fLocal_331 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(fLocal_330);
		...
		case 4:
			...
			func_11(1);
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_331) > 0.9f)
			{
				fLocal_330 = NETWORK::_0x77758139EC9B66C7(vLocal_347, vLocal_350, 2, false, true, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_330, sLocal_333, sLocal_335, 8f, -2f, 261, 0, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_330);
		...
		case 6:
			...
			if (!func_45(PLAYER::PLAYER_ID()) && PAD::IS_CONTROL_JUST_PRESSED(2, 222))
			{
				...
				func_8();
				fLocal_330 = NETWORK::_0x77758139EC9B66C7(vLocal_347, vLocal_350, 2, false, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_330, sLocal_333, sLocal_336, 2f, -2f, 261, 0, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_330);
				iLocal_326 = 8;
			}
			break;
		case 7:
			if (((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_343)) && !func_7()) && !func_5()) && Global_1312467.f_8 == 0)
			{
				bLocal_328 = true;
				fLocal_330 = NETWORK::_0x77758139EC9B66C7(vLocal_347, vLocal_350, 2, false, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_330, sLocal_333, sLocal_336, 1000f, -2f, 261, 0, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_330);
				iLocal_326 = 8;
			}
			break;
...
float func_15(struct<2> Param0, int iParam2, struct<2> Param3, var uParam5)
{
...
bool func_43(bool bParam0, bool bParam1, bool bParam2)
{
	int iVar0;
...
bool func_49(vector3 vParam0, var uParam3, var uParam4, var uParam5)
{
		...
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				if ((((CAM::IS_GAMEPLAY_CAM_RENDERING() && !CUTSCENE::IS_CUTSCENE_PLAYING()) && !CAM::IS_CINEMATIC_CAM_RENDERING()) && !func_42(0)) && !func_52())
				{
					...
					if (func_50(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, uParam3, 0))
					{
						return true;
					}
				}

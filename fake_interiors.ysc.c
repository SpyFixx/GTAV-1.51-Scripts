...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			bLocal_33 = UNK_0x16F2683693E537C9();
		}
		if (UNK_0x437347B10A200C4B(bLocal_33, 0))
		{
		}
		func_1();
	}
...
void func_1()
{
	...
	{
		vVar0 = { UNK_0x68F4C0EC296D3901(bLocal_33, false) };
		...
		if (SYSTEM::VDIST2(vVar3, vVar0) < IntToFloat(func_18(iLocal_29)))
		{
			...
			while (iVar7 < func_17(iLocal_29))
			{
				if (!bVar6)
				{
					if (UNK_0x3D1053F9EB43B7AD(bLocal_33, func_16(iLocal_29, iVar7), func_15(iLocal_29, iVar7), func_14(iLocal_29, iVar7), 0, true, 0))
					{
						bVar6 = true;
					}
				}
	...
	if (UNK_0x8CD06866876216F2())
	{
		if (func_2())
		{
			if (UNK_0xEAE0D21A50E6C7F4(bLocal_34, true))
			{
				UNK_0x0674E58A79778E99(&bLocal_34, true);
			}
			if (UNK_0x798A3F1296751F46())
			{
				if (!UNK_0xEAE0D21A50E6C7F4(bLocal_34, false))
				{
					UNK_0x4A847DA194A5532B(15, 1, -1);
					UNK_0x5D96D8530B3D0904(&bLocal_34, false);
				}
			}
			else if (UNK_0xEAE0D21A50E6C7F4(bLocal_34, false))
			{
				UNK_0x4A847DA194A5532B(15, 0, -1);
				UNK_0x0674E58A79778E99(&bLocal_34, false);
			}
		}
		else if (!UNK_0xEAE0D21A50E6C7F4(bLocal_34, true))
		{
			UNK_0x4A847DA194A5532B(15, 0, -1);
			UNK_0x0674E58A79778E99(&bLocal_34, false);
			UNK_0x5D96D8530B3D0904(&bLocal_34, true);
		}
	}
}

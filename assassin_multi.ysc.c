...
bool func_109(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, bool bParam5)
{
	bool bVar0;
		...
		case 1:
			...
			else
			{
				...
				if (bLocal_1514)
				{
					...
					bVar1 = func_417(vLocal_1570, fLocal_1573);
				...
				{
					if (bLocal_1516 && !PED::IS_PED_INJURED(*uParam1))
					{
						func_258();
				...
				func_186(&bLocal_1537, &(uParam1->f_16), "OJASAUD", sVar2, 9, 1, 0, 0);
...
void func_187(var uParam0, var uParam1)
{
	...
	func_188(&uLocal_1794, *uParam1, 0, 0, 1, 1, 1);
}
...
void func_206(var uParam0, int iParam1, vector3 vParam2, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_210(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
bool func_211(bool bParam0, bool bParam1, bool bParam2)
{
...
bool func_213(bool bParam0, bool bParam1, bool bParam2)
{
	if (!func_197(bParam0, bParam1, bParam2))
	{
		return false;
...
bool func_223(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	bool bVar1;
...
bool func_224(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
bool func_227(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
...
int func_240(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_253(int iParam0, int iParam1, float fParam2, float fParam3, var uParam4)
{
...
bool func_265(var uParam0)
{
	if (iLocal_1461 == 0)
	{
		if ((func_223(*uParam0, 0, &Local_122, &uLocal_133, 0, 0, 0, 1, 1) || func_254(&bLocal_1523)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_1563, 25f))
		{
			return true;
		}
	}
	...
	{
		if (func_223(*uParam0, uParam0->f_1, &Local_122, &uLocal_133, 0, 0, 0, 1, 1) || func_223(uParam0->f_7, 0, &Local_122, &uLocal_133, 0, 0, 0, 1, 1))
		{
			return true;
		}
	}
	else if (func_223(*uParam0, uParam0->f_1, &Local_122, &uLocal_133, 0, 0, 0, 1, 1))
	{
		return true;
	}
	return false;
	...
	switch (iLocal_1461)
	{
		case 0:
			if (!PED::IS_PED_INJURED(*uParam1))
			{
				...
				func_38(&uLocal_1629, 3, *uParam1, "OJAmlBODYBUILDER", 0, 1);
		...
		case 1:
			...
			{
				uParam1->f_9 = PED::CREATE_PED(5, uParam0->f_16, uParam0->f_22, uParam0->f_25, true, true);
				PED::_0x2208438012482A1A(uParam1->f_9, false, false);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam1->f_9, "WORLD_HUMAN_SUNBATHE", uParam0->f_22, uParam0->f_25, 0, false, true);
				PED::SET_PED_COMBAT_ATTRIBUTES(uParam1->f_9, 17, true);
			}
			if (!PED::IS_PED_INJURED(uParam1->f_7))
			{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_1))
			{
				...
				ENTITY::_SET_ENTITY_SOMETHING(uParam1->f_1, true);
			}
			if (!PED::IS_PED_INJURED(*uParam1))
			{
				PED::SET_PED_DIES_IN_WATER(*uParam1, false);
				func_38(&uLocal_1629, 3, *uParam1, "OJAmlYACHTTARGET", 0, 1);
		...
		case 2:
			if ((!PED::IS_PED_INJURED(*uParam1) && ENTITY::DOES_ENTITY_EXIST(uParam1->f_11[0])) && ENTITY::DOES_ENTITY_EXIST(uParam1->f_11[1]))
			{
				...
				ENTITY::ATTACH_ENTITY_TO_ENTITY(*uParam1, uParam1->f_11[0], 0, -2.1f, -0.4f, 0.25f, 0f, 0f, 180f, true, true, false, false, 2, true);
				TASK::TASK_PLAY_ANIM(*uParam1, "oddjobs@assassinate@multi@windowwasher", "_idle", 8f, -8f, -1, 1, 0f, false, false, false);
		...
		case 3:
			if (!PED::IS_PED_INJURED(*uParam1))
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(*uParam1, 6, true);
				PED::GIVE_PED_HELMET(*uParam1, false, 4096, -1);
				PED::SET_PED_HELMET(*uParam1, true);
				func_38(&uLocal_1629, 3, *uParam1, "OJAmlBIKER", 0, 1);
...
bool func_311(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
void func_317(bool bParam0, bool bParam1)
{
	...
	if (func_13(iVar0) && !PED::IS_PED_INJURED(bParam0))
	{
		...
		{
			func_318(bParam0, &(Global_111638.f_2358.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
bool func_326(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
void func_366(char* sParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, char* sParam10, char* sParam11, int iParam12, char* sParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, var uParam24)
{
	sParam0->f_4 = iParam5;
	*sParam0 = sParam1;
	sParam0->f_1 = { Param2 };
...
int func_374(bool bParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, int iParam10)
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	sVar5 = "NULL";
	sVar6 = "NULL";
	if (func_376(bParam0, sParam2, iParam3, iVar0, sVar1, sVar3, iVar2, iParam4, iParam5, iParam6, bParam8, iParam9, iParam10, iVar4, sVar5, sVar6, iParam1) == 1)
	{
		if (bParam8 == 1)
		{
			Global_8063 = iParam7;
			Global_7966[3 /*6*/] = { func_375(bParam0) };
			Global_8043 = bParam0;
...
int func_376(bool bParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	...
	func_377(bParam0, sParam1);
	return 1;
}

void func_377(bool bParam0, char* sParam1)
{
	if (!func_25())
	{
		return;
...
bool func_385(struct<6> Param0, struct<6> Param6)
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
bool func_393(int iParam0, char* sParam1, int iParam2)
{
	if (MISC::IS_BIT_SET(iParam0, 30))
	{
...
bool func_417(vector3 vParam0, float fParam3)
{
	return func_418(&(Global_105187.f_2890), vParam0, fParam3, 0);
}

bool func_418(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	bool bVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_401(uParam0))
	{
		...
		if (func_400(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0))
			{
				...
				else if ((!func_435(bVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_434(bVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
void func_419(bool bParam0, int iParam1)
{
	...
	func_295(bParam0, &(Global_111638.f_32744.f_5510));
}

bool func_420(bool bParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(bParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false)) || func_310(bParam0, 0, 0)) || func_310(bParam0, 1, 0)) || func_310(bParam0, 2, 0)) || func_291(bParam0) != 145) || func_425(bParam0)) || func_424(bParam0)) || func_423(bParam0)) || func_422(bParam0)) || !func_421(ENTITY::GET_ENTITY_MODEL(bParam0)))
	{
		if (func_424(bParam0))
		{
		}
...
bool func_435(bool bParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("CARGOBOB"):
			if (func_436(bParam0, Global_75441.f_139[38], 0))
			{
				func_429(38);
				return true;
			}
			break;
		case joaat("FIRETRUK"):
			if (func_436(bParam0, Global_75441.f_139[43], 1))
			{
				func_429(43);
				return true;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_436(bParam0, uVar1[iVar6], 1) && func_402(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_209(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(bParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
bool func_436(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_439(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_447(bParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_446())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
int func_440(bool bParam0, var uParam1, var uParam2)
{
	...
	if (func_444(ENTITY::GET_ENTITY_MODEL(*bParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*bParam0, 24) != func_443(*bParam0, ((*uParam1)[38] - 1)))
	{
...
bool func_479(int iParam0, float fParam1, vector3 vParam2, vector3 vParam5, float fParam8, bool bParam9, float fParam10)
{
...
void func_489(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, float fParam14, int iParam15, int iParam16, var uParam17, float fParam18)
{
	func_490(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, fParam14, iParam15, iParam16, uParam17, fParam18);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(bVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_491(bVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
bool func_491(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;

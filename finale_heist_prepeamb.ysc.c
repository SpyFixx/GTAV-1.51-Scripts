...
void func_137()
{
	...
	if (!UNK_0xEAE0D21A50E6C7F4(bLocal_105, 18))
	{
		if (!func_15(0) && !func_117())
		{
			func_143(sLocal_53[4], 7500, 0);
			UNK_0x5D96D8530B3D0904(&bLocal_105, 18);
		}
	}
	if (UNK_0xEAE0D21A50E6C7F4(bLocal_105, false))
	{
		if (UNK_0xEAE0D21A50E6C7F4(bLocal_105, true))
		{
			...
			if (func_85(bLocal_109))
			{
				if (!UNK_0xC42A92762C58E1B9(UNK_0x16F2683693E537C9(), bLocal_109, 0))
				{
					if (UNK_0x8B38C0DAEEDB5F9C(bLocal_109))
					{
						func_139();
	...
	{
		UNK_0x0674E58A79778E99(&bLocal_105, 18);
		func_138(&uLocal_1439);
		UNK_0xE342F209E49C5314(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, true, 1);
		func_78(0, 1);
	}
...
bool func_141(bool bParam0, int iParam1, bool bParam2)
{
...
void func_144()
{
	...
	{
		case 0:
			if (((!UNK_0xE4EDC4B0E92C078B(iLocal_1438) && UNK_0xEAE0D21A50E6C7F4(bLocal_105, false)) && !UNK_0xEAE0D21A50E6C7F4(bLocal_105, true)) && UNK_0xEAE0D21A50E6C7F4(bLocal_105, 18))
			{
	...
	if (func_103(35))
	{
		if (iLocal_38 == 0)
		{
			if (!UNK_0xEAE0D21A50E6C7F4(bLocal_105, true))
			{
				if (func_85(bLocal_109))
				{
					UNK_0x5A91F08DF773C39D(bLocal_109, vLocal_106, 4f, 4f, 2f, true, true, 0);
					if (UNK_0x3D1053F9EB43B7AD(bLocal_109, -168.8162f, -619.9002f, 31.42446f, -162.6423f, -622.0781f, 33.42446f, 4.14f, 0, true, 0))
					{
						func_150(24, 46);
						if (func_149(bLocal_109))
						{
			...
			{
				if (!func_76(bLocal_109, vLocal_106, 10f) || UNK_0x377BE9A1BF38C7CE(bLocal_109))
				{
					UNK_0x0674E58A79778E99(&bLocal_105, true);
				}
			}
...
bool func_148(float fParam0, int iParam1)
{
	bool bVar0;
							...
							if (func_85(bVar0))
							{
								if (!func_168(bVar0))
								{
									if (func_161(bVar0) && !func_160())
									{
										...
										{
											if (!UNK_0xEAE0D21A50E6C7F4(bLocal_105, 19))
											{
												func_69(9);
												UNK_0x5D96D8530B3D0904(&bLocal_105, 19);
											}
...
int func_162(bool bParam0)
{
	...
	iVar0 = UNK_0xD6DF381716822EFE(bParam0);
	if (iVar0 >= 3)
	{
		return 1;
	}
...
int func_174(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)
{
...
void func_189()
{
	...
	bVar0 = func_89();
	func_190(bVar0, func_199(bVar0));
}

void func_190(bool bParam0, char* sParam1)
{
	int iVar0;
...
void func_209()
{
	...
	if (((((((Global_41431 == 15 && iLocal_37 != 3) && UNK_0xEAE0D21A50E6C7F4(bLocal_105, 5)) && !func_169()) && Global_76619 == -1) && !func_219()) && !func_84(9)) || func_103(35))
	{
		func_218();
		func_217();
		switch (iLocal_39)
...
bool func_232(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (UNK_0x8CD06866876216F2())
	{
		if (func_96() == 0)
		{
			return UNK_0xEAE0D21A50E6C7F4(func_233(func_235(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
void func_237(bool bParam0, int iParam1)
{
	...
	{
		if (func_2(bParam0) && !UNK_0x79BBCD5833294FD5())
		{

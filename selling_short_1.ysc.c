...
void func_8(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_15(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
void func_18(bool bParam0)
{
	...
	while (bVar0 <= 26)
	{
		func_23(&(Local_90[bVar0 /*178*/]), bVar0);
		bVar0++;
	}
	bVar0 = false;
	while (bVar0 <= 29)
	{
		func_22(&(Local_4898[bVar0 /*24*/]), bVar0);
		bVar0++;
	}
	bVar0 = false;
	while (bVar0 <= 23)
	{
		func_21(&(Local_5620[bVar0 /*24*/]), bVar0);
		bVar0++;
	}
...
void func_24(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, var uParam8, var uParam9)
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam4 };
	uParam0->f_7 = fParam7;
...
void func_25(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5, int iParam8, var uParam9, var uParam10)
{
	if (uParam0->f_154 >= *uParam0)
	{
		return;
	}
	func_26(uParam0[uParam0->f_154 /*17*/], iParam1, vParam2, vParam5, iParam8, uParam9, uParam10);
	uParam0->f_154++;
}

void func_26(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5, int iParam8, var uParam9, var uParam10)
{
	*uParam0 = { vParam2 };
	uParam0->f_3 = { vParam5 };
	uParam0->f_6 = iParam8;
...
void func_43()
{
	...
	{
		func_46(iLocal_59[bVar0]);
		bVar0++;
	}
	bVar0 = false;
	while (bVar0 <= 12)
	{
		func_45(func_32(bVar0));
		bVar0++;
	}
	func_44(iLocal_6213);
	func_8(0, 1, 1, 0, 0, 0);

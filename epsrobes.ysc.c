	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && func_168(0))
	{
		switch (iLocal_222)
		{
			...
			case 1:
				...
				break;
			case 2:
				if ((func_47(PLAYER::PLAYER_PED_ID(), 12, bLocal_47) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
				{
				...
				break;
			case 3:
				if (!func_47(PLAYER::PLAYER_PED_ID(), 12, bLocal_47) && !func_45())
				{
					iLocal_222 = 2;
				}
...
void func_2(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (Global_117[bParam0 /*10*/].f_8 != 150)
	{
		...
		{
			if (func_6(bParam0, iParam1) == 1 && func_5(bParam0, iParam1) == 1)
			{
				bParam2 = false;
			}
			iVar0 = iParam1;
			func_8(bParam0, iVar0, 1);
			func_7(bParam0, iVar0, 1);
		}
		if (bParam2)
		{
			if (!Global_76622)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8015[iParam1 /*4*/] = { func_4(bParam0) };
					...
					{
						Global_7966[1 /*6*/] = { func_4(bParam0) };
...
bool func_14(bool bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	sVar6 = "NULL";
	iVar7 = 3;
	if (func_15(bParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		if (bParam7 == 1)
		{
			Global_8063 = iParam6;
			Global_7966[3 /*6*/] = { func_4(bParam0) };
			Global_8043 = bParam0;
...
int func_15(bool bParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	int iVar0;
	...
	func_16(bParam0, sParam1);
	return 1;
}

void func_16(bool bParam0, char* sParam1)
{
	if (!func_17())
	{
		return;
...
bool func_29(struct<6> Param0, struct<6> Param6)
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
bool func_47(int iParam0, int iParam1, bool bParam2)
{
	...
	Global_76434[1 /*14*/] = { func_67(iVar0, iParam1, bParam2, -1) };
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_47(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_47(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (bVar4 <= 19)
								{
									Global_76434[2 /*14*/] = { func_67(iVar0, 14, bVar4, -1) };
									if (Global_76434[2 /*14*/].f_12 == iVar3)
									{
										if (func_47(iParam0, 14, bVar4))
										{
					...
					{
						bVar1 = func_49(iParam0, iVar2);
						Global_76434[2 /*14*/] = { func_67(iVar0, iVar2, bVar1, -1) };
...
bool func_51(int iParam0, bool bParam1, int iParam2, bool bParam3, var uParam4, var uParam5)
{
	...
	if (func_58(iParam0, iParam2, bParam3))
	{
		return true;
	}
	if (iParam0 == joaat("PLAYER_ZERO"))
	{
		if (func_57(iParam0, iParam2, bParam3, -1))
		{
		...
		else if (func_56(iParam0, iParam2, bParam3, -1))
		{
		...
		else if (func_52(iParam0, iParam2, bParam3, -1))
		{
			if (((((((((bParam1 == 1 || bParam1 == 2) || bParam1 == 4) || bParam1 == 5) || bParam1 == 10) || bParam1 == 11) || bParam1 == 12) || bParam1 == 14) || bParam1 == 18) || bParam1 == 50)
			{
				return false;
...
int func_53(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar39 = 0;
		iVar40 = (bParam1 - func_54(iParam0, func_48(iParam2)));
		if (iVar40 < 0)
		{
			return -1;
		}
...
bool func_56(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (iParam0 == joaat("PLAYER_ZERO"))
	{
		if (iParam1 == 6)
...
struct<10> func_59(int iParam0, bool bParam1)
{
	int iVar0;
	struct<10> Var1;
		...
		case joaat("PLAYER_ZERO"):
			switch (bParam1)
			{
				...
				case 9:
					...
					break;
				default:
					func_60(&Var1, iParam0, bParam1, 10);
					break;
			}
			break;
		case joaat("PLAYER_ONE"):
			switch (bParam1)
			{
				...
				case 8:
					...
					break;
				default:
					func_60(&Var1, iParam0, bParam1, 9);
					break;
			}
			break;
		case joaat("PLAYER_TWO"):
		...
		case joaat("MP_M_FREEMODE_01"):
			switch (bParam1)
			{
				...
				case 24:
					...
					break;
				default:
					func_60(&Var1, iParam0, bParam1, 25);
					break;
			}
			break;
		case joaat("MP_F_FREEMODE_01"):
...
void func_60(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar16;
...
struct<17> func_63(int iParam0, bool bParam1)
{
	int iVar0;
	struct<17> Var1;
		...
		case joaat("PLAYER_ZERO"):
			switch (bParam1)
			{
				...
				case 52:
					...
					break;
				default:
					func_64(&Var1, iParam0, bParam1, 53);
					break;
			}
			break;
		case joaat("PLAYER_ONE"):
			switch (bParam1)
			{
				...
				case 46:
					...
					break;
				default:
					func_64(&Var1, iParam0, bParam1, 47);
					break;
			}
			break;
		case joaat("PLAYER_TWO"):
			switch (bParam1)
			{
				...
				case 47:
					...
					break;
				default:
					func_64(&Var1, iParam0, bParam1, 48);
					break;
			}
			break;
		case joaat("MP_M_FREEMODE_01"):
			switch (bParam1)
			{
				...
				case 25:
					...
					break;
				default:
					func_64(&Var1, iParam0, bParam1, 26);
					break;
			}
			break;
		case joaat("MP_F_FREEMODE_01"):
			switch (bParam1)
			{
				...
				case 27:
					...
					break;
				default:
					func_64(&Var1, iParam0, bParam1, 28);
					break;
			}
			break;
	}
...
void func_64(var uParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar16;
...
struct<14> func_67(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	func_135();
	if (iParam0 == joaat("PLAYER_ZERO"))
	{
...
void func_69(bool bParam0)
{
	...
	switch (bParam0)
	{
		...
		case 87:
			...
			break;
		default:
			func_81(iVar10, bParam0, 155, -1);
			return;
	}
	func_70(&(Global_76434[0 /*14*/]), iVar10, bParam0, &cVar2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_70(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
...
bool func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_78(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_81(int iParam0, bool bParam1, int iParam2, int iParam3)
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (bParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_70(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_70(&(Global_76434[0 /*14*/]), iParam0, bParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (bParam1 - iParam2))
				{
					...
					func_70(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_70(&(Global_76434[0 /*14*/]), iParam0, bParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
int func_136(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	Global_76434[1 /*14*/] = { func_67(iParam0, iParam1, bParam2, -1) };
		...
		if (iParam4 == 1 && bParam3 == 1)
		{
			switch (iParam0)
			{
				...
				case joaat("PLAYER_ONE"):
					...
					{
						case 3:
							if (bParam2 >= 176 && bParam2 <= 191)
							{
								bVar30 = (227 + Global_76434[1 /*14*/].f_4);
								func_136(iParam0, 3, bVar30, 1, 0);
							}
							else if (bParam2 >= 227 && bParam2 <= 242)
							{
								bVar30 = (176 + Global_76434[1 /*14*/].f_4);
								func_136(iParam0, 3, bVar30, 1, 0);
							}
							break;
						case 11:
							...
							{
								bVar30 = (25 + Global_76434[1 /*14*/].f_4);
								func_136(iParam0, 11, bVar30, 1, 0);
							}
							else if (bParam2 >= 25 && bParam2 <= 40)
							{
								bVar30 = (9 + Global_76434[1 /*14*/].f_4);
								func_136(iParam0, 11, bVar30, 1, 0);
							}
							break;
						case 8:
							if (bParam2 >= 27 && bParam2 <= 42)
							{
								bVar30 = (43 + Global_76434[1 /*14*/].f_4);
								func_136(iParam0, 8, bVar30, 1, 0);
								bVar30 = (59 + Global_76434[1 /*14*/].f_4);
								func_136(iParam0, 8, bVar30, 1, 0);
							}
							else if (bParam2 >= 43 && bParam2 <= 58)
							{
								bVar30 = (27 + Global_76434[1 /*14*/].f_4);
								func_136(iParam0, 8, bVar30, 1, 0);
								bVar30 = (59 + Global_76434[1 /*14*/].f_4);
								func_136(iParam0, 8, bVar30, 1, 0);
							}
							else if (bParam2 >= 59 && bParam2 <= 74)
							{
								bVar30 = (27 + Global_76434[1 /*14*/].f_4);
								func_136(iParam0, 8, bVar30, 1, 0);
								bVar30 = (43 + Global_76434[1 /*14*/].f_4);
							...
							break;
						case 14:
							if (bParam2 >= 64 && bParam2 <= 79)
							{
								bVar30 = (41 + Global_76434[1 /*14*/].f_4);
								func_136(iParam0, 14, bVar30, 1, 0);
							}
							break;
					}
					break;
				case joaat("PLAYER_TWO"):
					...
					{
						case 4:
							if (bParam2 >= 81 && bParam2 <= 90)
							{
								bVar30 = (94 + Global_76434[1 /*14*/].f_4);
								func_136(iParam0, 4, bVar30, 1, 0);
							}
							break;
						case 12:
							if (bParam2 == 2)
...
void func_185()
{
	...
	if (Global_111638.f_10044.f_105 < 240)
	{
		...
		else if (!func_47(PLAYER::PLAYER_PED_ID(), 12, bLocal_47))
		{
			Global_111638.f_10044.f_105 = 0;
			iLocal_50 = 1;
			iLocal_222 = 2;

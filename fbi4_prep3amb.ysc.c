	...
	if (iLocal_40 == 0)
	{
		switch (iLocal_41)
		{
			...
			case 3:
				...
				{
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_109, 1);
				}
		...
		if (!func_77(0f, 0f, 0f, vLocal_110, 0))
		{
			if (func_76(PLAYER::PLAYER_PED_ID(), vLocal_110, 100f) && !func_75())
			{
				if (func_85(func_74(25)))
				{
					...
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_109, true, true);
					if (func_85(bLocal_109))
					{
						if (!DECORATOR::DECOR_EXIST_ON(bLocal_109, "GetawayVehicleValid"))
						{
							if (DECORATOR::DECOR_SET_BOOL(bLocal_109, "GetawayVehicleValid", true))
							{
							}
						}
	...
	else
	{
		if (!func_77(0f, 0f, 0f, vLocal_110, 0))
		{
			if (!func_76(PLAYER::PLAYER_PED_ID(), vLocal_110, 100f))
			{
				if (func_85(bLocal_109))
				{
					if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), bLocal_109, false))
					{
						func_21(bLocal_109, vLocal_110, fLocal_113, 25, 1);
						MISC::CLEAR_BIT(&iLocal_105, 2);
						VEHICLE::SET_VEHICLE_HAS_BEEN_DRIVEN_FLAG(bLocal_109, false);
						func_20(&bLocal_109);
...
void func_18()
{
	if (MISC::IS_BIT_SET(iLocal_105, 2) && MISC::IS_BIT_SET(iLocal_105, 0))
	{
		if (func_85(bLocal_109))
		{
			if (func_19(PLAYER::PLAYER_PED_ID(), bLocal_109, 10f, 1))
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(bLocal_109, true), vLocal_110) >= 100f)
				{
					func_68(0);
				}
			}
...
bool func_19(int iParam0, bool bParam1, float fParam2, bool bParam3)
{
...
void func_21(bool bParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(bParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false))
	{
		...
		func_56(iParam5, &Var0, vParam1, fParam4, func_61(bParam0));
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(bParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(bParam0, false)) || func_39(bParam0, 0, 0)) || func_39(bParam0, 1, 0)) || func_39(bParam0, 2, 0)) || func_61(bParam0) != 145) || func_38(bParam0)) || func_37(bParam0)) || func_36(bParam0)) || func_35(bParam0)) || !func_25(ENTITY::GET_ENTITY_MODEL(bParam0)))
	{
		if (func_37(bParam0))
		{
		}
...
void func_139()
{
	...
	if (func_170())
	{
		if (func_140(&iVar0))
		{
			...
			if (func_85(bLocal_109))
			{
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(bLocal_109, 2);
			}
			func_78(iVar0, 0);
		}
	}
...
void func_171()
{
	if (!MISC::IS_BIT_SET(iLocal_105, 6))
	{
		if (func_85(bLocal_109))
		{
			vLocal_110 = { ENTITY::GET_ENTITY_COORDS(bLocal_109, true) };
			fLocal_113 = ENTITY::GET_ENTITY_HEADING(bLocal_109);
...
{
	if (!DECORATOR::DECOR_EXIST_ON(bParam0, "IgnoredByQuickSave"))
	{
		...
		if (iLocal_38 == 0)
		{
					...
					if (MISC::IS_BIT_SET(iLocal_105, 20) || func_133())
					{
						if ((func_249(PLAYER::PLAYER_PED_ID()) && !MISC::IS_BIT_SET(uLocal_101[0], 17)) && !MISC::IS_BIT_SET(uLocal_101[1], 18))
						{
							if (PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()))
							{
								...
								if (MISC::IS_BIT_SET(iLocal_105, 0))
								{
									if (!func_205() && func_185(ENTITY::GET_ENTITY_COORDS(bLocal_109, true)))
									{
			...
			else if (MISC::IS_BIT_SET(iLocal_105, 0))
			{
				...
				else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_85(bLocal_109))
					{
						if (PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false) != bLocal_109)
						{
							func_1(46, 0);
							func_177(0);
							func_176();
...
bool func_181(bool bParam0)
{
	...
	if (!VEHICLE::_0x639431E895B9AA57(PLAYER::PLAYER_PED_ID(), bParam0, -1, false, false) && !VEHICLE::_0x639431E895B9AA57(PLAYER::PLAYER_PED_ID(), bParam0, false, false, false))
	{
		func_69(37);
		return false;
	}
	...
	vVar0 = { ENTITY::GET_ENTITY_ROTATION(bParam0, 2) };
...
bool func_182(bool bParam0)
{
	...
	if (bParam0 != 0)
	{
		if (func_85(bParam0))
		{
			MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(bParam0), &vVar1, &vVar4);
			vVar1 = { vVar1 + Vector(-1f, -1f, -2f) };
			vVar4 = { vVar4 + Vector(1f, 1f, 2f) };
			if (!MISC::IS_AREA_OCCUPIED(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(bParam0, vVar1), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(bParam0, vVar4), false, true, false, false, false, bParam0, false))
			{
				iVar0++;
			}
			else if (func_13())
			...
			if (iVar0 == 2)
			{
				if (func_183(ENTITY::GET_ENTITY_COORDS(bParam0, true)))
				{
					return true;
				}
			}
		...
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!MISC::IS_BIT_SET(iLocal_105, 0))
			{
					...
					if (!func_219())
					{
						if (!MISC::IS_BIT_SET(iLocal_105, 7))
						{
							...
							if (func_85(bVar0))
							{
								if (!func_218(bVar0))
								{
									if (!DECORATOR::DECOR_EXIST_ON(bVar0, "Getaway_Winched"))
									{
				...
				else if (MISC::IS_BIT_SET(iLocal_105, 8))
				{
					...
					if (func_85(bVar1))
					{
						if (func_19(PLAYER::PLAYER_PED_ID(), bVar1, 10f, 1) && !DECORATOR::DECOR_EXIST_ON(bVar1, "Getaway_Winched"))
						{
							bLocal_109 = bVar1;
							ENTITY::SET_ENTITY_AS_MISSION_ENTITY(bLocal_109, true, true);
							MISC::SET_BIT(&iLocal_105, 0);
			...
			{
				if (!func_19(PLAYER::PLAYER_PED_ID(), bLocal_109, 80f, 1))
				{
					if (!DECORATOR::DECOR_EXIST_ON(bLocal_109, "Getaway_Winched"))
					{
				...
				{
					if (DECORATOR::DECOR_SET_BOOL(bLocal_109, "GetawayVehicleValid", false))
					{
					}
					func_206(17, 46);
					func_206(18, 46);
...
{
	if (DECORATOR::DECOR_EXIST_ON(bParam0, "GetawayVehicleValid"))
	{
	...
	if (func_249(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_85(bVar0))
		{
			...
			if ((iVar1 == joaat("CARGOBOB") || iVar1 == joaat("CARGOBOB2")) || iVar1 == joaat("CARGOBOB3"))
			{
				...
				{
					iVar2 = VEHICLE::GET_VEHICLE_ATTACHED_TO_CARGOBOB(bVar0);

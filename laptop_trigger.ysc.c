	...
	while (bVar28)
	{
		...
		if (((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && ENTITY::DOES_ENTITY_EXIST(iLocal_127)) && !CUTSCENE::IS_CUTSCENE_PLAYING()) && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
		{
			if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_127))
			{
				...
				if (((((((((((((((((!bVar36 && !Global_31037) && !func_221(0)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false)) && !func_220()) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar29, vVar39, false, true, 1)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_127)) && !MISC::IS_BIT_SET(Global_2359302, 15)) && !func_219()) && !(Global_76622 && func_218())) && !(!Global_76622 && func_217())) && !((Global_76622 && MISC::IS_BIT_SET(Global_4456448.f_14, 24)) && NETWORK::NETWORK_IS_ACTIVITY_SESSION())) && !((Global_76622 && func_216()) && func_215())) && !(Global_76622 && func_213(PLAYER::PLAYER_ID()) == 5)) && !NETWORK::NETWORK_SET_IN_MP_CUTSCENE()) && !Global_75434) && !func_210()) && (!func_223() || func_209(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_127), 90f)))
				{
		...
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_4(2, &uVar0))
				{
					if (iLocal_128 != 0)
					{
						if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_129))
						{
							PED::DETACH_SYNCHRONIZED_SCENE(fLocal_129);
							fLocal_129 = -1;
						}
						fLocal_129 = NETWORK::_0x77758139EC9B66C7(vLocal_133, ENTITY::GET_ENTITY_ROTATION(iLocal_127, 2), 2, false, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
						NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_129, &uVar0, "exit", 8f, -4f, 5, 0, 1148846080 /* Float: 1000f */, 0);
						NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_129);
						STREAMING::REMOVE_ANIM_DICT(&uVar0);
					}
				}
			}
...
int func_32(bool bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)
{
	...
	if (func_34(bParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		...
		{
			Global_8063 = iParam6;
			Global_7966[3 /*6*/] = { func_33(bParam0) };
			Global_8043 = bParam0;
...
bool func_47(struct<6> Param0, struct<6> Param6)
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
void func_152()
{
	if (MISC::IS_PC_VERSION())
	{
		...
		if (func_84(1))
		{
			HUD::_OVERRIDE_MULTIPLAYER_CHAT_PREFIX(1253452001 /* GXTEntry: "MOTORCYCLE CLUB" */);
		}
		else
		{
			HUD::_OVERRIDE_MULTIPLAYER_CHAT_PREFIX(-1755491431 /* GXTEntry: "ORGANIZATION" */);
		}
	}
}
...
int func_164(bool bParam0)
{
	...
	if (func_7(bParam0, 0, 1))
	{
		...
		iVar1 = ((iVar0 + func_165()) - NETWORK::_0xF12E6CD06C73D69E());
		return iVar1;
	}
	return -1;
}
...
void func_171(int iParam0)
{
	...
	switch (iLocal_128)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&uVar0))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 2106541073) == 7 && STREAMING::HAS_ANIM_DICT_LOADED(&uVar0))
				{
					...
					fLocal_129 = NETWORK::_0x77758139EC9B66C7(vLocal_133, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
					NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_129, &uVar0, "enter", 4f, -2f, 5, 0, 1148846080 /* Float: 1000f */, 0);
					NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_129);
					STREAMING::REMOVE_ANIM_DICT(&uVar0);
					iLocal_128 = 1;
				}
		...
		case 1:
			...
			fVar50 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(fLocal_129);
			if (!bLocal_120)
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fVar50) >= 0.93f)
				{
					AUDIO::PLAY_SOUND_FRONTEND(-1, "Login", "GTAO_Exec_SecuroServ_Warehouse_PC_Sounds", true);
					bLocal_120 = true;
				}
			}
			if (STREAMING::HAS_ANIM_DICT_LOADED(&uVar16) && (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(fVar50) || PED::GET_SYNCHRONIZED_SCENE_PHASE(fVar50) >= 0.96f))
			{
				...
				fLocal_129 = NETWORK::_0x77758139EC9B66C7(vLocal_133, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, true, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				switch (iVar51)
				{
					case 0:
						NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_129, &uVar16, "idle_a", 4f, -2f, 5, 0, 1148846080 /* Float: 1000f */, 0);
						NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_129);
						StringCopy(&cLocal_136, "idle_a", 16);
						iLocal_128 = 3;
						break;
					case 1:
						NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_129, &uVar16, "idle_b", 4f, -2f, 5, 0, 1148846080 /* Float: 1000f */, 0);
						NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_129);
						StringCopy(&cLocal_136, "idle_b", 16);
						iLocal_128 = 3;
						break;
					case 2:
						NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_129, &uVar16, "idle_c", 4f, -2f, 5, 0, 1148846080 /* Float: 1000f */, 0);
						NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_129);
						StringCopy(&cLocal_136, "idle_c", 16);
						iLocal_128 = 3;
						break;
					case 3:
						NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_129, &uVar16, "idle_d", 4f, -2f, 5, 0, 1148846080 /* Float: 1000f */, 0);
						NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_129);
		...
		case 3:
			...
			fVar50 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(fLocal_129);
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_129) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(fVar50))
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_129))
				{
					PED::DETACH_SYNCHRONIZED_SCENE(fLocal_129);
				...
				fLocal_129 = NETWORK::_0x77758139EC9B66C7(vLocal_133, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, true, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				fVar50 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(fLocal_129);
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fVar50))
				{
					PED::SET_SYNCHRONIZED_SCENE_PHASE(fVar50, 0f);
				}
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_129, &uVar16, sVar48, 4f, -2f, 5, 0, 1148846080 /* Float: 1000f */, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(fLocal_129);
				iLocal_128 = 3;
				return;
			}
			if (STREAMING::HAS_ANIM_DICT_LOADED(&uVar16) && (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(fVar50) || PED::GET_SYNCHRONIZED_SCENE_PHASE(fVar50) >= 0.99f))
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_129))
				{
					PED::DETACH_SYNCHRONIZED_SCENE(fLocal_129);
...
{
	if (((func_176() && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676237)
	{
...
{
	if ((((func_206(PLAYER::PLAYER_ID()) && func_193(PLAYER::PLAYER_ID()) == func_192(PLAYER::PLAYER_ID())) && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676237)
	{
		if (func_190())
		{
...
{
	if (((((func_205(PLAYER::PLAYER_ID()) || func_177()) && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676237) && func_209(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_127), 90f))
	{
		if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		{
			func_189("WHSECUROBLCK");
...
{
	if (((func_178() && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE(PLAYER::PLAYER_ID())) && !func_183()) && !Global_1676237)
	{
		if (func_190())
		{
			func_189("WHPRIVSESLAP");
...
bool func_209(float fParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
...
bool func_234(var uParam0, int iParam1, bool bParam2)
{
	if (iParam1 == -1)
	{
		return true;

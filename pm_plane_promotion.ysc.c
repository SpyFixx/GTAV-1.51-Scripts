...
bool func_28(bool bParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_30(int* iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, bool bParam10, char* sParam11, char* sParam12, char* sParam13, int iParam14, char* sParam15, int iParam16, bool bParam17, bool bParam18, bool bParam19)
{
	return func_31(iParam0, vParam1, func_75(), vParam4, vParam7, sParam11, 5, 0, 0, 0, sParam12, sParam13, func_74(), func_74(), func_74(), func_74(), iParam14, 0, iParam16, sParam15, 1, bParam17, bParam18, bParam19, func_74(), func_74(), func_74(), 1, bParam10);
}

int func_31(int* iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, bool bParam13, bool bParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24, bool bParam25, bool bParam26, bool bParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, bool bParam32, bool bParam33, bool bParam34, bool bParam35, bool bParam36)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	func_72(iParam0);
	func_71();
	if (func_54(iParam0, iParam0->f_17[0], iParam0->f_17[1], iParam0->f_17[2], bParam20, bParam21, bParam22, bParam23, iParam0->f_8, bParam25, iParam18, 0, 0, bParam32, bParam33, bParam34, bParam14, bParam26))
	{
		func_53(bParam20);
		func_53(bParam21);
		func_53(bParam22);
...
bool func_54(int* iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!MISC::IS_BIT_SET(iParam0->f_13, 26))
	{
		if ((!func_67(iParam0) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) && !ENTITY::DOES_ENTITY_EXIST(iParam10))
		{
		...
		while (iVar0 < 3)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_17[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iParam0->f_17[iVar0]))
				{
					...
					if ((!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar0], func_40()) && !func_61(iParam0->f_17[iVar0], iParam10)) && !func_60(iParam0->f_17[iVar0], iParam10))
					{
					...
					{
						if (((func_38(iParam0->f_17[iVar0], 1) || func_61(iParam0->f_17[iVar0], iParam10)) || bParam12) || (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam10, false) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, false)))
						{
							if (HUD::DOES_BLIP_EXIST(iParam0->f_1[iVar0]))
							{
						...
						if (!PED::IS_PED_SITTING_IN_VEHICLE(iParam0->f_17[iVar0], iParam10))
						{
							if ((ENTITY::IS_ENTITY_AT_ENTITY(iParam0->f_17[iVar0], iParam10, 20f, 20f, 5f, false, true, 0) && !MISC::IS_BIT_SET(iParam0->f_13, 11)) && !((bParam17 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, false)))
							{
								...
								else
								{
									...
									iVar14 = TASK::GET_SCRIPT_TASK_STATUS(iParam0->f_17[iVar0], -1794415470);
									if (iVar14 == 7 && !func_70(iParam0->f_17[iVar0], iParam10))
									{
										if (((((!PED::IS_PED_JUMPING_OUT_OF_VEHICLE(iParam0->f_17[iVar0]) && !PED::IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER::PLAYER_PED_ID())) && !func_59(iParam0->f_17[iVar0], 2f)) && !PED::IS_PED_RAGDOLL(iParam0->f_17[iVar0])) && !TASK::IS_PED_GETTING_UP(iParam0->f_17[iVar0])) && !FIRE::IS_ENTITY_ON_FIRE(iParam10))
										{
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iParam0->f_17[iVar0], true);

...
int func_6(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
void func_21()
{
	switch (iLocal_43)
	{
		...
		case 1:
			...
			{
				if (func_23(&Local_44, &Local_57) || bLocal_620)
				{
					iLocal_43 = 2;
				}
...
bool func_27(int iParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_40(var uParam0, int iParam1, vector3 vParam2)
{
	bool bVar0;
	...
	if ((iParam1[bVar0 /*11*/])->f_10)
	{
		...
		{
			if (UNK_0xEB751B41BC4080D4((iParam1[bVar0 /*11*/])->f_1) || func_55((iParam1[bVar0 /*11*/])->f_1))
			{
				func_42(uParam0, iParam1, bVar0);
				return true;
			}
		}
	}
	...
	{
		if ((SYSTEM::VDIST2(vParam2, UNK_0xE925E52ACABA4CE7((iParam1[bVar0 /*11*/])->f_1)) > (60f * 60f) || func_60(13)) || func_60(14))
		{
			func_41(&((iParam1[bVar0 /*11*/])->f_1));
...
void func_42(var uParam0, int iParam1, bool bParam2)
{
	...
	func_41(&((iParam1[bParam2 /*11*/])->f_1));
	func_54(&((iParam1[bParam2 /*11*/])->f_2));
...
void func_46()
{
	...
	bVar3 = false;
	UNK_0x6FB46C25CCB7E6D5(func_48(0), &bVar0, -1);
	iVar1 = (iVar1 + bVar0);
	if (bVar0 > 0)
	{
		func_47(18, bVar0);
	}
	UNK_0x6FB46C25CCB7E6D5(func_48(1), &bVar0, -1);
	iVar1 = (iVar1 + bVar0);
	if (bVar0 > 0)
	{
		func_47(19, bVar0);
	}
	UNK_0x6FB46C25CCB7E6D5(func_48(3), &bVar0, -1);
	iVar1 = (iVar1 + bVar0);
	if (bVar0 > 0)
	{
		func_47(20, bVar0);
...
void func_49(var uParam0)
{
	...
	{
		if (func_59(uParam0, bVar0))
		{
			iVar1++;
			func_50((uParam0->f_2 + bVar0), 1, -1, 1);
			if (bLocal_40)
			{
			}
		}
...
void func_57(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	bool bVar0;
...
bool func_59(var uParam0, bool bParam1)
{
	if (bParam1 < 0 || bParam1 >= 64)
	{
		return false;
...
void func_62(bool bParam0, int iParam1, int iParam2)
{
	...
	*bParam0 = 0;
	...
	{
		if (func_27((bParam0->f_2 + bVar0), -1, -1))
		{
			iVar1++;
			func_53(bParam0, bVar0, 1);
			if (bLocal_40)
			{
			}
		}

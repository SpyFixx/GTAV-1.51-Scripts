...
void func_184(int iParam0, bool bParam1, vector3 vParam2)
{
	if (UNK_0xE1DBBD6CE209517C(UNK_0xD803B885F5E47A62()))
	{
	...
	if (func_127(bParam0))
	{
		switch (uParam1->f_3)
		{
			case 1:
				...
				break;
			case 2:
				if (!func_196(uParam1) || !UNK_0xB4ECF989E2C1DAC8(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_195(iParam2) && !UNK_0x7069CC4DE1EA3FAA(bParam0, UNK_0x16F2683693E537C9(), 25f))
					{
						UNK_0xF96A174EE26D7588(bParam0, UNK_0x16F2683693E537C9(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_196(uParam1) && uParam1->f_4 == 0) && UNK_0x0EB28750412C3A5A(UNK_0x68F4C0EC296D3901(UNK_0x16F2683693E537C9(), true), UNK_0x68F4C0EC296D3901(bParam0, true), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 3:
				...
				break;
			case 5:
				if (!func_195(iParam2) || UNK_0x7069CC4DE1EA3FAA(bParam0, UNK_0x16F2683693E537C9(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						UNK_0xC6EB89C59F2AF6B8(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, false, 0, 0, 0);
...
bool func_201(var uParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
bool func_203(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_205(bool bParam0, float fParam1)
{
	...
	{
		if (func_216(bParam0) || UNK_0x292E02BF8ABF889C(UNK_0xD803B885F5E47A62(), bParam0))
		{
...
{
	return func_207(bParam0, UNK_0x16F2683693E537C9(), fParam1, 1, 250, 7);
}

bool func_207(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;

	iVar4 = func_215(bParam0, bParam1);
	...
	if (!func_211(bParam0, bParam1, fParam2, iParam3))
	{
		return false;
	}
	if (iVar4 == -1)
	...
	bVar0 = func_208(&(Local_37[iVar4 /*4*/]), vVar1, bParam1, &(Local_37[iVar4 /*4*/].f_3), bParam0, iParam5);
	return (bVar0 || (UNK_0x1C0640BA9A7327B3() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_208(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_209(bParam4, iParam7) };
...
Vector3 func_209(bool bParam0, int iParam1)
{
	int iVar0;
...
bool func_211(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_213(UNK_0x68F4C0EC296D3901(bParam1, true) - UNK_0x68F4C0EC296D3901(bParam0, true)) };
	...
	{
		vVar3 = { func_213(UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 5f, 0f) - UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_217(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	bool bVar1;
	int iVar2;
	...
	if (func_127(UNK_0x16F2683693E537C9()) && func_127(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_221(bParam0, bParam1, fVar0, bVar1))
			{
				return true;
			}
			if (func_218(bParam0, bVar1, bParam3, bParam4))
			{
				return true;
			}
		}
...
bool func_218(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_219(bool bParam0, bool bParam1)
{
	...
	{
		if (func_220(bParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_220(bool bParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_213(vParam1 - UNK_0x68F4C0EC296D3901(bParam0, true)) };
...
bool func_221(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
	if (bParam1)
	{
		if (UNK_0x168558745A6AC21E(UNK_0x16F2683693E537C9()))
...
bool func_232(int iParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 3:
			...
			{
				iParam0->f_59 = UNK_0xE9744DB7B8CA6965(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				UNK_0xC90224D9E95E5E3A(iParam0->f_59, true);
				UNK_0xEFC3DF9D33E248D8(iParam0->f_59, false);
				UNK_0x915804B434753CBD(iParam0->f_28[0], iParam0->f_59, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar6 += 512;
				iVar6 += 4096;
				UNK_0xE14EC663EED44AD5(iParam0->f_41[0], iParam0->f_59, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar6, 1148846080 /* Float: 1000f */);
			}
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
...
bool func_233(bool bParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	if (func_234(bParam0, iParam1, vParam2, fParam5, 1))
	{
		if (UNK_0xC844350D5D58C99A(*bParam0))
		{
			if (!UNK_0x437347B10A200C4B(*bParam0, 0))
...
bool func_234(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6)
{
	bool bVar0;

	if (!func_36(iParam1))
	{
		bVar0 = func_239(iParam1);
...
void func_236(bool bParam0, bool bParam1, vector3 vParam2, bool bParam5)
{
	func_199(bParam0);
...
bool func_250(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
...
bool func_251(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
...
bool func_252(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_267(int iParam0)
{
	if (UNK_0x69DF961355195C3C(iParam0->f_59))
	{
		...
		{
			UNK_0x1BF8B16C32704027(iParam0->f_41[0], -1000f, 1);
		}
	}
}

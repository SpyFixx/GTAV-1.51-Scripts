	...
	if ((UNK_0x1C0640BA9A7327B3() - iLocal_98) > 1250)
	{
		if (func_127(iParam0->f_28[0]) && !UNK_0x0A059E0DB9253280(iParam0->f_28[0]))
		{
			if (func_127(UNK_0x16F2683693E537C9()) && !func_185(UNK_0x16F2683693E537C9(), iParam0->f_28[0], 50f, 1))
			{
				...
				if (fVar8 != 0f)
				{
					bVar6 = UNK_0x5D8ABF6396A76564(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					bVar6 = -90f;
				...
				UNK_0xD8F6A53F4799FAFE(iParam0->f_28[0], bVar6);
			}
		}
...
bool func_185(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
...
void func_186()
{
	...
	if ((UNK_0x1C0640BA9A7327B3() - iLocal_98) > 1250)
	{
		UNK_0xEB819BD1E585E9CB(iLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", false, 0, 0);
		iLocal_98 = UNK_0x1C0640BA9A7327B3();
	}
}

int func_187(int iParam0, vector3 vParam1, char[4] cParam4, bool bParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
...
void func_195(int iParam0, bool bParam1, vector3 vParam2)
{
	if (UNK_0xE1DBBD6CE209517C(UNK_0xD803B885F5E47A62()))
	{
	...
	if (func_127(bParam0))
	{
		switch (uParam1->f_3)
		{
			case 1:
				...
				break;
			case 2:
				if (!func_206(uParam1) || !UNK_0xB4ECF989E2C1DAC8(bParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_205(iParam2) && !UNK_0x7069CC4DE1EA3FAA(bParam0, UNK_0x16F2683693E537C9(), 25f))
					{
						UNK_0xF96A174EE26D7588(bParam0, UNK_0x16F2683693E537C9(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && UNK_0x0EB28750412C3A5A(UNK_0x68F4C0EC296D3901(UNK_0x16F2683693E537C9(), true), UNK_0x68F4C0EC296D3901(bParam0, true), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 3:
				...
				break;
			case 5:
				if (!func_205(iParam2) || UNK_0x7069CC4DE1EA3FAA(bParam0, UNK_0x16F2683693E537C9(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						UNK_0xC6EB89C59F2AF6B8(bParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, false, 0, 0, 0);
			...
			if (UNK_0xC844350D5D58C99A(iParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*iParam0 == 16)
						{
							if (func_212(UNK_0x16F2683693E537C9(), iParam0->f_35[iVar0]))
							{
...
bool func_215(bool bParam0, float fParam1)
{
	...
	{
		if (func_226(bParam0) || UNK_0x292E02BF8ABF889C(UNK_0xD803B885F5E47A62(), bParam0))
		{
...
{
	return func_217(bParam0, UNK_0x16F2683693E537C9(), fParam1, 1, 250, 7);
}

bool func_217(bool bParam0, bool bParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;

	iVar4 = func_225(bParam0, bParam1);
	...
	bVar0 = func_218(&(Local_37[iVar4 /*4*/]), vVar1, bParam1, &(Local_37[iVar4 /*4*/].f_3), bParam0, iParam5);
	return (bVar0 || (UNK_0x1C0640BA9A7327B3() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_218(var uParam0, vector3 vParam1, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_219(bParam4, iParam7) };
...
Vector3 func_219(bool bParam0, int iParam1)
{
	int iVar0;
...
bool func_221(bool bParam0, bool bParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_223(UNK_0x68F4C0EC296D3901(bParam1, true) - UNK_0x68F4C0EC296D3901(bParam0, true)) };
	...
	{
		vVar3 = { func_223(UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 5f, 0f) - UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_227(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	bool bVar1;
	int iVar2;
	...
	if (func_127(UNK_0x16F2683693E537C9()) && func_127(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_231(bParam0, bParam1, fVar0, bVar1))
			{
				return true;
			}
			if (func_228(bParam0, bVar1, bParam3, bParam4))
			{
				return true;
			}
		}
...
bool func_228(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_229(bool bParam0, bool bParam1)
{
	...
	{
		if (func_230(bParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_230(bool bParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_223(vParam1 - UNK_0x68F4C0EC296D3901(bParam0, true)) };
...
bool func_231(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
	if (bParam1)
	{
		if (UNK_0x168558745A6AC21E(UNK_0x16F2683693E537C9()))
...
void func_245(bool bParam0, bool bParam1, vector3 vParam2, bool bParam5)
{
	func_246(bParam0);
...
bool func_253(int iParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				iParam0->f_41[0] = UNK_0x7707E48765093646(iVar0[1], 2468.51f, 3437.39f, 55f, true, true, false);
			}
			if (!UNK_0xC844350D5D58C99A(iParam0->f_41[1]))
			{
				iParam0->f_41[1] = UNK_0x7707E48765093646(iVar0[2], 2468.51f, 3437.39f, 57f, true, true, false);
			}
			if ((func_127(iParam0->f_28[0]) && UNK_0xC844350D5D58C99A(iParam0->f_41[0])) && UNK_0xC844350D5D58C99A(iParam0->f_41[1]))
			{
				UNK_0x9F528B1B53FBC5D9(iParam0->f_41[0], iParam0->f_28[0], UNK_0x4A089F2B762B8D33(iParam0->f_28[0], 18905), 0.09f, 0.072f, -0.006f, 298f, 194f, 178f, 0, 0, 0, 0, 2, 1);
				UNK_0x9F528B1B53FBC5D9(iParam0->f_41[1], iParam0->f_28[0], UNK_0x4A089F2B762B8D33(iParam0->f_28[0], 64729), 0.1f, 0.08f, 0f, 162.72f, 5.4f, 1.8f, 0, 0, 0, 0, 2, 1);
			}
			else
			{
				bVar5 = false;
...
bool func_264(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
...
bool func_265(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	struct<7> Var1;
...
bool func_266(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;

...
void func_12(vector3 vParam0, vector3 vParam3, var uParam6, var uParam7, var uParam8)
{
	vector3 vVar0;

	vVar0 = { vParam3 - vParam0 };
	func_13(vVar0, uParam6, uParam7, uParam8);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, var uParam12, int iParam13, float fParam14, bool bParam15)
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam4 };
	uParam0->f_7 = iParam7;
...
void func_34(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11, int iParam12, float fParam13, float fParam14, int iParam15)
{
	func_35(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, fParam13, fParam14, iParam15);
}
...
bool func_46(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool func_67(int iParam0, bool bParam1, int iParam2, bool bParam3, var uParam4, var uParam5)
{
	var uVar0;
	int iVar10;
...
bool func_74(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
...
bool func_75(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
bool func_78(int iParam0, bool bParam1, int iParam2)
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_83(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else if (iParam2 == 14)
	{
		...
		iVar18 = 0;
		iVar19 = (bParam1 - func_85(iParam0));
		if (iVar19 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar39 = 0;
		iVar40 = (bParam1 - func_84(iParam0, func_71(iParam2)));
		if (iVar40 < 0)
		{
			return -1;
		}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_176(iParam0, iVar2, uVar5[iVar2]))
				{
							...
							if (!func_176(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (bVar4 <= 19)
								{
									...
									if (Global_76434[2 /*14*/].f_12 == iVar3)
									{
										...
										{
											if (!func_67(iVar0, bParam2, 14, bVar4, &uVar5, &(Global_76434[2 /*14*/])))
											{
												return false;
											}
										}
					...
					else
					{
						...
						if (!func_67(iVar0, bParam2, iVar2, bVar1, &uVar5, &(Global_76434[2 /*14*/])))
						{
							return false;
						}
					}

...
void __EntryFunction__()
{
	...
	if (UNK_0xC844350D5D58C99A(bLocal_179))
	{
	}
	func_318();
	if (!func_335())
...
void func_1()
{
	switch (iLocal_147)
	{
		case 0:
			...
			if (UNK_0xEA6BC48857E0AC4C(bLocal_168))
			{
				func_351(1);
			}
			else
...
void func_8()
{
	switch (iLocal_149)
	{
		case 0:
			...
			break;
		case 1:
			if (UNK_0xC844350D5D58C99A(bLocal_178))
			{
				if (!UNK_0x437347B10A200C4B(bLocal_178, 0))
				{
					if (func_316(UNK_0x16F2683693E537C9(), bLocal_178, 1f, 1))
					{
						UNK_0x262EF6C6306BEA6C(UNK_0x16F2683693E537C9(), joaat("GADGET_PARACHUTE"), true, false, false);
						UNK_0xF690C84DADBB3551(&bLocal_178);
					}
				}
			}
			if (iLocal_347 == 0)
...
bool func_50(bool bParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	else if (iParam4 == 6)
	{
		if (iParam2 == 4)
		{
			if (func_55(iParam1, bParam3, &bVar0))
			{
			}
		}
	}
...
void func_229()
{
	...
	while (UNK_0x1C0640BA9A7327B3() < iLocal_374 + 11000 && !UNK_0x757EF87A33649210())
	{
		...
		else if (UNK_0x69DF961355195C3C(iLocal_373) && UNK_0xA45992A6CE82FB43(iLocal_373) >= 0.323f)
		{
			...
			else if (!bLocal_382)
			{
				...
				{
					iLocal_180 = UNK_0xB055A4268B938F30("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, false);
	...
	if (func_317(Local_155))
	{
		if (iVar0 < 3)
		{
			UNK_0xD458AC1C1D29C3B4(Local_155, 101, false);
			vVar4 = { UNK_0x68F4C0EC296D3901(Local_155, true) };
			if (vVar4.z > 155f)
			{
				fVar7 = 155f;
			}
			...
			UNK_0xA47B46945FF6DE74(Local_155, 1657.046f, -17.4571f, fVar7, 1, 0, 0, 1);
		}
	}
	...
	if (func_228(Local_155))
	{
		...
		UNK_0xF895E10BF4C72645(Local_155, 0, 0);
		UNK_0xA47B46945FF6DE74(Local_155, 1655.77f, -20.04f, 135.8f, 1, 0, 0, 1);
		UNK_0xD458AC1C1D29C3B4(Local_155, false, false);
	}
	func_230(&uLocal_182, 1, UNK_0x16F2683693E537C9(), "FRANKLIN", 0, 1);
	func_211(&uLocal_182, "EXT4AUD", "EXT4_DUMB", 7, 0, 0, 0);
}

void func_230(var uParam0, int iParam1, bool bParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_232(bool bParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5)
{
	if (bParam0)
	{
...
int func_238(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
void func_245()
{
	...
	switch (iLocal_149)
	{
		case 0:
			...
			{
				UNK_0x7656EB524FEAB9B3("Dom", 8, 2, false, false);
			}
			if (!func_266())
			{
				if (func_260(1, 20f, 1))
				{
					if ((!bLocal_383 || UNK_0x1C0640BA9A7327B3() > iLocal_384 + 3000) || UNK_0x5A91F08DF773C39D(UNK_0x16F2683693E537C9(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, false, true, 0))
					{
						UNK_0x420FE818E70BB523(1);
						UNK_0x4C902758BEA97C68(2048);
						if (func_317(Local_155))
						{
							UNK_0x29E8331978B73E7F(Local_155, "Dom", 0, joaat("CS_DOM"), 0);
						}
						SYSTEM::WAIT(0);
						bLocal_383 = false;
						...
						if (UNK_0xC844350D5D58C99A(bLocal_179) && !UNK_0x437347B10A200C4B(bLocal_179, 0))
						{
							UNK_0x4A4806F9D471E491(bLocal_179, false, 0);
						}
						if (UNK_0x405E212DDE472467(UNK_0x16F2683693E537C9(), 0))
						{
							bLocal_172 = UNK_0x6937EA2286828455(UNK_0x16F2683693E537C9(), 0);
							bLocal_181 = UNK_0x134B62B726CEC8E6(bLocal_172);
							if (UNK_0x8E39AC3C76C8AA58(bLocal_181) == 1 || UNK_0x7D8B2A8F9EA82DB7(bLocal_181) == 1)
							{
		...
		case 2:
			...
			if (UNK_0xC844350D5D58C99A(bLocal_179) && !UNK_0x437347B10A200C4B(bLocal_179, 0))
			{
				UNK_0x4A4806F9D471E491(bLocal_179, true, 0);
			}
			if (iLocal_151 == 0)
			{
...
void func_250(vector3 vParam0, bool bParam3)
{
	bool bVar0;
	...
	if (!UNK_0xEB6A8945D1AC98A1(UNK_0x16F2683693E537C9()))
	{
		...
		if (UNK_0xC844350D5D58C99A(bVar0))
		{
			...
			{
				UNK_0xA47B46945FF6DE74(bVar0, vParam0, 1, 0, 0, 1);
...
void func_251(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11, int iParam12, bool bParam13, float fParam14, int iParam15)
{
	func_252(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, bParam13, fParam14, iParam15);
}

void func_252(vector3 vParam0, vector3 vParam3, bool bParam6, vector3 vParam7, bool bParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (UNK_0xC844350D5D58C99A(bVar0))
	{
		...
		if (UNK_0xDF1306B443CD3D15(bVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_256(bVar0, vParam0, vParam3, bParam6))
					{
						bVar1 = true;
					}
				}
...
bool func_255(int iParam0, int iParam1, char* sParam2, int iParam3)
{
...
bool func_256(bool bParam0, vector3 vParam1, vector3 vParam4, bool bParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
bool func_260(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (UNK_0x405E212DDE472467(UNK_0x16F2683693E537C9(), 0))
	{
		...
		{
			if (!func_264(UNK_0x6937EA2286828455(UNK_0x16F2683693E537C9(), 0), fParam1, 1, 1056964608 /* Float: 0.5f */, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_264(bool bParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_267()
{
	...
	switch (iLocal_149)
	{
		case 0:
			...
			{
				UNK_0xAFF39FB306F8E232(Local_82.f_28[0], 17, true);
			}
			iLocal_368 = 0;
			bLocal_383 = true;
...
void func_268()
{
	if (func_317(Local_155))
	{
		...
		{
			UNK_0x78ADC381772E3D54(Local_155, iLocal_171);
		}
	}
}
...
void func_269()
{
	if (!func_266())
	{
		if (iLocal_368 < 5)
		{
			if (UNK_0x1C0640BA9A7327B3() > (iLocal_369 + (8000 + UNK_0x09AC81E49EA267F7(false, 2000))))
			{
	...
	if (!func_266())
	{
		if ((UNK_0xAE317D00A5A55DF6("EXTREME_04_DOM_A", 0, -1) && UNK_0xAE317D00A5A55DF6("EXTREME_04_DOM_B", 0, -1)) && UNK_0xAE317D00A5A55DF6("EXTREME_04_DOM_C", 0, -1))
		{
			if (UNK_0x8AA6DC470ABA63A2(iLocal_367))
			{
				UNK_0xCEAA091B490F8407(iLocal_367, "DOM", Local_155, "EXTREME_04_SOUNDSET", 0, 0);
			}
		}
	}
}
...
bool func_271(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_228(UNK_0x16F2683693E537C9()) && func_228(bParam0))
	{
		...
		if (!bParam2)
		{
			if (func_276(bParam0, bParam1, fVar0, fVar1))
			{
				return true;
			}
...
bool func_272(bool bParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
bool func_273(bool bParam0, float fParam1)
{
	var uVar0;
	vector3 vVar1;
	...
	{
		if (func_274(bParam0, vVar1, 90f, 0))
		{
			return true;
		}
	}
...
bool func_274(bool bParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = { func_258(vParam1 - UNK_0x68F4C0EC296D3901(bParam0, true)) };
	...
	{
		vVar3 = { func_258(UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 5f, 0f) - UNK_0x64430C979F516F7A(bParam0, 31086, 0f, 0f, 0f)) };
	}
...
bool func_276(bool bParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (UNK_0x168558745A6AC21E(UNK_0x16F2683693E537C9()))
...
int func_277(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
void func_281()
{
	...
	UNK_0x96167B03C5A77156(Local_82.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 1048576000 /* Float: 0.25f */, 0, 1193033728);
	UNK_0xCD7D80FD792F9954("WORLD_VEHICLE_BICYCLE_MOUNTAIN", false);
	UNK_0x28F5E4DA506AC0CA(Local_155.f_1, 20f, 0, 0, 0, 0, false, 0);
	if (!UNK_0xC844350D5D58C99A(bLocal_173))
	{
		bLocal_173 = UNK_0x122AAB0B1D6F55AD(joaat("SANCHEZ"), 1662.88f, -14.255f, 172.7742f, 205.3516f, true, true, false);
	}
	if (!UNK_0xC844350D5D58C99A(bLocal_174))
	{
		bLocal_174 = UNK_0x122AAB0B1D6F55AD(joaat("BMX"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, true, true, false);
	}
	if (!UNK_0xC844350D5D58C99A(bLocal_176))
	{
		bLocal_176 = UNK_0x7707E48765093646(joaat("PROP_BOX_WOOD01A"), 1666.282f, -11.20408f, 172.7773f, true, true, false);
		UNK_0xC023D1C4BF532815(bLocal_176, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!UNK_0xC844350D5D58C99A(bLocal_177))
	{
		bLocal_177 = UNK_0x7707E48765093646(joaat("PROP_BOX_WOOD01A"), 1667.076f, -12.07778f, 173.2611f, true, true, false);
		UNK_0xC023D1C4BF532815(bLocal_177, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_317(Local_155))
	{
		if (UNK_0xD1960163A3042274(Local_155, 242628503) != 1)
		{
			...
			UNK_0xC6EB89C59F2AF6B8(false, "rcmextreme4", "idle", 8f, -8f, -1, 0, false, 0, 0, 0);
			UNK_0xC6EB89C59F2AF6B8(false, "rcmextreme4", "idle", 8f, -8f, -1, 0, false, 0, 0, 0);
			UNK_0xC6EB89C59F2AF6B8(false, "rcmextreme4", "fidget_01", 8f, -8f, -1, 0, false, 0, 0, 0);
			UNK_0xC6EB89C59F2AF6B8(false, "rcmextreme4", "idle", 8f, -8f, -1, 0, false, 0, 0, 0);
			UNK_0xC6EB89C59F2AF6B8(false, "rcmextreme4", "idle", 8f, -8f, -1, 0, false, 0, 0, 0);
			UNK_0xC6EB89C59F2AF6B8(false, "rcmextreme4", "idle", 8f, -8f, -1, 0, false, 0, 0, 0);
			UNK_0xC6EB89C59F2AF6B8(false, "rcmextreme4", "fidget_02", 8f, -8f, -1, 0, false, 0, 0, 0);
			UNK_0x25644C31B4B6E9F3(iLocal_171, 1);
	...
	if (!UNK_0xC844350D5D58C99A(bLocal_179))
	{
		bLocal_179 = UNK_0xB8D1BBEFD1257857(joaat("PICKUP_PARACHUTE"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("P_PARACHUTE_S"), 1, 1);
	}
	UNK_0xC023D1C4BF532815(bLocal_179, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	UNK_0xD65E6E13E145467B(bLocal_179, "Chute_Off_Bag", "skydive@parachute@", 4f, false, true, 0, 0.99f, 0);
	func_246(1);
}

void func_282(bool bParam0, vector3 vParam1, float fParam4)
{
	func_283(bParam0, bLocal_81, vParam1, fParam4, 26);
	UNK_0x78ED16BE998AECC7(*bParam0);
	UNK_0xF4CB0B98F8F79D8D(*bParam0, 0);
	UNK_0x5F2AA9E2843E9403(*bParam0, "EXTREME LAUNCHER RC");
}

void func_283(bool bParam0, bool bParam1, vector3 vParam2, bool bParam5, int iParam6)
{
	func_284(bParam0);
...
bool func_285(bool bParam0, vector3 vParam1, bool bParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_291()
{
	switch (iLocal_150)
	{
		case 0:
			...
			{
				if (!bLocal_383 || UNK_0x1C0640BA9A7327B3() > iLocal_384 + 3500)
				{
					func_292();
					UNK_0x420FE818E70BB523(1);
...
bool func_293(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_296()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_335() && func_317(Local_82.f_28[0])) && func_317(UNK_0x16F2683693E537C9())) && bLocal_383 == 1)
	{
		if (!UNK_0x8C74DE122769E1BF())
		{
			...
			UNK_0xC0B0B9E466C0ED17(Local_82.f_28[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, false);
...
void func_297()
{
	...
	if (bLocal_383)
	{
		if (!UNK_0x8C74DE122769E1BF())
		{
			...
			UNK_0x4F4B34F617B087DF(1);
			UNK_0xC0B0B9E466C0ED17(Local_155, 0f, 0f, 0f, 1, 30000, 2000, 2000, false);
			UNK_0xF0B0E93CF50F0322(fVar0);
			UNK_0x908430F113C0DC6D(fVar1);
			UNK_0xDA9C58A3CC25952B(fVar2);
			UNK_0x4BF9B75F44D4B6CE(fVar3);
...
void func_298()
{
	...
	if (iLocal_148 == 1)
	{
		...
		{
			fVar0 = UNK_0x0EB28750412C3A5A(UNK_0x68F4C0EC296D3901(UNK_0x16F2683693E537C9(), true), UNK_0x68F4C0EC296D3901(Local_155, true), 1);
			if (iLocal_153 == 0)
			{
				if (fVar0 > 160f)
				{
...
bool func_316(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
...
void func_318()
{
	...
	UNK_0xD7992BEF7A9D109E("EXT4", false);
	...
	{
		bLocal_175 = UNK_0xB0BE3DFBBB59A620(joaat("PROP_BOX_GUNCASE_03A"), 1658.299f, -7.930665f, 173.71f, true, true, false);
		UNK_0xC023D1C4BF532815(bLocal_175, 90f, 0f, -63f, 2, 1);
		UNK_0x1E9649458B15960F(bLocal_175, true);
	...
	if (!UNK_0xC844350D5D58C99A(Local_155))
	{
		...
		UNK_0x11AD11297DC58CC7(Local_155, true);
		UNK_0xE3A2D2E900FEFBE7(Local_155, 1);
		UNK_0x64F9F278AB9DCA2C(Local_155, 8, 2, false, 0);
...
int func_319(bool bParam0, int iParam1, vector3 vParam2, int iParam5, bool bParam6, int iParam7)
{
	if (func_320(bParam0, iParam1, vParam2, iParam5, 1))
	{
		if (UNK_0xC844350D5D58C99A(*bParam0))
		{
			if (!UNK_0x437347B10A200C4B(*bParam0, 0))
...
bool func_320(bool bParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6)
{
	bool bVar0;
...
int func_330(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			while (iVar2 <= (bVar0 - 1))
			{
				UNK_0x523BCC9DC80CD82F(bVar0[iVar2]);
				iVar2++;
			}
			...
			break;
		case 1:
			if (!func_333(&bVar0) || !func_331(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_79 = 2;
		...
		case 2:
			...
			while (iVar2 <= (bVar0 - 1))
			{
				UNK_0x71199B01895C6202(bVar0[iVar2]);
				iVar2++;
			}
			return 1;
	}
...
void func_336(int iParam0)
{
	...
	func_348(&bLocal_176, 0);
	func_348(&bLocal_177, 0);
	func_348(&bLocal_178, 0);

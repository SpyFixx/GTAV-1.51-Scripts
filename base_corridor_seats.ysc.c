...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 5:
			...
			{
				uParam0->f_57.f_1 = NETWORK::_0x77758139EC9B66C7(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
				NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_57.f_1, &uVar0, &uVar16, 2f, -1000f, 13, 16, 1.5f, 0);
				NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_57.f_1);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			fVar42 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_57.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fVar42))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fVar42) >= 1f)
				{
					...
					func_40(uParam0, &uVar16);
					uParam0->f_57.f_1 = NETWORK::_0x77758139EC9B66C7(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
					NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_57.f_1, &uVar0, &uVar16, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_57.f_1);
					func_25(&(uParam0->f_57), 8);
		...
		case 7:
			...
			break;
		case 8:
			fVar43 = NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_57.f_1);
...
void func_24(var uParam0)
{
	...
	uParam0->f_57.f_1 = NETWORK::_0x77758139EC9B66C7(func_39(uParam0), func_38(uParam0), 2, true, false, 1065353216 /* Float: 1f */, 0, 1065353216 /* Float: 1f */);
	func_41(uParam0, &uVar0);
	NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_57.f_1, &uVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	NETWORK::NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0->f_57.f_1);
	func_9(&(uParam0->f_57.f_5));
	func_52(uParam0, 8);
}

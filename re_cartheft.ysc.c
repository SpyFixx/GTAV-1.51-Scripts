	...
	if (((!PED::IS_PED_INJURED(iLocal_75) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && func_168(iLocal_77)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_306))
	{
		switch (iLocal_51)
		{
			...
			case 1:
				...
				vLocal_310 = { 0f, 0f, 0f };
				vLocal_313 = { 0f, 0f, 0f };
				fLocal_302 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_310, vLocal_313, 2);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(fLocal_302, iLocal_77, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_77, sVar3));
				PED::SET_SYNCHRONIZED_SCENE_ORIGIN(fLocal_302, vLocal_310, vLocal_313, 2);
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_75, fLocal_302, sLocal_306, sLocal_308, 1000f, -2f, 0, 0, 1000f, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), fLocal_302, sLocal_306, sLocal_309, 1000f, -2f, 1024, 0, 1000f, 0);
				iLocal_79 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_ANIMATED_CAMERA", vLocal_113, vLocal_116, fLocal_112, false, 2);
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_79, fLocal_302, "car_returned_cam", sLocal_306);
			...
			case 3:
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_302) && !bLocal_342)
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_302) >= 0.2f)
					{
						if (func_47(&Local_122, cLocal_294, sLocal_121, 4, 0, 0, 0))
						{
							iLocal_62 = 0;
			...
			case 4:
				...
				if (iLocal_301 == 1)
				{
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_302))
					{
						if (iLocal_316 == 0)
						{
							if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_302) >= 0.83f)
							{
								TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
								TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_306, sLocal_309, 1000f, -2f, -1, 1048576, PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_302), false, false, false);
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_302))
				{
					if (iLocal_316 == 0)
					{
						if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_302) >= 0.86f)
						{
							TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
							TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_306, sLocal_309, 1000f, -2f, -1, 1048576, PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_302), false, false, false);
							PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), true, false);
					...
					if (!PED::IS_PED_INJURED(iLocal_75))
					{
						if (PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_302) > 0.847f)
						{
							if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_75, sLocal_306, sLocal_308, 2))
							{
								ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_75, -1000f, false);
				...
				if (((PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_302) && PED::GET_SYNCHRONIZED_SCENE_PHASE(fLocal_302) >= 0.99f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_302)) || func_20())
				{
					...
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(fLocal_302))
					{
						PED::SET_SYNCHRONIZED_SCENE_PHASE(fLocal_302, 1f);
					}
					if (bLocal_342)
					{
...
bool func_33(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
bool func_44(int iParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_143(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	struct<10> Var0;
	struct<10> Var10;
	int iVar20;
...
bool func_194(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;

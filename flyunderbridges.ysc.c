			...
			if (UNK_0xE1DBBD6CE209517C(UNK_0xD803B885F5E47A62()))
			{
				...
				switch (iLocal_27)
				{
					case 0:
						...
						{
							if (SYSTEM::VDIST2(UNK_0x68F4C0EC296D3901(UNK_0x16F2683693E537C9(), false), vLocal_39[bLocal_31 /*3*/]) < fLocal_250)
							{
								if (UNK_0x398B22FA3FCBDFA9(UNK_0x16F2683693E537C9()) || UNK_0x5EDB8AD1D9CB1AC8(UNK_0x16F2683693E537C9()))
								{
									...
									if (UNK_0xDF1306B443CD3D15(UNK_0x6937EA2286828455(UNK_0x16F2683693E537C9(), 0), 0))
									{
										if (func_15())
										{
											if (UNK_0x3D1053F9EB43B7AD(UNK_0x16F2683693E537C9(), vLocal_251, vLocal_254, bLocal_263, 0, true, 0))
											{
												bLocal_33 = true;
												iLocal_27 = 1;
											}
											if (UNK_0x3D1053F9EB43B7AD(UNK_0x16F2683693E537C9(), vLocal_257, vLocal_260, bLocal_263, 0, true, 0))
											{
												bLocal_34 = true;
												iLocal_27 = 1;
											}
						...
						if (!UNK_0xEB6A8945D1AC98A1(UNK_0x16F2683693E537C9()))
						{
							...
							if (bLocal_33)
							{
								if (bLocal_37)
								{
									if (bLocal_36)
									{
										if (!UNK_0x3D1053F9EB43B7AD(UNK_0x16F2683693E537C9(), vLocal_251, vLocal_254, bLocal_263, 0, true, 0) && !UNK_0x3D1053F9EB43B7AD(UNK_0x16F2683693E537C9(), vLocal_257, vLocal_260, bLocal_263, 0, true, 0))
										{
											func_14();
											func_1();
									...
									else if (!UNK_0x3D1053F9EB43B7AD(UNK_0x16F2683693E537C9(), vLocal_251, vLocal_254, bLocal_263, 0, true, 0) && UNK_0x3D1053F9EB43B7AD(UNK_0x16F2683693E537C9(), vLocal_257, vLocal_260, bLocal_263, 0, true, 0))
									{
										bLocal_36 = true;
									}
									else if (!UNK_0x3D1053F9EB43B7AD(UNK_0x16F2683693E537C9(), vLocal_251, vLocal_254, bLocal_263, 0, true, 0) && !UNK_0x3D1053F9EB43B7AD(UNK_0x16F2683693E537C9(), vLocal_257, vLocal_260, bLocal_263, 0, true, 0))
...
void func_1()
{
	...
	if (bLocal_31 < 32)
	{
		bVar0 = UNK_0xEAE0D21A50E6C7F4(Global_111638.f_10044.f_96, bLocal_31);
	}
	else if (bLocal_31 < 64)
	{
		bVar0 = UNK_0xEAE0D21A50E6C7F4(Global_111638.f_10044.f_97, (bLocal_31 - 32));
	}
	else
	{
		bVar0 = UNK_0xEAE0D21A50E6C7F4(Global_111638.f_10044.f_98, (bLocal_31 - 64));
	}
	if (bVar0)
	{
	}
	else
	{
		...
		if (bLocal_31 < 32)
		{
			UNK_0x5D96D8530B3D0904(&(Global_111638.f_10044.f_96), bLocal_31);
		}
		else if (bLocal_31 < 64)
		{
			UNK_0x5D96D8530B3D0904(&(Global_111638.f_10044.f_97), (bLocal_31 - 32));
		}
		else
		{
			UNK_0x5D96D8530B3D0904(&(Global_111638.f_10044.f_98), (bLocal_31 - 64));
		}
		Global_95189 = 1;
		func_30();
		bLocal_29 = true;
...
void func_16()
{
	if ((UNK_0x1C0640BA9A7327B3() - iLocal_268) > 500)
	{
		if (bLocal_31 == 29)
		{
			if (UNK_0xEAE0D21A50E6C7F4(Global_111638.f_10044.f_96, bLocal_31))
			{
				bLocal_267 = true;
			}
		}
...
void func_26()
{
	...
	{
		if (UNK_0xEAE0D21A50E6C7F4(Global_111638.f_10044.f_97, (bLocal_31 - 32)))
		{
			bLocal_267 = true;
		}
	}
	else if (UNK_0xEAE0D21A50E6C7F4(Global_111638.f_10044.f_98, (bLocal_31 - 64)))
	{
		bLocal_267 = true;
	}
	if (bLocal_267)
...
int func_47(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_49()
{
	...
	while (bVar1 < 32)
	{
		if (UNK_0xEAE0D21A50E6C7F4(Global_111638.f_10044.f_96, bVar1))
		{
			if (func_50(bVar1))
			{
				iVar0++;
		...
		if (UNK_0xEAE0D21A50E6C7F4(Global_111638.f_10044.f_97, bVar1))
		{
			if (func_50(bVar1 + 32))
			{
				iVar0++;
		...
		if (UNK_0xEAE0D21A50E6C7F4(Global_111638.f_10044.f_98, bVar1))
		{
			if (func_50(bVar1 + 64))
			{
				iVar0++;
